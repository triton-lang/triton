...
Usage:
  python third_party/apple/tests/run_core_tests.py              # run all categories
  python third_party/apple/tests/run_core_tests.py arith         # run one category
...
# Now one directory deeper: tests/ -> apple/ -> third_party/ -> triton root
TRITON_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
