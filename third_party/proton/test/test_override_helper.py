...
def test_override():
    ...
    subprocess.run(["python", dir_path + "/test_override.py"], env=first_env)
    ...
    subprocess.run(["python", dir_path + "/test_override.py"], env=second_env)

    temp_file = "test_override.hatchet"
