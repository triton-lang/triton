...
protected:
  ...
  struct ThreadState {
    ...
    size_t apiExternId{Scope::DummyScopeId}; // Mark if an op is API-originated
    ...
    void enterOp() {
      ...
      apiExternId = Scope::getNewScopeId();
      profiler.enterOp(Scope(apiExternId));
      profiler.correlation.setApiExternId(apiExternId);
    }
