...
public:
  ...
  void deactivateSession(size_t sessionId, bool flush);

  void deactivateAllSessions(bool flush);
...
private:
  ...
  void deActivateSessionImpl(size_t sessionId, bool flush);
