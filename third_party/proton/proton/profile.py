...
def _normalize_backend(backend: str) -> str:
    ...
    if backend_lower == "roctracer":
        warnings.warn(
            "The 'roctracer' backend has been renamed to 'rocprofiler'. "
    ...
    *,
    ...
    Args:
        ...
        backend (str, optional): The backend to use for profiling.
                                 Available options are [None, "cupti", "rocprofiler", "instrumentation"]. The deprecated alias "roctracer" is also accepted.
        ...
        mode (Union[str, BaseMode], optional): The "mode" to use for profiling, which is specific to the backend.
                                               ...
                                               For "rocprofiler", available options are [None].
