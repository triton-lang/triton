...
#define cuGraphInstantiateWithParams                                           \
...
typedef enum CUctx_flags_enum {
  ...
  CU_CTX_COREDUMP_ENABLE =
      0x20, /**< Trigger coredumps from exceptions in this context */
  CU_CTX_USER_COREDUMP_ENABLE =
      0x40, /**< Enable user pipe to trigger coredumps in this context */
  CU_CTX_SYNC_MEMOPS =
      0x80, /**< Force synchronous blocking on cudaMemcpy/cudaMemset */
...
typedef enum CUdevice_attribute_enum {
  ...
  CU_DEVICE_ATTRIBUTE_CAN_USE_STREAM_MEM_OPS_V1 =
      92, /**< Deprecated, along with v1 MemOps API, ::cuStreamBatchMemOp and
             related APIs are supported. */
  CU_DEVICE_ATTRIBUTE_CAN_USE_64_BIT_STREAM_MEM_OPS_V1 =
      93, /**< Deprecated, along with v1 MemOps API, 64-bit operations are
             supported in ::cuStreamBatchMemOp and related APIs. */
  CU_DEVICE_ATTRIBUTE_CAN_USE_STREAM_WAIT_VALUE_NOR_V1 =
      94, /**< Deprecated, along with v1 MemOps API, ::CU_STREAM_WAIT_VALUE_NOR
             is supported. */
  ...
  CU_DEVICE_ATTRIBUTE_CLUSTER_LAUNCH =
      120, /**< Indicates device supports cluster launch */
  ...
  CU_DEVICE_ATTRIBUTE_CAN_USE_64_BIT_STREAM_MEM_OPS =
      122, /**< 64-bit operations are supported in ::cuStreamBatchMemOp and
              related MemOp APIs. */
  CU_DEVICE_ATTRIBUTE_CAN_USE_STREAM_WAIT_VALUE_NOR =
      123, /**< ::CU_STREAM_WAIT_VALUE_NOR is supported by MemOp APIs. */
  CU_DEVICE_ATTRIBUTE_DMA_BUF_SUPPORTED =
      124, /**< Device supports buffer sharing with dma_buf mechanism. */
  CU_DEVICE_ATTRIBUTE_IPC_EVENT_SUPPORTED =
      125, /**< Device supports IPC Events. */
  CU_DEVICE_ATTRIBUTE_MEM_SYNC_DOMAIN_COUNT =
      126, /**< Number of memory domains the device supports. */
  CU_DEVICE_ATTRIBUTE_TENSOR_MAP_ACCESS_SUPPORTED =
      127, /**< Device supports accessing memory using Tensor Map. */
  CU_DEVICE_ATTRIBUTE_UNIFIED_FUNCTION_POINTERS =
      129, /**< Device supports unified function pointers. */
  CU_DEVICE_ATTRIBUTE_IS_NUMA_NODE = 130,
  CU_DEVICE_ATTRIBUTE_NUMA_ID = 131,
  CU_DEVICE_ATTRIBUTE_MULTICAST_SUPPORTED =
      132, /**< Device supports switch multicast and reduction operations. */
...
typedef enum CUfunction_attribute_enum {
   ...
   * the function. See ::cuFuncSetAttribute, ::cuKernelSetAttribute
   */
 ...
 * ::cuFuncSetAttribute or ::cuKernelSetAttribute
 */
...
typedef enum CUmem_advise_enum {
  CU_MEM_ADVISE_SET_READ_MOSTLY =
      1, /**< Data will mostly be read and only occasionally be written to */
...
typedef enum CUmem_range_attribute_enum {
  CU_MEM_RANGE_ATTRIBUTE_READ_MOSTLY =
      1, /**< Whether the range will mostly be read and only occasionally be
            written to */
...
typedef struct CUDA_KERNEL_NODE_PARAMS_v2_st {
  ...
  void **extra;                /**< Extra options */
  CUkernel
      kern; /**< Kernel to launch, will only be referenced if func is NULL */
  CUcontext ctx; /**< Context for the kernel task to run in. The value NULL will
                    indicate the current context should be used by the api. This
                    field is ignored if func is set. */
...
typedef enum CUgraphInstantiateResult_enum {
  ...
  CUDA_GRAPH_INSTANTIATE_ERROR =
      1, /**< Instantiation failed for an unexpected reason which is described
            in the return value of the function */
  CUDA_GRAPH_INSTANTIATE_INVALID_STRUCTURE =
      2, /**< Instantiation failed due to invalid structure, such as cycles */
  CUDA_GRAPH_INSTANTIATE_NODE_OPERATION_NOT_SUPPORTED =
      3, /**< Instantiation for device launch failed because the graph contained
            an unsupported operation */
  CUDA_GRAPH_INSTANTIATE_MULTIPLE_CTXS_NOT_SUPPORTED =
      4 /**< Instantiation for device launch failed due to the nodes belonging
...
typedef struct CUDA_GRAPH_INSTANTIATE_PARAMS_st {
  ...
  CUgraphNode
      hErrNode_out; /**< The node which caused instantiation to fail, if any */
  CUgraphInstantiateResult
      result_out; /**< Whether instantiation was successful.  If it failed, the
                     reason why */
...
/**
 * Cluster scheduling policies. These may be passed to ::cuFuncSetAttribute or
 * ::cuKernelSetAttribute
 */
typedef enum CUclusterSchedulingPolicy_enum {
  CU_CLUSTER_SCHEDULING_POLICY_DEFAULT = 0, /**< the default policy */
  CU_CLUSTER_SCHEDULING_POLICY_SPREAD =
      1, /**< spread the blocks within a cluster to the SMs */
  CU_CLUSTER_SCHEDULING_POLICY_LOAD_BALANCING =
      2 /**< allow the hardware to load-balance the blocks in a cluster to the
           SMs */
...
typedef enum CUlaunchAttributeID_enum {
  CU_LAUNCH_ATTRIBUTE_IGNORE =
      0 /**< Ignored entry, for convenient composition */
  ,
  ...
  CU_LAUNCH_ATTRIBUTE_CLUSTER_DIMENSION =
      4 /**< Valid for graph nodes, launches. */
  ,
  CU_LAUNCH_ATTRIBUTE_CLUSTER_SCHEDULING_POLICY_PREFERENCE =
      5 /**< Valid for graph nodes, launches. */
  ,
  CU_LAUNCH_ATTRIBUTE_PROGRAMMATIC_STREAM_SERIALIZATION =
      6 /**< Valid for launches. Setting
  ...
  CU_LAUNCH_ATTRIBUTE_PROGRAMMATIC_EVENT =
      7 /**< Valid for launches. Event recorded through this
  ...
  CU_LAUNCH_ATTRIBUTE_PRIORITY =
      8 /**< Valid for streams, graph nodes, launches. */
  ,
...
typedef union CUlaunchAttributeValue_union {
  ...
  int cooperative;        /**< Nonzero indicates a cooperative kernel (see
                             ::cuLaunchCooperativeKernel). */
  CUsynchronizationPolicy syncPolicy; /**< ::CUsynchronizationPolicy for work
  ...
  CUclusterSchedulingPolicy
      clusterSchedulingPolicyPreference; /**< Cluster scheduling policy
                                            preference for the kernel node. */
...
#define CU_KERNEL_NODE_ATTRIBUTE_CLUSTER_DIMENSION                             \
  CU_LAUNCH_ATTRIBUTE_CLUSTER_DIMENSION
#define CU_KERNEL_NODE_ATTRIBUTE_CLUSTER_SCHEDULING_POLICY_PREFERENCE          \
  CU_LAUNCH_ATTRIBUTE_CLUSTER_SCHEDULING_POLICY_PREFERENCE
...
#define CU_KERNEL_NODE_ATTRIBUTE_MEM_SYNC_DOMAIN                               \
...
#define CU_STREAM_ATTRIBUTE_MEM_SYNC_DOMAIN_MAP                                \
  CU_LAUNCH_ATTRIBUTE_MEM_SYNC_DOMAIN_MAP
...
typedef enum CUdriverProcAddressQueryResult_enum {
  ...
  CU_GET_PROC_ADDRESS_SYMBOL_NOT_FOUND =
      1, /**< Symbol was not found in search */
  CU_GET_PROC_ADDRESS_VERSION_NOT_SUFFICIENT =
      2 /**< Symbol was found but version supplied was not sufficient */
...
/**
 * Library options to be specified with ::cuLibraryLoadData() or
...
typedef enum CUlibraryOption_enum {
  ...
  /**
   * Specifes that the argument \p code passed to ::cuLibraryLoadData() will be
   * preserved. Specifying this option will let the driver know that \p code can
   * be accessed at any point until ::cuLibraryUnload(). The default behavior is
   * for the driver to allocate and maintain its own copy of \p code. Note that
   * this is only a memory usage optimization hint and the driver can choose to
   * ignore it if required. Specifying this option with
   * ::cuLibraryLoadFromFile() is invalid and will return
...
typedef enum cudaError_enum {
  ...
  /**
   * This error indicates that the module is using CUDA Dynamic Parallelism, but
...
typedef enum CUmulticastGranularity_flags_enum {
  ...
  CU_MULTICAST_GRANULARITY_RECOMMENDED =
      0x1 /**< Recommended granularity for best performance */
...
typedef struct CUgraphExecUpdateResultInfo_st {
  ...
  /**
   * The from node of error edge when the topologies do not match. Otherwise
   * NULL.
   */
 ...
 * the driver API in the current process. Currently, the \p Flags parameter must
 * be 0. If ::cuInit() has not been called, any function from the driver API
 * will return
 ...
 * block shared memory size supported on this device. This is the maximum value
 * that can be opted into when using the cuFuncSetAttribute() or
 ...
 * nvSciSyncAttrList.
 *
 * Note that this API updates the input \p nvSciSyncAttrList with values
 * equivalent to the following public attribute key-values:
 * NvSciSyncAttrKey_RequiredPerm is set to
 * - NvSciSyncAccessPerm_SignalOnly if ::CUDA_NVSCISYNC_ATTR_SIGNAL is set in \p
 * flags.
 * - NvSciSyncAccessPerm_WaitOnly if ::CUDA_NVSCISYNC_ATTR_WAIT is set in \p
 * flags.
 ...
 * - NvSciSyncAttrValPrimitiveType_SysmemSemaphorePayload64b if \p device is
 * GA10X+. NvSciSyncAttrKey_GpuId is set to the same UUID that is returned for
 * this \p device from ::cuDeviceGetUuid.
 *
 ...
 * this context raises an exception during execution. These environment
 * variables are described in the CUDA-GDB user guide under the "GPU core dump
 * support" section. The initial settings will be taken from the global settings
 * at the time of context creation. The other settings that control coredump
 * output can be modified by calling ::cuCoredumpSetAttribute from the created
 * context after it becomes current.
 *
 ...
 * this context raises an exception during execution. These environment
 * variables are described in the CUDA-GDB user guide under the "GPU core dump
 * support" section. The initial attributes will be taken from the global
 * attributes at the time of context creation. The other attributes that control
 * coredump output can be modified by calling ::cuCoredumpSetAttribute from the
 * created context after it becomes current.
 *
 * - ::CU_CTX_USER_COREDUMP_ENABLE: If user-triggered GPU coredumps have not
 * been enabled globally with ::cuCoredumpSetAttributeGlobal or environment
 * variables, this flag can be set during context creation to instruct CUDA to
 ...
 * of context creation. The other attributes that control coredump output can be
 * modified by calling ::cuCoredumpSetAttribute from the created context after
 * it becomes current.
 ...
 * ::cuCtxCreate() must call ::cuCtxDestroy() when done using the context. If a
 ...
 * set via ::cuFuncSetCacheConfig() or ::cuKernelSetCacheConfig() will be
 * preferred over this context-wide setting. Setting the context-wide cache
 * configuration to
 ...
 * call returns.
 *
 * \note For LTO-IR input, only LTO-IR compiled with toolkits prior to CUDA 12.0
 * will be accepted
 *
 ...
 * driver API (___CURRENT_FILE___) ___ENDMANBRIEF___
 *
 * This section describes the deprecated module management functions of the
 * low-level CUDA driver application programming interface.
 *
 * @{
 */
 ...
 *
 * The pointer may be obtained by mapping a \e cubin or \e PTX or \e fatbin
 * file, passing a \e cubin or \e PTX or \e fatbin file as a NULL-terminated
 * text string, or incorporating a \e cubin or \e fatbin object into the
 * executable resources and using operating system calls such as Windows \c
 * FindResource() to obtain the pointer.
 *
 * Options are passed as an array via \p jitOptions and any corresponding
 * parameters are passed in \p jitOptionsValues. The number of total JIT options
 * is supplied via \p numJitOptions. Any outputs will be returned via \p
 * jitOptionsValues.
 *
 * Library load options are passed as an array via \p libraryOptions and any
 * corresponding parameters are passed in \p libraryOptionValues. The number of
 * total library load options is supplied via \p numLibraryOptions.
 *
 ...
 *
 * Takes a filename \p fileName and loads the corresponding library \p library
 * into all contexts existent at the time of the call and future contexts at the
 * time of creation until the library is unloaded with ::cuLibraryUnload().
 *
 * The file should be a \e cubin file as output by \b nvcc, or a \e PTX file
 * either as output by \b nvcc or handwritten, or a \e fatbin file as output by
 * \b nvcc from toolchain 4.0 or later.
 *
 * Options are passed as an array via \p jitOptions and any corresponding
 * parameters are passed in \p jitOptionsValues. The number of total options is
 * supplied via \p numJitOptions. Any outputs will be returned via \p
 * jitOptionsValues.
 *
 * Library load options are passed as an array via \p libraryOptions and any
 * corresponding parameters are passed in \p libraryOptionValues. The number of
 ...
 *
 * Returns in \p pKernel the handle of the kernel with name \p name located in
 * library \p library. If kernel handle is not found, the call returns
 * ::CUDA_ERROR_NOT_FOUND.
 *
 ...
 * located in library \p library. If module handle is not found, the call
 * returns ::CUDA_ERROR_NOT_FOUND.
 *
 ...
 * \brief Returns a function handle
 *
 * Returns in \p pFunc the handle of the function for the requested kernel \p
 * kernel and the current context. If function handle is not found, the call
 * returns ::CUDA_ERROR_NOT_FOUND.
 *
 ...
 *
 * Returns in \p *dptr and \p *bytes the base pointer and size of the global
 * with name \p name for the requested library \p library and the current
 * context. If no global for the requested name \p name exists, the call returns
 * ::CUDA_ERROR_NOT_FOUND. One of the parameters \p dptr or \p bytes (not both)
 ...
 *
 * Returns in \p *dptr and \p *bytes the base pointer and size of the managed
 * memory with name \p name for the requested library \p library. If no managed
 * memory with the requested name \p name exists, the call returns
 * ::CUDA_ERROR_NOT_FOUND. One of the parameters \p dptr or \p bytes (not both)
 * can be NULL in which case it is ignored. Note that managed memory for library
 * \p library is shared across devices and is registered when the library is
 * loaded into atleast one context.
 *
 * \note The API requires a CUDA context to be present and initialized on at
 * least one device. If no context is present, the call returns
 * ::CUDA_ERROR_NOT_FOUND.
 *
 ...
 *
 * Returns in \p *fptr the function pointer to a unified function denoted by \p
 * symbol. If no unified function with name \p symbol exists, the call returns
 * ::CUDA_ERROR_NOT_FOUND. If there is no device with attribute
 * ::CU_DEVICE_ATTRIBUTE_UNIFIED_FUNCTION_POINTERS present in the system, the
 ...
 * CUclusterSchedulingPolicy.
 *
 * \note If another thread is trying to set the same attribute on the same
 * device using
 * ::cuKernelSetAttribute() simultaneously, the attribute query will give the
 * old or new value depending on the interleavings chosen by the OS scheduler
 ...
 *
 * This call sets the value of a specified attribute \p attrib on the kernel \p
 * kernel for the requested device \p dev to an integer value specified by \p
 * val. This function returns CUDA_SUCCESS if the new value of the attribute
 * could be successfully set. If the set fails, this call will return an error.
 ...
 *
 * Note that attributes set using ::cuFuncSetAttribute() will override the
 * attribute set by this API irrespective of whether the call to
 * ::cuFuncSetAttribute() is made before or after this API call. However,
 * ::cuKernelGetAttribute() will always return the attribute value set by this
 * API.
 *
 * Supported attributes are:
 * - ::CU_FUNC_ATTRIBUTE_MAX_DYNAMIC_SHARED_SIZE_BYTES: This is the maximum size
 * in bytes of dynamically-allocated shared memory. The value should contain the
 ...
 * CUclusterSchedulingPolicy.
 *
 * \note The API has stricter locking requirements in comparison to its legacy
 * counterpart
 * ::cuFuncSetAttribute() due to device-wide semantics. If multiple threads are
 * trying to set the same attribute on the same device simultaneously, the
 * attribute setting will depend on the interleavings chosen by the OS scheduler
 * and memory consistency.
 *
 * \param attrib - Attribute requested
 ...
 * On devices where the L1 cache and shared memory use the same hardware
 * resources, this sets through \p config the preferred cache configuration for
 * the device kernel \p kernel on the requested device \p dev. This is only a
 * preference. The driver will use the requested configuration if possible, but
 * it is free to choose a different configuration if required to execute \p
 * kernel.  Any context-wide preference set via ::cuCtxSetCacheConfig() will be
 * overridden by this per-kernel setting.
 *
 * Note that attributes set using ::cuFuncSetCacheConfig() will override the
 * attribute set by this API irrespective of whether the call to
 * ::cuFuncSetCacheConfig() is made before or after this API call.
 *
 * This setting does nothing on devices where the size of the L1 cache and
 * shared memory are fixed.
 *
 ...
 * \note The API has stricter locking requirements in comparison to its legacy
 * counterpart
 * ::cuFuncSetCacheConfig() due to device-wide semantics. If multiple threads
 * are trying to set a config on the same device simultaneously, the cache
 * config setting will depend on the interleavings chosen by the OS scheduler
 * and memory consistency.
 *
 ...
 * a single stream, the default association as specified during
 ...
 *
 * On systems where
 * ::CU_DEVICE_ATTRIBUTE_PAGEABLE_MEMORY_ACCESS_USES_HOST_PAGE_TABLES is true,
 * ::cuMemHostRegister will not page-lock the memory range specified by \p ptr
 ...
 * will be stored. \param[in] dptr        - Pointer to a valid CUDA device
 * allocation. Must be aligned to host page size. \param[in] size        -
 * Length of the address range. Must be aligned to host page size. \param[in]
 * handleType  - Type of handle requested (defines type and size of the \p
 * handle output parameter) \param[in] flags       - Reserved, must be zero
 *
 * \return
 * CUDA_SUCCESS
 * CUDA_ERROR_INVALID_VALUE
 ...
 * handle. Each time a recipient process imports a shareable handle, it needs to
 * pair it with
 ...
 * ::cuMemGetAllocationGranularity with the ::CU_MEM_ALLOC_GRANULARITY_MINIMUM
 * flag. If \p handle represents a multicast object, \p ptr, \p size and \p
 * offset must be aligned to the value returned by ::cuMulticastGetGranularity
 * with the flag
 ...
 *
 * ___MANBRIEF___ Functions for creating multicast objects, adding devices to
 * them and binding/unbinding memory
 * (___CURRENT_FILE___) ___ENDMANBRIEF___
 *
 ...
 * participating device via either ::cuMulticastBindMem or
 * ::cuMulticastBindAddr. Multicast objects can be mapped into a device's
 * virtual address space using the virtual memmory management APIs (see
 * ::cuMemMap and ::cuMemSetAccess).
 *
...
/**
 * \brief Create a generic allocation handle representing a multicast object
 ...
 * handles must be specified in the bitmask
 * ::CUmulticastObjectProp::handleTypes. Multicast objects can be released using
 ...
 * ::CUDA_ERROR_NOT_SUPPORTED
 *
 * \sa ::cuMulticastAddDevice, ::cuMulticastBindMem, ::cuMulticastBindAddr,
 * ::cuMulticastUnbind \sa ::cuMemCreate, ::cuMemRelease,
 * ::cuMemExportToShareableHandle, ::cuMemImportFromShareableHandle
 */
CUresult CUDAAPI cuMulticastCreate(CUmemGenericAllocationHandle *mcHandle,
 ...
 */
CUresult CUDAAPI cuMulticastAddDevice(CUmemGenericAllocationHandle mcHandle,
                                      CUdevice dev);

/**
 * \brief Bind a memory allocation represented by a handle to a multicast
 * object.
 *
 ...
 */
CUresult CUDAAPI cuMulticastBindMem(CUmemGenericAllocationHandle mcHandle,
                                    size_t mcOffset,
                                    CUmemGenericAllocationHandle memHandle,
...
/**
 * \brief Bind a memory allocation represented by a virtual address to a
 * multicast object.
 *
 ...
 * \sa ::cuMulticastCreate, ::cuMulticastAddDevice, ::cuMemCreate
 */
CUresult CUDAAPI cuMulticastBindAddr(CUmemGenericAllocationHandle mcHandle,
                                     size_t mcOffset, CUdeviceptr memptr,
                                     size_t size, unsigned long long flags);

/**
 * \brief Unbind any memory allocations bound to a multicast object at a given
 * offset and upto a given size.
 *
 ...
 */
CUresult CUDAAPI cuMulticastUnbind(CUmemGenericAllocationHandle mcHandle,
                                   CUdevice dev, size_t mcOffset, size_t size);

/**
 * \brief Calculates either the minimal or recommended granularity for multicast
 * object
 *
 ...
 * ::cuMulticastUnbind
 */
CUresult CUDAAPI cuMulticastGetGranularity(size_t *granularity,
                                           const CUmulticastObjectProp *prop,
 ...
 * that this simply returns the last location that the application requested to
 ...
 *
 * Returns in \p streamId the unique Id which is associated with the given
 ...
 * undefined behavior.</li> <li>any of the special streams such as the NULL
 * stream, ::CU_STREAM_LEGACY and
 ...
 * object of the type
 * ::CU_EXTERNAL_SEMAPHORE_HANDLE_TYPE_NVSCISYNC can be deterministic. For this
 * the NvSciSyncAttrList used to create the semaphore object must have value of
 * NvSciSyncAttrKey_RequireDeterministicFences key set to true. Deterministic
 * fences allow users to enqueue a wait over the semaphore object even before
 * corresponding signal is enqueued. For such a semaphore object, CUDA
 * guarantees that each signal operation will increment the fence value by '1'.
 * Users are expected to track count of signals enqueued on the semaphore object
 * and insert waits accordingly. When such a semaphore object is signaled from
 * multiple streams, due to concurrent stream execution, it is possible that the
 * order in which the semaphore gets signaled is indeterministic. This could
 * lead to waiters of the semaphore getting unblocked incorrectly. Users are
 * expected to handle such situations, either by not using the same semaphore
 * object with deterministic fence support enabled in different streams or by
 * adding explicit dependency amongst such streams so that the semaphore is
 * signaled in order.
 *
 * If the semaphore object is any one of the following types:
 * ::CU_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D11_KEYED_MUTEX,
...
/**
 * \brief Launches a CUDA function ::CUfunction or a CUDA kernel ::CUkernel with
 launch-time configuration
 *
 * Invokes the function ::CUfunction or the kernel ::CUkernel \p f with the
 specified launch-time configuration
 * \p config.
 *
 ...
 * by querying the handle using ::cuLibraryGetKernel() and then passing it
 * to the API by casting to ::CUfunction. Here, the context to launch
 * the kernel on will either be taken from the specified stream
...
/**
 * \brief Launches a CUDA function ::CUfunction or a CUDA kernel ::CUkernel
 * where thread blocks can cooperate and synchronize as they execute
 *
 * Invokes the function ::CUfunction or the kernel ::CUkernel \p f on a \p
 * gridDimX x \p gridDimY x \p gridDimZ grid of blocks. Each block contains \p
 * blockDimX x \p blockDimY x \p blockDimZ threads.
 *
 * Note that the API can also be used to launch context-less kernel ::CUkernel
 * by querying the handle using ::cuLibraryGetKernel() and then passing it
 * to the API by casting to ::CUfunction. Here, the context to launch
 ...
 * the kernel launched on each device, are independently instantiated on every
 device.
 * It is the application's responsibility to ensure these variables are
 initialized and
 * used appropriately.
 *
 ...
 *   Note that you can also specify context-less kernel ::CUkernel by querying
 the handle
 *   using ::cuLibraryGetKernel() and then casting to ::CUfunction. In this
 case, the context to
 *   launch the kernel on be taken from the specified stream
 ...
 *
 * - ::CUDA_GRAPH_INSTANTIATE_FLAG_DEVICE_LAUNCH, which configures the graph for
 * launch from the device. If this flag is passed, the executable graph handle
 * returned can be used to launch the graph from both the host and device. This
 * flag can only be used on platforms which support unified addressing. This
 ...
 * ::cuGraphExecDestroy will result in an error.
 *
 * If \p hGraph contains kernels which call device-side cudaGraphLaunch() from
 * multiple contexts, this will result in an error.
 *
 ...
 * child graph nodes. Operation-specific restrictions are outlined below.
 * - Kernel nodes:
 ...
 * \brief Creates an executable graph from a graph
 *
 * Instantiates \p hGraph as an executable graph according to the \p
 instantiateParams structure.
 * The graph is validated for any structural constraints or intra-node
 constraints
 * which were not previously validated. If instantiation is successful, a handle
 to
 ...
 * graph launches, as well as returning more detailed information in the event
 of an error.
 ...
 * unfreed memory allocations before the graph is relaunched.
 *
 * - ::CUDA_GRAPH_INSTANTIATE_FLAG_UPLOAD, which will perform an upload of the
 graph
 * into \p hUploadStream once the graph has been instantiated.
 *
 * - ::CUDA_GRAPH_INSTANTIATE_FLAG_DEVICE_LAUNCH, which configures the graph for
 launch
 * from the device. If this flag is passed, the executable graph handle returned
 can be
 * used to launch the graph from both the host and device. This flag can only be
 used
 ...
 * executable graph in existence for that graph at a time. An attempt to
 instantiate a
 * second executable graph before destroying the first with ::cuGraphExecDestroy
 will
 * result in an error.
 *
 * If \p hGraph contains kernels which call device-side cudaGraphLaunch() from
 ...
 *   - Copies involving CUDA arrays are not permitted.
 *   - Both operands must be accessible from the current context, and the
 current context must
 *     match the context of other nodes in the graph.
 *
 * In the event of an error, the \p result_out and \p hErrNode_out fields will
 contain more
 ...
 *   which is described by the return value of the function. \p hErrNode_out
 will be set to NULL.
 * - ::CUDA_GRAPH_INSTANTIATE_INVALID_STRUCTURE, if the graph structure is
 invalid. \p hErrNode_out
 *   will be set to one of the offending nodes.
 * - ::CUDA_GRAPH_INSTANTIATE_NODE_OPERATION_NOT_SUPPORTED, if the graph is
 instantiated for device
 *   launch but contains a node of an unsupported node type, or a node which
 performs unsupported
 *   operations, such as use of CUDA dynamic parallelism within a kernel node.
 \p hErrNode_out will
 *   be set to this node.
 * - ::CUDA_GRAPH_INSTANTIATE_MULTIPLE_CTXS_NOT_SUPPORTED, if the graph is
 instantiated for device
 *   launch but a node’s context differs from that of another node. This error
 can also be returned
 *   if a graph is not instantiated for device launch and it contains kernels
 which call device-side
 *   cudaGraphLaunch() from multiple contexts. \p hErrNode_out will be set to
 this node.
 *
 * If instantiation is successful, \p result_out will be set to
 ...
 *
 * Returns the flags that were passed to instantiation for the given executable
 * graph.
 * ::CUDA_GRAPH_INSTANTIATE_FLAG_UPLOAD will not be returned by this API as it
 * does not affect the resulting executable graph.
 *
 ...
 *   - If \p hGraphExec was not instantiated for device launch, a node whose
 ...
 * case resultInfo->errorNode is set to NULL.
 * - \p hGraph has more exit nodes than \p hGraph, in which case
 * resultInfo->errorNode is set to one of the exit nodes in hGraph.
 * - A node in \p hGraph has a different number of dependencies than the node
 * from \p hGraphExec it is paired with, in which case resultInfo->errorNode is
 * set to the node from \p hGraph.
 * - A node in \p hGraph has a dependency that does not match with the
 * corresponding dependency of the paired node from \p hGraphExec.
 * resultInfo->errorNode will be set to the node from \p hGraph.
 * resultInfo->errorFromNode will be set to the mismatched dependency. The
 * dependencies are paired based on edge order and a dependency does not match
 * when the nodes are already paired based on other edges examined in the graph.
 *
 * cuGraphExecUpdate sets the result member of \p resultInfo to:
 ...
 * hErrorNode_out is set to the node from \p hGraph
 *
 * If the update fails for a reason not listed above, the result member of \p
 * resultInfo will be set to CU_GRAPH_EXEC_UPDATE_ERROR. If the update succeeds,
 * the result member will be set to CU_GRAPH_EXEC_UPDATE_SUCCESS.
 *
 ...
 *
 * - \p tensorDataType has to be an enum from ::CUtensorMapDataType which is
 defined as:
 * \code
    typedef enum CUtensorMapDataType_enum {
 ...
 * \endcode
 *
 * - \p tensorRank must be non-zero and less than or equal to the maximum
 supported dimensionality of 5. If \p interleave is not
 * ::CU_TENSOR_MAP_INTERLEAVE_NONE, then \p tensorRank must additionally be
 greater than or equal to 3.
 *
 * - \p globalAddress, which specifies the starting address of the memory region
 described, must be 32 byte aligned when \p interleave is
 * ::CU_TENSOR_MAP_INTERLEAVE_32B and 16 byte aligned otherwise.
 *
 * - \p globalDim array, which specifies tensor size of each of the \p
 tensorRank dimensions, must be non-zero and less than or
 * equal to 2^32.
 *
 * - \p globalStrides array, which specifies tensor stride of each of the lower
 \p tensorRank - 1 dimensions in bytes, must be a
 * multiple of 16 and less than 2^40. Additionally, the stride must be a
 multiple of 32 when \p interleave is ::CU_TENSOR_MAP_INTERLEAVE_32B.
 ...
 * \code
 ...
 padding[0]; for (i = 1; i < tensorRank - 1; i++) globalStrides[i] =
 globalStrides[i – 1] * globalStrides[i] + padding[i]; assert(globalStrides[i]
 >= globalDim[i]);
 * \endcode
 *
 * - \p boxDim array, which specifies number of elements to be traversed along
 each of the \p tensorRank dimensions, must be less
 * than or equal to 8.
 * When \p interleave is ::CU_TENSOR_MAP_INTERLEAVE_NONE, { \p boxDim[0] *
 elementSizeInBytes( \p tensorDataType ) } must be a multiple
 * of 16 bytes.
 *
 * - \p elementStrides array, which specifies the iteration step along each of
 the \p tensorRank dimensions, must be non-zero and less
 * than or equal to 8. Note that when \p interleave is
 ::CU_TENSOR_MAP_INTERLEAVE_NONE, the first element of this array is ignored
 since
 * TMA doesn’t support the stride for dimension zero.
 * When all elemets of \p elementStrides array is one, \p boxDim specifies the
 number of elements to load. However, if the \p elementStrides[i]
 * is not equal to one, then TMA loads ceil( \p boxDim[i] / \p
 elementStrides[i]) number of elements along i-th dimension. To load N elements
 along
 * i-th dimension, \p boxDim[i] must be set to N * \p elementStrides[i].
 *
 * - \p interleave specifies the interleaved layout of type
 ...
 * TMA supports interleaved layouts like NC/8HWC8 where C8 utilizes 16 bytes in
 memory assuming 2 byte per channel or NC/16HWC16 where C16
 * uses 32 bytes.
 * When \p interleave is ::CU_TENSOR_MAP_INTERLEAVE_NONE and \p swizzle is not
 ::CU_TENSOR_MAP_SWIZZLE_NONE, the bounding box inner dimension
 * (computed as \p boxDim[0] multiplied by element size derived from \p
 tensorDataType) must be less than or equal to the swizzle size.
 *    - CU_TENSOR_MAP_SWIZZLE_32B implies the bounding box inner dimension will
 be <= 32.
 *    - CU_TENSOR_MAP_SWIZZLE_64B implies the bounding box inner dimension will
 be <= 64.
 *    - CU_TENSOR_MAP_SWIZZLE_128B implies the bounding box inner dimension will
 be <= 128.
 *
 * - \p swizzle, which specifies the shared memory bank swizzling pattern, has
 to be of type ::CUtensorMapSwizzle which is defined as:
 * \code
    typedef enum CUtensorMapSwizzle_enum {
        CU_TENSOR_MAP_SWIZZLE_NONE = 0,
        CU_TENSOR_MAP_SWIZZLE_32B,
 ...
 * \endcode
 * Data is organized in specific order in global memory; however, it may not
 match the order in which data are accessed by application in
 * the shared memory. This difference in data organization may cause bank
 conflicts when shared memory is accessed. In order to avoid this
 * problem, data can be loaded to shard memory with shuffling across shared
 memory banks.
 * Note that it’s expected that when \p interleave is
 ::CU_TENSOR_MAP_INTERLEAVE_32B, \p swizzle should be
 ::CU_TENSOR_MAP_SWIZZLE_32B mode.
 * Other interleave modes can have any swizzling patterns.
 *
 * - \p l2Promotion specifies L2 fetch size which indicates the byte granurality
 at which L2 requests is filled from DRAM. It must be of
 ...
 * \endcode
 *
 * - \p oobFill, which indicates whether zero or a special NaN constant should
 be used to fill out-of-bound elements, must be of type
 ...
 * \endcode
 * Note that ::CU_TENSOR_MAP_FLOAT_OOB_FILL_NAN_REQUEST_ZERO_FMA can only be
 used when \p tensorDataType represents a floating data type.
 *
 ...
 * \param globalAddress     - Starting address of memory region described by
 tensor
 * \param globalDim         - Array containing tensor size (number of elements)
 along each of the \p tensorRank dimensions
 * \param globalStrides     - Array containing stride size (in bytes) along each
 of the \p tensorRank - 1 dimensions
 * \param boxDim            - Array containing traversal box size (number of
 elments) along each of the \p tensorRank dimensions. Specifies how many
 elements to be traversed along each tensor dimension.
 * \param elementStrides    - Array containing traversal stride in each of the
 \p tensorRank dimensions
 ...
 * \param oobFill           - Indicate whether zero or special NaN constant must
 be used to fill out-of-bound elements
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_DEINITIALIZED,
...
/**
 * \brief Create a tensor map descriptor object representing im2col memory
 region
 *
 * Creates a descriptor for Tensor Memory Access (TMA) object specified
 * by the parameters describing a im2col memory layout and returns it in \p
 tensorMap.
 *
 * Tensor map objects are only supported on devices of compute capability 9.0 or
 higher.
 ...
 * \endcode
 *
 * - \p pixelBoxLowerCorner array specifies the coordinate offsets {D, H, W} of
 the bounding box from top/left/front corner. The number of
 * offsets and their precision depends on the tensor dimensionality:
 *    - When \p tensorRank is 3, one signed offset within range [-32768, 32767]
 is supported.
 *    - When \p tensorRank is 4, two signed offsets each within range [-128,
 127] are supported.
 *    - When \p tensorRank is 5, three offsets each within range [-16, 15] are
 supported.
 *
 * - \p pixelBoxUpperCorner array specifies the coordinate offsets {D, H, W} of
 the bounding box from bottom/right/back corner. The number of
 * offsets and their precision depends on the tensor dimensionality:
 *    - When \p tensorRank is 3, one signed offset within range [-32768, 32767]
 is supported.
 *    - When \p tensorRank is 4, two signed offsets each within range [-128,
 ...
 *    - When \p tensorRank is 5, three offsets each within range [-16, 15] are
 supported.
 * The bounding box specified by \p pixelBoxLowerCorner and \p
 pixelBoxUpperCorner must have non-zero area.
 *
 * - \p channelsPerPixel, which specifies the number of elements which must be
 accessed along C dimension, must be less than or equal to 256.
 *
 * - \p pixelsPerColumn, which specifies the number of elements that must be
 accessed along the {N, D, H, W} dimensions, must be less than or
 * equal to 1024.
 *
 * - \p elementStrides array, which specifies the iteration step along each of
 the \p tensorRank dimensions, must be non-zero and less
 ...
 * \param tensorMap             - Tensor map object to create
 * \param tensorDataType        - Tensor data type
 * \param tensorRank            - Dimensionality of tensor, needs to be at least
 of dimension 3
 * \param globalAddress         - Starting address of memory region described by
 tensor
 * \param globalDim             - Array containing tensor size (number of
 elements) along each of the \p tensorRank dimensions
 * \param globalStrides         - Array containing stride size (in bytes) along
 each of the \p tensorRank - 1 dimensions
 * \param pixelBoxLowerCorner   - Array containing DHW dimentions of lower box
 corner
 * \param pixelBoxUpperCorner   - Array containing DHW dimentions of upper box
 corner
 * \param channelsPerPixel      - Number of channels per pixel
 * \param pixelsPerColumn       - Number of pixels per column
 * \param elementStrides        - Array containing traversal stride in each of
 the \p tensorRank dimensions
 * \param interleave            - Type of interleaved layout the tensor
 addresses
 * \param swizzle               - Bank swizzling pattern inside shared memory
 * \param l2Promotion           - L2 promotion size
 * \param oobFill               - Indicate whether zero or special NaN constant
 must be used to fill out-of-bound elements
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_DEINITIALIZED,
...
/**
 * \brief Modify an existing tensor map descriptor with an updated global
 * address
 *
 * Modifies the descriptor for Tensor Memory Access (TMA) object passed in \p
 * tensorMap with an updated \p globalAddress.
 *
 * Tensor map objects are only supported on devices of compute capability 9.0 or
 ...
 * \param globalAddress         - Starting address of memory region described by
 * tensor, must follow previous alignment requirements
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_DEINITIALIZED,
 ...
 * - ::CU_GET_PROC_ADDRESS_SUCCESS - The requested symbol was succesfully found
 * based on input arguments and \p pfn is valid
 ...
 * found but is not supported by cudaVersion specified
 *
 ...
 *                       \p symbol based on \p cudaVersion. See
 ...
 *
 * ___MANBRIEF___ coredump attribute control functions for the low-level CUDA
 * API
 * (___CURRENT_FILE___) ___ENDMANBRIEF___
 *
 * This section describes the coredump attribute control functions of the
 * low-level CUDA driver application programming interface.
 *
 * @{
 */
...
/**
 * \brief Allows caller to fetch a coredump attribute value for the current
 * context
 *
 * Returns in \p *value the requested value specified by \p attrib. It is up to
 * the caller to ensure that the data type and size of \p *value matches the
 * request.
 *
 * If the caller calls this function with \p *value equal to NULL, the size of
 * the memory region (in bytes) expected for \p attrib will be placed in \p
 * size.
 *
 * The supported attributes are:
 * - ::CU_COREDUMP_ENABLE_ON_EXCEPTION: Bool where ::true means that GPU
 * exceptions from this context will create a coredump at the location specified
 * by ::CU_COREDUMP_FILE. The default value is ::false unless set to ::true
 * globally or locally, or the CU_CTX_USER_COREDUMP_ENABLE flag was set during
 * context creation.
 * - ::CU_COREDUMP_TRIGGER_HOST: Bool where ::true means that the host CPU will
 *      also create a coredump. The default value is ::true unless set to
 * ::false globally or or locally.
 ...
 * - ::CU_COREDUMP_ENABLE_USER_TRIGGER: Bool where ::true means that a coredump
 * can be created by writing to the system pipe specified by ::CU_COREDUMP_PIPE.
 * The default value is ::false unless set to ::true globally or locally.
 ...
 * default value is
 *      ::core.cuda.HOSTNAME.PID where ::HOSTNAME is the host name of the
 * machine running the CUDA applications and ::PID is the process ID of the CUDA
 * application.
 * - ::CU_COREDUMP_PIPE: String of up to 1023 characters that defines the name
 * of the pipe that will be monitored if user-triggered coredumps are enabled.
 * The default value is
 *      ::corepipe.cuda.HOSTNAME.PID where ::HOSTNAME is the host name of the
 * machine running the CUDA application and ::PID is the process ID of the CUDA
 * application.
 *
 ...
 * ::cuCoredumpSetAttributeGlobal
 */
CUresult CUDAAPI cuCoredumpGetAttribute(CUcoredumpSettings attrib, void *value,
                                        size_t *size);

/**
 * \brief Allows caller to fetch a coredump attribute value for the entire
 * application
 *
 * Returns in \p *value the requested value specified by \p attrib. It is up to
 * the caller to ensure that the data type and size of \p *value matches the
 ...
 * - ::CU_COREDUMP_ENABLE_ON_EXCEPTION: Bool where ::true means that GPU
 * exceptions from this context will create a coredump at the location specified
 * by ::CU_COREDUMP_FILE. The default value is ::false.
 * - ::CU_COREDUMP_TRIGGER_HOST: Bool where ::true means that the host CPU will
 ...
 * ::cuCoredumpSetAttributeGlobal
 */
CUresult CUDAAPI cuCoredumpGetAttributeGlobal(CUcoredumpSettings attrib,
                                              void *value, size_t *size);

/**
 * \brief Allows caller to set a coredump attribute value for the current
 * context
 *
 ...
 * over any values set with this this function. This decision was made to ensure
 * no change in behavior for any users that may be currently using these
 * variables to get coredumps.
 *
 * \p *value shall contain the requested value specified by \p set. It is up to
 * the caller to ensure that the data type and size of \p *value matches the
 * request.
 *
 * If the caller calls this function with \p *value equal to NULL, the size of
 * the memory region (in bytes) expected for \p set will be placed in \p size.
 *
 * ::CU_COREDUMP_ENABLE_USER_TRIGGER and ::CU_COREDUMP_PIPE cannot be set on a
 * per-context basis.
 *
 * The supported attributes are:
 * - ::CU_COREDUMP_ENABLE_ON_EXCEPTION: Bool where ::true means that GPU
 ...
 * ::cuCoredumpSetAttributeGlobal
 */
CUresult CUDAAPI cuCoredumpSetAttribute(CUcoredumpSettings attrib, void *value,
                                        size_t *size);
 ...
 * - ::CU_COREDUMP_PIPE: String of up to 1023 characters that defines the name
 * of the pipe that will be monitored if user-triggered coredumps are enabled.
 * This value may not be changed after ::CU_COREDUMP_ENABLE_USER_TRIGGER is set
 * to ::true. The default value is ::corepipe.cuda.HOSTNAME.PID where ::HOSTNAME
 * is the host name of the machine running the CUDA application and ::PID is the
 ...
 * ::cuCoredumpSetAttribute
 */
CUresult CUDAAPI cuCoredumpSetAttributeGlobal(CUcoredumpSettings attrib,
                                              void *value, size_t *size);
...
CUresult CUDAAPI cuStreamWriteValue32_ptsz(CUstream stream, CUdeviceptr addr,
                                           cuuint32_t value,
                                           unsigned int flags);
CUresult CUDAAPI cuStreamWaitValue32_ptsz(CUstream stream, CUdeviceptr addr,
                                          cuuint32_t value, unsigned int flags);
CUresult CUDAAPI cuStreamWriteValue64_ptsz(CUstream stream, CUdeviceptr addr,
                                           cuuint64_t value,
                                           unsigned int flags);
CUresult CUDAAPI cuStreamWaitValue64_ptsz(CUstream stream, CUdeviceptr addr,
                                          cuuint64_t value, unsigned int flags);
CUresult CUDAAPI cuStreamBatchMemOp_ptsz(CUstream stream, unsigned int count,
                                         CUstreamBatchMemOpParams *paramArray,
                                         unsigned int flags);
...
CUresult CUDAAPI cuStreamGetCaptureInfo(
    CUstream hStream, CUstreamCaptureStatus *captureStatus_out,
    cuuint64_t *id_out);
CUresult CUDAAPI cuStreamGetCaptureInfo_ptsz(
    CUstream hStream, CUstreamCaptureStatus *captureStatus_out,
    cuuint64_t *id_out);
...
CUresult CUDAAPI cuGraphAddKernelNode(
    CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies,
    size_t numDependencies, const CUDA_KERNEL_NODE_PARAMS_v1 *nodeParams);
CUresult CUDAAPI cuGraphKernelNodeGetParams(
    CUgraphNode hNode, CUDA_KERNEL_NODE_PARAMS_v1 *nodeParams);
CUresult CUDAAPI cuGraphKernelNodeSetParams(
...
CUresult CUDAAPI cuGraphInstantiate(CUgraphExec *phGraphExec, CUgraph hGraph,
                                    ...
                                    size_t bufferSize);
CUresult CUDAAPI cuGraphInstantiate_v2(CUgraphExec *phGraphExec, CUgraph hGraph,
...
cuGetProcAddress_v2_ptsz(const char *symbol, void **funcPtr, int driverVersion,
                         cuuint64_t flags,
                         CUdriverProcAddressQueryResult *symbolStatus) {
  ...
  return cuGetProcAddress_v2(symbol, funcPtr, driverVersion, flags,
                             symbolStatus);
}
