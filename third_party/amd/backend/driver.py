...
static PyObject* launch(PyObject* self, PyObject* args) {{
  ...
  _launch(gridX, gridY, gridZ, num_warps, num_ctas, launch_cooperative_grid, clusterDimX, clusterDimY, clusterDimZ, shared_memory, (hipStream_t)_stream, (hipFunction_t)_function, profile_scratch{', ' + ', '.join(internal_args_list) if len(internal_args_list) > 0 else ''});
...
class HIPLauncher(object):
    ...
    def __call__(self, gridX, gridY, gridZ, stream, function, *args):
        ...
        self.launch(gridX, gridY, gridZ, stream, function, self.launch_cooperative_grid, profile_scratch, *args)
