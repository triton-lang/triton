...
Pingponger::transformTwoClusterWithLocalLoadAndAll(OpBuilder &builder,
  ...
  // FIXME: This can be done in the tritonamdgpu-pipeline pass but currently
  // there's a know issue with combineRedundantWaitOps that produces incorrect
  // IR. Can be removed once the issue is fixed.
