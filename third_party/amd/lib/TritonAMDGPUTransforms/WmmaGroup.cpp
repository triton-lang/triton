...
#define TRITON_WMMA_v(v, m, n, aET, bET, opW, dET, symbol, k, kBase, feature)  \
  {                                                                            \
    /*key=*/                                                                   \
...
#define TRITON_WMMA_v3_n16(m, n, aET, bET, opW, dET, symbol, k, kBase,         \
                           feature)                                            \
  TRITON_WMMA_v(3, m, n, aET, bET, opW, dET, symbol, k, kBase, feature)
...
#define TRITON_WMMA_v_2case(v, m, n, aET, bET, opW, dET, symbol1, k1, kBase1,  \
                            feature1, symbol2, k2, kBase2, feature2)           \
  {                                                                            \
    /*key=*/                                                                   \
    {v, m, n, aET.getTypeID(), bET.getTypeID(), opW, dET.getTypeID()},         \
    /*value=*/{                                                                \
...
#define TRITON_WMMA_v2_2case(m, n, aET, bET, opW, dET, symbol1, k1, kBase1,    \
  ...
  constexpr StringLiteral kWmma256bOr128bInsts =
      "wmma-256b-insts|wmma-128b-insts";
  constexpr StringLiteral kWmma128bInsts = "wmma-128b-insts";
  constexpr StringLiteral kGfx1250Insts = "gfx1250-insts";
  ...
  wmmaMap = {
      ...
      TRITON_WMMA_v2_2case(16, 16, i4T, i4T, 4, i32T,
                           ...
                           kWmma128bInsts, "llvm.amdgcn.wmma.i32.16x16x16.iu4",
                           16, 8, kWmma256bOr128bInsts),
  };
}
