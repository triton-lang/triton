...
LogicalResult initSchedule(int maxDist, Stages &stages, int numStages,
  ...
  dumpSchedule(schedule, "[lowerLoops]after recovering gload & compute:");
...
void updateSchedule(scf::ForOp &forOp, const LoadToInfoMap &loadToInfo,
  ...
  dumpSchedule(schedule, "[lowerLoops]after scheduleStreamOps:");

  scheduleDependencies(forOp, schedule);
  dumpSchedule(schedule, "[lowerLoops]after scheduleDependencies:");
  ttg::scheduleDistanceOneDependencies(forOp, schedule);
  dumpSchedule(schedule, "[lowerLoops]after scheduleDistanceOneDependencies:");
  ...
  dumpSchedule(schedule, "[lowerLoops]after scheduleRemainingToLastStage:");
}
} // namespace SingleDotSchedule
...
void lowerLoop(scf::ForOp forOp,
  ...
  dumpSchedule(schedule, "[lowerLoops]deSeralized Schedule:");
