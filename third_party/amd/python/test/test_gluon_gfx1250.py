...
from triton.experimental.gluon.language.amd import PartitionedSharedLayout
...
@pytest.mark.skipif(not is_hip_gfx1250(), reason="Shared memory is only partitioned on GFX1250 hardware")
