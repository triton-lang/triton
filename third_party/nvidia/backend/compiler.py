...
class CUDABackend(BaseBackend):
    ...
    def make_llir(src, metadata, options, capability):
        ...
        nvidia.passes.ttnvgpuir.add_allocate_global_scratch_memory(pm)
        ...
        metadata["global_scratch_size"] = src.get_int_attr("triton_nvidia_gpu.global_scratch_memory_size")
        metadata["global_scratch_align"] = src.get_int_attr("triton_nvidia_gpu.global_scratch_memory_alignment")
        ret = str(llvm_mod)
        del llvm_mod
        del context
        return ret
