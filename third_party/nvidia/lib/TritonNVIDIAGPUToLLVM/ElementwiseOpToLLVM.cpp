...
bool optimizedClampPatternFound(ClampFOp op, int computeCapability) {
...
SmallVector<Value> emitDefault(ClampFOp op, ConversionPatternRewriter &rewriter,
                               Type elemTy, MultipleOperandsRange operands,
                               Location loc, int computeCapability) {
...
#undef POPULATE_UNARY_OP
  ...
  mlir::triton::populateClampFOpToLLVMPattern(
      typeConverter, patterns, axisInfoAnalysis, optimizedClampPatternFound,
      emitOptimization, emitDefault, computeCapability, benefit);
}
