...
module attributes {"ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", ttg.warp_specialize.tag = 0 : i32} {
  tt.func public @gemm_operand_view(%arg0: !ttg.memdesc<256x64xf16, #shared, #smem>, %arg1: !tt.tensordesc<tensor<64x64xf16, #shared>>, %arg2: !tt.tensordesc<tensor<64x64xf16, #shared>>, %arg3: f32, %arg4: i32) {
    ...
    scf.for %arg5 = %c0_i32 to %arg4 step %c64_i32  : i32 {
      ...
      %2 = ttg.memdesc_trans %1 {order = array<i32: 1, 0>, ttg.partition = array<i32: 1>} : !ttg.memdesc<64x64xf16, #shared, #smem> -> !ttg.memdesc<64x64xf16, #shared1, #smem>
      %3 = ttg.memdesc_trans %1 {order = array<i32: 1, 0>, ttg.partition = array<i32: 0>} : !ttg.memdesc<64x64xf16, #shared, #smem> -> !ttg.memdesc<64x64xf16, #shared1, #smem>
      %4 = ttg.memdesc_subslice %2[0, 0] {ttg.partition = array<i32: 1>} : !ttg.memdesc<64x64xf16, #shared1, #smem> -> !ttg.memdesc<64x64xf16, #shared1, #smem>
      %5 = ttng.tc_gen5_mma %arg0, %4, %result[%token], %false, %true {ttg.partition = array<i32: 1>} : !ttg.memdesc<256x64xf16, #shared, #smem>, !ttg.memdesc<64x64xf16, #shared1, #smem>, !ttg.memdesc<256x64xf32, #tmem, #ttng.tensor_memory, mutable>
      %6 = ttg.local_load %3 {ttg.partition = array<i32: 0>} : !ttg.memdesc<64x64xf16, #shared1, #smem> -> tensor<64x64xf16, #blocked>
      %result_0, %token_1 = ttng.tmem_load %result[%5] {ttg.partition = array<i32: 0>} : !ttg.memdesc<256x64xf32, #tmem, #ttng.tensor_memory, mutable> -> tensor<256x64xf32, #blocked1>
      "use"(%6, %result_0) {ttg.partition = array<i32: 0>} : (tensor<64x64xf16, #blocked>, tensor<256x64xf32, #blocked1>) -> ()
