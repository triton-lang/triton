...
module attributes {"nvws.warp-specialized" = true, "ttg.num-ctas" = 1 : i32, "ttg.num-stages" = 4 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32, ttg.warp_specialize.tag = 0 : i32} {
  tt.func public @gemm_persistent_flattened_fp16(%arg0: !tt.tensordesc<tensor<256x128xf16, #shared>>, %arg1: i32, %arg2: i32, %arg3: i64, %arg4: i64, %arg5: !tt.tensordesc<tensor<256x128xf16, #shared>>, %arg6: i32, %arg7: i32, %arg8: i64, %arg9: i64, %arg10: !tt.tensordesc<tensor<256x256xf16, #shared>>, %arg11: i32, %arg12: i32, %arg13: i64, %arg14: i64, %arg15: i32 {tt.divisibility = 16 : i32}, %arg16: i32 {tt.divisibility = 16 : i32}, %arg17: i32 {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %15:7 = scf.for %arg18 = %c0_i32 to %14 step %c1_i32 iter_args(%arg19 = %c-1_i32, %arg20 = %12, %arg21 = %c0_i32, %arg22 = %c0_i32, %arg23 = %12, %arg24 = %false, %arg25 = %token) -> (i32, i32, i32, i32, i32, i1, !ttg.async.token)  : i32 {
      ...
      %23 = tt.descriptor_load %arg0[%21#1, %22] {ttg.partition = array<i32: 0>} : !tt.tensordesc<tensor<256x128xf16, #shared>> -> tensor<256x128xf16, #blocked>
      %24 = ttg.local_alloc %23 {ttg.partition = array<i32: 0>} : (tensor<256x128xf16, #blocked>) -> !ttg.memdesc<256x128xf16, #shared, #smem>
      %25 = tt.descriptor_load %arg5[%21#2, %22] {ttg.partition = array<i32: 0>} : !tt.tensordesc<tensor<256x128xf16, #shared>> -> tensor<256x128xf16, #blocked>
      ...
      %28 = ttng.tc_gen5_mma %24, %27, %result[%arg25], %arg24, %true {ttg.partition = array<i32: 1>} : !ttg.memdesc<256x128xf16, #shared, #smem>, !ttg.memdesc<128x256xf16, #shared1, #smem>, !ttg.memdesc<256x256xf32, #tmem, #ttng.tensor_memory, mutable>
      ...
      %31:2 = scf.if %29 -> (i32, !ttg.async.token) {
        ...
        %43 = arith.truncf %result_0 {ttg.partition = array<i32: 2>} : tensor<256x256xf32, #blocked1> to tensor<256x256xf16, #blocked1>
        %44 = ttg.convert_layout %43 {ttg.partition = array<i32: 2>} : tensor<256x256xf16, #blocked1> -> tensor<256x256xf16, #blocked>
        tt.descriptor_store %arg10[%41, %42], %44 {ttg.partition = array<i32: 2>} : !tt.tensordesc<tensor<256x256xf16, #shared>>, tensor<256x256xf16, #blocked>
