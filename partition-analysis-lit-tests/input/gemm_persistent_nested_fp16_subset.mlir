...
module attributes {"nvws.warp-specialized" = true, "ttg.num-ctas" = 1 : i32, "ttg.num-stages" = 4 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @gemm_persistent_nested_fp16(%arg0: !tt.tensordesc<tensor<256x128xf16, #shared>> loc(unknown), %arg1: i32 loc(unknown), %arg2: i32 loc(unknown), %arg3: i64 loc(unknown), %arg4: i64 loc(unknown), %arg5: !tt.tensordesc<tensor<256x128xf16, #shared>> loc(unknown), %arg6: i32 loc(unknown), %arg7: i32 loc(unknown), %arg8: i64 loc(unknown), %arg9: i64 loc(unknown), %arg10: !tt.tensordesc<tensor<256x256xf16, #shared>> loc(unknown), %arg11: i32 loc(unknown), %arg12: i32 loc(unknown), %arg13: i64 loc(unknown), %arg14: i64 loc(unknown), %arg15: i32 {tt.divisibility = 16 : i32} loc(unknown), %arg16: i32 {tt.divisibility = 16 : i32} loc(unknown), %arg17: i32 {tt.divisibility = 16 : i32} loc(unknown)) attributes {noinline = false} {
    ...
    scf.for %arg18 = %0 to %7 step %9  : i32 {
      ...
      %20:3 = scf.for %arg19 = %c0_i32 to %6 step %c1_i32 iter_args(%arg20 = %c0_i32, %arg21 = %false, %arg22 = %token) -> (i32, i1, !ttg.async.token)  : i32 {
        %23 = tt.descriptor_load %arg0[%18, %arg20] : !tt.tensordesc<tensor<256x128xf16, #shared>> -> tensor<256x128xf16, #blocked>
        %24 = ttg.local_alloc %23 : (tensor<256x128xf16, #blocked>) -> !ttg.memdesc<256x128xf16, #shared, #smem>
        %25 = tt.descriptor_load %arg5[%19, %arg20] : !tt.tensordesc<tensor<256x128xf16, #shared>> -> tensor<256x128xf16, #blocked>
        %26 = ttg.local_alloc %25 : (tensor<256x128xf16, #blocked>) -> !ttg.memdesc<256x128xf16, #shared, #smem>
        %27 = ttg.memdesc_trans %26 {order = array<i32: 1, 0>} : !ttg.memdesc<256x128xf16, #shared, #smem> -> !ttg.memdesc<128x256xf16, #shared1, #smem>
        %28 = ttng.tc_gen5_mma %24, %27, %result[%arg22], %arg21, %true : !ttg.memdesc<256x128xf16, #shared, #smem>, !ttg.memdesc<128x256xf16, #shared1, #smem>, !ttg.memdesc<256x256xf32, #tmem, #ttng.tensor_memory, mutable>
        %29 = arith.addi %arg20, %c128_i32 : i32
      ...
      %21 = arith.truncf %result_0 : tensor<256x256xf32, #blocked1> to tensor<256x256xf16, #blocked1>
      %22 = ttg.convert_layout %21 : tensor<256x256xf16, #blocked1> -> tensor<256x256xf16, #blocked>
      tt.descriptor_store %arg10[%18, %19], %22 : !tt.tensordesc<tensor<256x256xf16, #shared>>, tensor<256x256xf16, #blocked>
    } {"nvws.warp-specialize"}
    tt.return
  }
}
