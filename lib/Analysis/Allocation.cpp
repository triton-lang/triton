...
unsigned getNumScratchElemsSwizzledCvt(
  ...
  auto smem =
      gpu::optimalSwizzlingLdSt(srcLayoutNoBroadcast, dstLayoutNoBroadcast,
                                bitwidth, numBanks, srcTiles, dstTiles);
...
unsigned
getNumScratchElemsSwizzledCvt(RankedTensorType srcTy, RankedTensorType dstTy,
                              int numBanks,
  ...
  return getNumScratchElemsSwizzledCvt(
      ...
      getBitwidth(srcTy), numBanks, srcTiles, dstTiles);
}
