...
void populateTritonPatterns(TritonGPUTypeConverter &typeConverter,
  ...
  patterns.insert< // TODO: view should have custom pattern that views the
      ...
      GenericOpPattern<triton::ExperimentalTensormapReplaceRankOp>,
      GenericOpPattern<triton::ExperimentalTensormapAllocOp>,
      GenericOpPattern<triton::ExperimentalTensormapDeallocOp>,
      GenericOpPattern<triton::ExperimentalTensormapReplaceRankOp>,
      GenericOpPattern<triton::ExperimentalTensormapReplaceBoxDimOp>,
      GenericOpPattern<triton::ExperimentalTensormapReplaceGlobalDimOp>,
      GenericOpPattern<triton::ExperimentalTensormapReplaceGlobalStrideOp>,
      GenericOpPattern<triton::ExperimentalTensormapReplaceElementStrideOp>,
      GenericOpPattern<triton::ExperimentalTensormapReplaceElemTypeOp>,
      GenericOpPattern<triton::ExperimentalTensormapReplaceSwizzleModeOp>,
      GenericOpPattern<triton::ExperimentalTensormapReplaceFillModeOp>,
      GenericOpPattern<triton::ExperimentalTensormapCpFenceproxyOp>,
