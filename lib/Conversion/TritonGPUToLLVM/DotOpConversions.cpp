...
LogicalResult
DotOpConversion::matchAndRewrite(triton::DotOp op, DotOpAdaptor adaptor,
...
LogicalResult
DotOpConversion::convertMMA16816(triton::DotOp op, DotOpAdaptor adaptor,
                                 ConversionPatternRewriter &rewriter) const {
  auto loc = op.getLoc();
...
LogicalResult
DotOpConversion::convertFMADot(triton::DotOp op, DotOpAdaptor adaptor,
                               ConversionPatternRewriter &rewriter) const {
