...
struct LoadStoreMemSpace
    : public PassInfoMixin<LoadStoreMemSpace> {
...
void InstrumentationFunction(const BasicBlock::iterator &I, const Function &F, const llvm::Module &M,
...
PassPluginLibraryInfo getPassPluginInfo() {
  ...
  return {LLVM_PLUGIN_API_VERSION, "print-mem-space",
