...
@triton.jit
def _memset_metadata(Hist, n_expts_tot, MDHist, MDTokStarts, MDTileStarts, MDTileInfo, md_n_tiles, BLOCK: tl.constexpr,
...
@triton.jit
def _compute_metadata(Hist, MDTileStarts, MDTileInfo, BLOCK: tl.constexpr, TILE_DIM: tl.constexpr):
