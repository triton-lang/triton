...
def bench_mlp(batch, dim1, dim2, n_expts_tot, n_expts_act, x_dtype, w_dtype,
    ...
    min_time_flops = viewer.get_min_time_flops(gf.dataframe.head(1), device_info, exclusive=False)
    min_time_bytes = viewer.get_min_time_bytes(gf.dataframe.head(1), device_info, exclusive=False)
