...
if __name__ == "__main__":
    ...
    roofline_mlp(batch_ranges_moe, 8192, 8192, 128, 4, *dense_dtypes, TP=1, EP=1, name="llama4-maverick")
    roofline_mlp(batch_ranges_moe, 8192, 8192, 128, 4, *quantized_dtypes, TP=1, EP=1, name="llama4-maverick")
