...
def _build_test_op_cases():
    ...
    test_cases.extend([
        Case(128, 128, 128, "plain", "bfloat16", b_dtype)
        for b_dtype in ("nvfp4_e2m1", "nvfp4_e2m1_fiber")
    ])
    # float8 x mxfloat
    test_cases.extend([
    ...
    # nvfp4 x dense
    test_cases.extend([
        Case(128, 128, 128, "plain", a_dtype, b_dtype, "bfloat16")
        for a_dtype in ("nvfp4_e2m1", "nvfp4_e2m1_fiber")
        for b_dtype in ("bfloat16", "float16")
    ])
    # mxfloat x mxfloat
    test_cases.extend([
        ...
        *[
        ...
        Case(128, 128, 128, "plain", "nvfp4_e2m1_fiber", "nvfp4_e2m1_fiber", "nvfp4_e2m1"),
