...
def _swiglu(Out, OutExpectedScale, A, AScale, alpha, M, N, stride_am, stride_an, stride_outm, stride_outn,
            limit: tl.constexpr, NTokens, BLOCK_M: tl.constexpr, BLOCK_N: tl.constexpr, EVEN_N: tl.constexpr, M_BLOCKS,
            N_BLOCKS):
