...
def make_default_opt_flags_nvidia(
    ...
    requires_persistent = (_layout_name(precision_config.act_scale) is not None or _layout_name(precision_config.weight_scale) is not None) and target_info.has_native_mxfp()
