...
def apply_precision(x_tri, w_tri, precision_config):
    ...
    if precision_config.a_mx_scale is not None:
        ...
        canonical_layout = layout.StridedLayout([2, 1, 0])
        x_tri = convert_layout(x_tri, canonical_layout)
        x_tri_scale = convert_layout(precision_config.a_mx_scale, canonical_layout)
        print("---- x_tri ----")
        print(x_tri.storage.data.shape)
        print(x_tri.storage.data.stride())
        print(x_tri.storage.data)
        print("---- x_tri_scale ----")
        print(x_tri_scale.storage.data.shape)
        print(x_tri_scale.storage.data.stride())
        print(x_tri_scale.storage.data)
    ...
    if precision_config.b_mx_scale is not None:
        ...
        canonical_layout = layout.StridedLayout([1, 2, 0])
        w_tri = convert_layout(w_tri, canonical_layout)
        w_tri_scale = convert_layout(precision_config.b_mx_scale, canonical_layout)
        print("---- w_tri ----")
        print(w_tri.storage.data.shape)
        print(w_tri.storage.data.stride())
        print(w_tri.storage.data)
        print("---- w_tri_scale ----")
        print(w_tri_scale.storage.data.shape)
        print(w_tri_scale.storage.data.stride())
        print(w_tri_scale.storage.data)
