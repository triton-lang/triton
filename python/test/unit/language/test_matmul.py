...
def test_mxfp8_mxfp4_matmul(M, N, K, BLOCK_M, BLOCK_N, BLOCK_K, NUM_STAGES, B_TRANS, PACK_B_ALONG_K, CONST_SCALE,
    ...
    if is_cuda():
        ...
        if (is_hip_cdna4() and nonKDim == 0 and (BLOCK_M, BLOCK_N, BLOCK_K) == (128, 64, 128) and NUM_STAGES == 3
                and A_DATA_TYPE == "float8e5" and B_DATA_TYPE == "float4" and WITH_A_SCALE and WITH_B_SCALE
                and not CONST_SCALE and not PACK_B_ALONG_K and not B_TRANS):
