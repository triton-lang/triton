...
STRIDE_CM_HINTS = {k: (v if k != "stride_cm" else 16) for k, v in DEFAULT_MATMUL_HINTS.items()}
STRIDE_AM_HINTS = {k: (v if k != "stride_am" else 16) for k, v in DEFAULT_MATMUL_HINTS.items()}
STRIDE_CM_AM_HINTS = {k: (v if k != "stride_cm" and k != "stride_am" else 16) for k, v in DEFAULT_MATMUL_HINTS.items()}
...
NO_HINT_SIGNATURE = ("*fp32, *fp16, *fp16, i32, i32, i32, i32, i32, i32, i32, i32, i32, 16, 16, 16")
