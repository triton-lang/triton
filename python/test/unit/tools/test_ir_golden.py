...
from triton.tools.ir_golden import (SCHEMA_VERSION, GoldenCorpus, GoldenCorpusError, capture_compilations,
                                    ...
                                    normalize_source, verify_payload, write_shard)
...
def pytest_generate_tests(metafunc: pytest.Metafunc) -> None:
    ...
    metafunc.parametrize("production_golden_case", corpus.cases,
                         ids=[f"{case.language}-{case.kernel}-{case.case_id[:12]}" for case in corpus.cases])
