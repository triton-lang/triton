...
test_stdout ='Hello From First Instruction of AMDGPU Kernel: _attn_fwd\ttest_fused-attention.py:113:28\nHello From First Instruction of AMDGPU Kernel: _attn_fwd\ttest_fused-attention.py:113:28\nHello From First Instruction of AMDGPU Kernel: _attn_bwd_preprocess\ttest_fused-attention.py:197:26\nHello From First Instruction of AMDGPU Kernel: _attn_bwd\ttest_fused-attention.py:325:25\n'

@pytest.mark.parametrize("Z, H, N_CTX, HEAD_DIM", [(1, 2, 1024, 64)])
@pytest.mark.parametrize("causal", [True])
def test_op(capfd, Z, H, N_CTX, HEAD_DIM, causal, dtype=torch.float16):
