...
matmul_data = {
    ...
    (256, 256, 256): {
        'v100': {'float16': 0.027},
        'a100': {'float16': 0.010, 'float32': 0.0214, 'int8': 0.006}},
    (512, 512, 512): {
        'v100': {'float16': 0.158},
        'a100': {'float16': 0.061, 'float32': 0.109, 'int8': 0.030}},
    (1024, 1024, 1024): {
        'v100': {'float16': 0.466},
        'a100': {'float16': 0.287, 'float32': 0.331, 'int8': 0.169}},
    (2048, 2048, 2048): {
        'v100': {'float16': 0.680},
        'a100': {'float16': 0.604, 'float32': 0.599, 'int8': 0.385}},
    (4096, 4096, 4096): {
        'v100': {'float16': 0.831},
        'a100': {'float16': 0.842, 'float32': 0.862, 'int8': 0.711}},
    (8192, 8192, 8192): {
        'v100': {'float16': 0.849},
        'a100': {'float16': 0.896, 'float32': 0.932, 'int8': 0.860}},
    # tall-skinny
    (16, 1024, 1024): {
        'v100': {'float16': 0.0128},
        'a100': {'float16': 0.0077, 'float32': 0.0127, 'int8': 0.005}},
    (16, 4096, 4096): {
        'v100': {'float16': 0.0883},
        'a100': {'float16': 0.0363, 'float32': 0.0457, 'int8': 0.0259}},
    (16, 8192, 8192): {
        'v100': {'float16': 0.101},
        'a100': {'float16': 0.0564, 'float32': 0.0648, 'int8': 0.0431}},
    (64, 1024, 1024): {
        'v100': {'float16': 0.073},
        'a100': {'float16': 0.0271, 'float32': 0.0509, 'int8': 0.0169}},
    (64, 4096, 4096): {
        'v100': {'float16': 0.270},
        'a100': {'float16': 0.141, 'float32': 0.162, 'int8': 0.097}},
    (64, 8192, 8192): {
        'v100': {'float16': 0.459},
        'a100': {'float16': 0.244, 'float32': 0.257, 'int8': 0.174}},
    (1024, 64, 1024): {
        'v100': {'float16': 0.0692},
        'a100': {'float16': 0.0263, 'float32': 0.0458, 'int8': 0.017}},
    (4096, 64, 4096): {
        'v100': {'float16': 0.264},
        'a100': {'float16': 0.135, 'float32': 0.177, 'int8': 0.102}},
    (8192, 64, 8192): {
        'v100': {'float16': 0.452},
        'a100': {'float16': 0.216, 'float32': 0.230, 'int8': 0.177}},
    #   # deep reductions
    #   (64  , 64  , 16384) : {'a100': 0.},
    #   (64  , 64  , 65536) : {'a100': 0.},
    #   (256 , 256 , 8192 ) : {'a100': 0.},
