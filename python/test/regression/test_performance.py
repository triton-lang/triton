...
matmul_data = {
    ...
    (1024, 1024, 1024): {
        'v100': {'float16': 0.466},
        'a100': {'float16': 0.287, 'float32': 0.310, 'int8': 0.138}},
    (2048, 2048, 2048): {
        'v100': {'float16': 0.680},
        'a100': {'float16': 0.604, 'float32': 0.569, 'int8': 0.321}},
    (4096, 4096, 4096): {
        'v100': {'float16': 0.831},
        'a100': {'float16': 0.842, 'float32': 0.862, 'int8': 0.480}},
    (8192, 8192, 8192): {
        'v100': {'float16': 0.849},
        'a100': {'float16': 0.896, 'float32': 0.932, 'int8': 0.547}},
    # tall-skinny
    (16, 1024, 1024): {
        'v100': {'float16': 0.0128},
    ...
    (64, 4096, 4096): {
        'v100': {'float16': 0.270},
        'a100': {'float16': 0.119, 'float32': 0.162, 'int8': 0.077}},
    (64, 8192, 8192): {
        'v100': {'float16': 0.360},
        'a100': {'float16': 0.217, 'float32': 0.257, 'int8': 0.137}},
    (1024, 64, 1024): {
        'v100': {'float16': 0.0692},
        'a100': {'float16': 0.0263, 'float32': 0.0458, 'int8': 0.017}},
    (4096, 64, 4096): {
        'v100': {'float16': 0.264},
        'a100': {'float16': 0.119, 'float32': 0.150, 'int8': 0.081}},
    (8192, 64, 8192): {
        'v100': {'float16': 0.323},
        'a100': {'float16': 0.187, 'float32': 0.230, 'int8': 0.152}},
    #   # deep reductions
    #   (64  , 64  , 16384) : {'a100': 0.},
    #   (64  , 64  , 65536) : {'a100': 0.},
    #   (256 , 256 , 8192 ) : {'a100': 0.},
