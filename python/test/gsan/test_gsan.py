...
@pytest.mark.parametrize("buffers", [4, 6])
def test_tcgen05_mma_scaled_k96_completion(with_gsan, fmt, buffers, monkeypatch):
    ...
    epilogue = 16 if fmt == "nvfp4" and buffers == 6 else 32
    for _ in range(3):
