...
def _reduce_layouts():
    ...
    layouts = _filter_layouts([
        ...
        ttgl.amd.AMDMFMALayout(version=1, warps_per_cta=[1, 4], tiles_per_warp=[1, 1], instr_shape=[32, 32, 8],
                               transposed=True),
        ttgl.amd.AMDMFMALayout(version=2, warps_per_cta=[1, 4], tiles_per_warp=[1, 1], instr_shape=[32, 32, 8],
                               transposed=True),
        ttgl.amd.AMDMFMALayout(version=3, warps_per_cta=[1, 4], tiles_per_warp=[1, 1], instr_shape=[32, 32, 8],
                               transposed=True),
        ttgl.amd.AMDMFMALayout(version=4, warps_per_cta=[1, 4], tiles_per_warp=[1, 1], instr_shape=[32, 32, 16],
                               transposed=True),
...
_mma_pairs = [
    ...
    # AMD MFMA v1 layouts
    [
        ttgl.amd.AMDMFMALayout(version=1, warps_per_cta=[2, 2], instr_shape=[32, 32, 8], transposed=True),
        ttgl.amd.AMDMFMALayout(version=1, warps_per_cta=[4, 1], instr_shape=[32, 32, 8], transposed=True),
    ],
    [
        ttgl.amd.AMDMFMALayout(version=1, warps_per_cta=[4, 4], instr_shape=[16, 16, 8], transposed=True),
        ttgl.amd.AMDMFMALayout(version=1, warps_per_cta=[16, 1], instr_shape=[16, 16, 8], transposed=True),
    ],
    # AMD MFMA v2 layouts
    [
        ttgl.amd.AMDMFMALayout(version=2, warps_per_cta=[2, 2], instr_shape=[32, 32, 8], transposed=True),
        ttgl.amd.AMDMFMALayout(version=2, warps_per_cta=[4, 1], instr_shape=[32, 32, 8], transposed=True),
    ],
    [
        ttgl.amd.AMDMFMALayout(version=2, warps_per_cta=[4, 4], instr_shape=[16, 16, 16], transposed=True),
        ttgl.amd.AMDMFMALayout(version=2, warps_per_cta=[16, 1], instr_shape=[16, 16, 16], transposed=True),
    ],
    # AMD MFMA v3 layouts
    [
        ttgl.amd.AMDMFMALayout(version=3, warps_per_cta=[2, 2], instr_shape=[32, 32, 8], transposed=True),
        ttgl.amd.AMDMFMALayout(version=3, warps_per_cta=[4, 1], instr_shape=[32, 32, 8], transposed=True),
    ],
    [
        ttgl.amd.AMDMFMALayout(version=3, warps_per_cta=[4, 4], instr_shape=[16, 16, 16], transposed=True),
        ttgl.amd.AMDMFMALayout(version=3, warps_per_cta=[16, 1], instr_shape=[16, 16, 16], transposed=True),
    ],
    # AMD MFMA v4 layouts
    [
        ttgl.amd.AMDMFMALayout(version=4, warps_per_cta=[2, 2], instr_shape=[32, 32, 16], transposed=True),
        ttgl.amd.AMDMFMALayout(version=4, warps_per_cta=[4, 1], instr_shape=[32, 32, 16], transposed=True),
    ],
    [
        ttgl.amd.AMDMFMALayout(version=4, warps_per_cta=[4, 4], instr_shape=[16, 16, 32], transposed=True),
        ttgl.amd.AMDMFMALayout(version=4, warps_per_cta=[16, 1], instr_shape=[16, 16, 32], transposed=True),
    ],
    # AMD WMMA v1 layouts
    [
