...
def _reduce_layouts():
    ...
    layouts = _filter_layouts([
        ...
        ttgl.amd.AMDMFMALayout(version=4, warps_per_cta=[1, 4], tiles_per_warp=[1, 1], instr_shape=[32, 32],
                               transposed=True),
        ttgl.amd.AMDWMMALayout(version=1, transposed=True, warps_per_cta=[1, 4], instr_shape=[16, 16, 16]),
        ttgl.amd.AMDWMMALayout(version=2, transposed=True, warps_per_cta=[1, 4], instr_shape=[16, 16, 16]),
...
_mma_pairs = [
    ...
    # AMD WMMA v1 layouts
    [
        ttgl.amd.AMDWMMALayout(version=1, transposed=True, warps_per_cta=[4, 4], instr_shape=[16, 16, 16]),
        ttgl.amd.AMDWMMALayout(version=1, transposed=True, warps_per_cta=[16, 1], instr_shape=[16, 16, 16]),
    ],
    # AMD WMMA v2 layouts
    [
        ttgl.amd.AMDWMMALayout(version=2, transposed=True, warps_per_cta=[4, 4], instr_shape=[16, 16, 16]),
        ttgl.amd.AMDWMMALayout(version=2, transposed=True, warps_per_cta=[16, 1], instr_shape=[16, 16, 16]),
    ],
]
