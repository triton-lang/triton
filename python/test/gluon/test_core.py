...
def test_tmem_copy_2d():
    ...
    def kernel(in_ptr, out_ptr, smem_h: ttgl.constexpr, smem_w: ttgl.constexpr, num_rows: ttgl.constexpr,
        ...
        tmem_alias: ttgl.constexpr = TensorMemoryLayout((128, 32), unpacked=False, bitwidth=8)
...
def test_tmem_subslice_block_m_64():
    ...
    def kernel(s_ptr, out_ptr):
        ...
        tmem_layout: ttgl.constexpr = TensorMemoryLayout((BLOCK_M, BLOCK_N), unpacked=True, bitwidth=32)
        ...
        p_tmem_layout: ttgl.constexpr = TensorMemoryLayout((BLOCK_M, BLOCK_N), unpacked=False, bitwidth=16)
        ...
        d1_tmem_layout: ttgl.constexpr = TensorMemoryLayout((BLOCK_M, 1), unpacked=True, bitwidth=32)
...
def test_block_m_64_mma():
    ...
    def kernel(a_ptr, b_ptr, c_ptr, d_ptr):
        ...
        a_tmem_layout: ttgl.constexpr = TensorMemoryLayout((BLOCK_M, BLOCK_N), unpacked=False, bitwidth=16)
        acc_tmem_layout: ttgl.constexpr = TensorMemoryLayout((BLOCK_M, BLOCK_N), unpacked=True, bitwidth=32)
...
def test_tmem_copy_no_scales(M, N, BLOCK_N, num_warps, swizzle):
    ...
    def tmem_copy_no_scales(in_ptr, out_ptr, M: ttgl.constexpr, N: ttgl.constexpr, BLOCK_N: ttgl.constexpr,
        ...
        tmem_layout: ttgl.constexpr = TensorMemoryLayout(
            block=(128, BLOCK_N),
            unpacked=True,
            bitwidth=in_ptr.dtype.element_ty.primitive_bitwidth,
        )
