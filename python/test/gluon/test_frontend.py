...
def test_tensor_memory():
    ...
    tmem_layout = TensorMemoryLayout(block=[128, 128], unpacked=True, bitwidth=32)
    mod = run_parser(
...
def test_tcgen05_mma():
    ...
    acc_layout = TensorMemoryLayout([128, 128], unpacked=True, bitwidth=16)
...
def tmem_index_kernel():
    layout: ttgl.constexpr = TensorMemoryLayout(block=[128, 128], unpacked=True, bitwidth=32)
