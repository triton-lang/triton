...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "...", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @broadcast_kernel() attributes {noinline = false} {
    ...
    %1 = tt.reshape %0 : tensor<16xi32, #ttg.slice<{dim = 0, parent = #blocked}>> -> tensor<1x16xi32, #blocked>
    %2 = tt.make_range {end = 16 : i32, start = 0 : i32} : tensor<16xi32, #ttg.slice<{dim = 1, parent = #blocked}>>
    %3 = tt.reshape %2 : tensor<16xi32, #ttg.slice<{dim = 1, parent = #blocked}>> -> tensor<16x1xi32, #blocked>
    %c0_i32 = arith.constant 0 : i32
    %c0_i32_0 = arith.constant 0 : i32
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "...", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @libdevice_implicit_broadcast_kernel() attributes {noinline = false} {
    ...
    %0 = tt.reshape %cst_2 : tensor<32xf32, #ttg.slice<{dim = 0, parent = #blocked}>> -> tensor<1x32xf32, #blocked>
    %cst_3 = arith.constant 4.000000e+00 : f32
    %cst_4 = arith.constant dense<4.000000e+00> : tensor<4xf32, #ttg.slice<{dim = 1, parent = #blocked}>>
    %1 = tt.reshape %cst_4 : tensor<4xf32, #ttg.slice<{dim = 1, parent = #blocked}>> -> tensor<4x1xf32, #blocked>
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "...", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @amd_async_copy_global_to_shared(%arg0: !tt.ptr<f16> {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %6 = tt.reshape %2 : tensor<16xi32, #ttg.slice<{dim = 0, parent = #blocked}>> -> tensor<1x16xi32, #blocked>
    %7 = tt.broadcast %5 : tensor<128x1xi32, #blocked> -> tensor<128x16xi32, #blocked>
    %8 = tt.broadcast %6 : tensor<1x16xi32, #blocked> -> tensor<128x16xi32, #blocked>
    %9 = arith.addi %7, %8 : tensor<128x16xi32, #blocked>
    %10 = tt.splat %arg0 : !tt.ptr<f16> -> tensor<128x16x!tt.ptr<f16>, #blocked>
    %11 = tt.addptr %10, %9 : tensor<128x16x!tt.ptr<f16>, #blocked>, tensor<128x16xi32, #blocked>
    %12 = ttg.async_copy_global_to_local %11, %0 : tensor<128x16x!tt.ptr<f16>, #blocked> -> <128x16xf16, #shared, #smem, mutable>
    ...
    %14 = tt.reshape %13 : tensor<128xi1, #ttg.slice<{dim = 1, parent = #blocked}>> -> tensor<128x1xi1, #linear>
    %15 = ttg.convert_layout %14 : tensor<128x1xi1, #linear> -> tensor<128x1xi1, #blocked>
    %16 = tt.splat %arg0 : !tt.ptr<f16> -> tensor<128x16x!tt.ptr<f16>, #blocked>
    %17 = tt.addptr %16, %9 : tensor<128x16x!tt.ptr<f16>, #blocked>, tensor<128x16xi32, #blocked>
    %18 = tt.broadcast %15 : tensor<128x1xi1, #blocked> -> tensor<128x16xi1, #blocked>
    %19 = ttg.async_copy_global_to_local %17, %0 mask %18 : tensor<128x16x!tt.ptr<f16>, #blocked> -> <128x16xf16, #shared, #smem, mutable>
    %20 = tt.splat %arg0 : !tt.ptr<f16> -> tensor<128x16x!tt.ptr<f16>, #blocked>
    %21 = tt.addptr %20, %9 : tensor<128x16x!tt.ptr<f16>, #blocked>, tensor<128x16xi32, #blocked>
    %22 = tt.broadcast %15 : tensor<128x1xi1, #blocked> -> tensor<128x16xi1, #blocked>
    %cst_2 = arith.constant 0.000000e+00 : f32
    %23 = arith.truncf %cst_2 : f32 to f16
    %24 = tt.splat %23 : f16 -> tensor<128x16xf16, #blocked>
    %25 = ttg.async_copy_global_to_local %21, %0 mask %22 other %24 : tensor<128x16x!tt.ptr<f16>, #blocked> -> <128x16xf16, #shared, #smem, mutable>
    %cst_3 = arith.constant 0.000000e+00 : f16
    ...
    %27 = tt.addptr %26, %9 : tensor<128x16x!tt.ptr<f16>, #blocked>, tensor<128x16xi32, #blocked>
    %28 = tt.broadcast %15 : tensor<128x1xi1, #blocked> -> tensor<128x16xi1, #blocked>
    %29 = ttg.async_copy_global_to_local %27, %0 mask %28 other %cst_4 : tensor<128x16x!tt.ptr<f16>, #blocked> -> <128x16xf16, #shared, #smem, mutable>
    %30 = ttg.async_commit_group
    tt.return
  }
}
""")
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "...", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @amd_async_copy_shared_to_global(%arg0: !tt.ptr<f16> {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %10 = tt.splat %arg0 : !tt.ptr<f16> -> tensor<128x16x!tt.ptr<f16>, #blocked>
    %11 = tt.addptr %10, %9 : tensor<128x16x!tt.ptr<f16>, #blocked>, tensor<128x16xi32, #blocked>
    %12 = amdg.async_copy_local_to_global %0, %11 : !ttg.memdesc<128x16xf16, #shared, #smem, mutable> -> tensor<128x16x!tt.ptr<f16>, #blocked>
    %c64_i32 = arith.constant 64 : i32
    %cst_1 = arith.constant dense<64> : tensor<128xi32, #ttg.slice<{dim = 1, parent = #blocked}>>
    %13 = arith.cmpi slt, %1, %cst_1 : tensor<128xi32, #ttg.slice<{dim = 1, parent = #blocked}>>
    %14 = tt.reshape %13 : tensor<128xi1, #ttg.slice<{dim = 1, parent = #blocked}>> -> tensor<128x1xi1, #linear>
    ...
    %17 = tt.addptr %16, %9 : tensor<128x16x!tt.ptr<f16>, #blocked>, tensor<128x16xi32, #blocked>
    %18 = tt.broadcast %15 : tensor<128x1xi1, #blocked> -> tensor<128x16xi1, #blocked>
    %19 = amdg.async_copy_local_to_global %0, %17 mask %18 : !ttg.memdesc<128x16xf16, #shared, #smem, mutable> -> tensor<128x16x!tt.ptr<f16>, #blocked>
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "...", "ttg.threads-per-warp" = 64 : i32} {
  tt.func public @amd_global_load_to_shared(%arg0: !tt.ptr<f16> {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %17 = tt.addptr %16, %9 : tensor<128x16x!tt.ptr<f16>, #blocked>, tensor<128x16xi32, #blocked>
    %18 = tt.broadcast %15 : tensor<128x1xi1, #blocked> -> tensor<128x16xi1, #blocked>
    %19 = ttg.async_copy_global_to_local %17, %0 mask %18 other %cst_3 : tensor<128x16x!tt.ptr<f16>, #blocked> -> <128x16xf16, #shared, #smem, mutable>
    %cst_4 = arith.constant 0.000000e+00 : f16
    %cst_5 = arith.constant dense<0.000000e+00> : tensor<128x1xf16, #blocked>
    %20 = tt.splat %arg0 : !tt.ptr<f16> -> tensor<128x16x!tt.ptr<f16>, #blocked>
    %21 = tt.addptr %20, %9 : tensor<128x16x!tt.ptr<f16>, #blocked>, tensor<128x16xi32, #blocked>
    %22 = tt.broadcast %15 : tensor<128x1xi1, #blocked> -> tensor<128x16xi1, #blocked>
    %23 = tt.broadcast %cst_5 : tensor<128x1xf16, #blocked> -> tensor<128x16xf16, #blocked>
    %24 = ttg.async_copy_global_to_local %21, %0 mask %22 other %23 : tensor<128x16x!tt.ptr<f16>, #blocked> -> <128x16xf16, #shared, #smem, mutable>
    %25 = tt.splat %arg0 : !tt.ptr<f16> -> tensor<128x16x!tt.ptr<f16>, #blocked>
    %26 = tt.addptr %25, %9 : tensor<128x16x!tt.ptr<f16>, #blocked>, tensor<128x16xi32, #blocked>
    %27 = tt.broadcast %15 : tensor<128x1xi1, #blocked> -> tensor<128x16xi1, #blocked>
    %cst_6 = arith.constant 0.000000e+00 : f32
    %28 = arith.truncf %cst_6 : f32 to f16
    %29 = tt.splat %28 : f16 -> tensor<128x16xf16, #blocked>
    %30 = ttg.async_copy_global_to_local %26, %0 mask %27 other %29 : tensor<128x16x!tt.ptr<f16>, #blocked> -> <128x16xf16, #shared, #smem, mutable>
    tt.return
  }
}
""")
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "...", "ttg.threads-per-warp" = 64 : i32} {
  tt.func public @buffer_load_to_shared_kernel(%arg0: !tt.ptr<f16> {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %8 = tt.broadcast %6 : tensor<1x16xi32, #blocked> -> tensor<128x16xi32, #blocked>
    %9 = arith.addi %7, %8 : tensor<128x16xi32, #blocked>
    %10 = amdg.buffer_load_to_local %arg0[%9] into %0 : <f16>[tensor<128x16xi32, #blocked>]  -> <128x16xf16, #shared, #smem, mutable>
    %11 = amdg.buffer_load_to_local %arg0[%9] cacheModifier = ca into %0 : <f16>[tensor<128x16xi32, #blocked>]  -> <128x16xf16, #shared, #smem, mutable>
    %12 = amdg.buffer_load_to_local %arg0[%9] cacheModifier = cg into %0 : <f16>[tensor<128x16xi32, #blocked>]  -> <128x16xf16, #shared, #smem, mutable>
    %13 = amdg.buffer_load_to_local %arg0[%9] cacheModifier = cv into %0 : <f16>[tensor<128x16xi32, #blocked>]  -> <128x16xf16, #shared, #smem, mutable>
    %c64_i32 = arith.constant 64 : i32
    %cst_1 = arith.constant dense<64> : tensor<128xi32, #ttg.slice<{dim = 1, parent = #blocked}>>
    ...
    %cst_2 = arith.constant 0.000000e+00 : f16
    %cst_3 = arith.constant dense<0.000000e+00> : tensor<128x16xf16, #blocked>
    %17 = tt.broadcast %16 : tensor<128x1xi1, #blocked> -> tensor<128x16xi1, #blocked>
    %18 = amdg.buffer_load_to_local %arg0[%9] mask = %17 other = %cst_3 into %0 : <f16>[tensor<128x16xi32, #blocked>] tensor<128x16xf16, #blocked> -> <128x16xf16, #shared, #smem, mutable>
    %cst_4 = arith.constant 0.000000e+00 : f16
    %cst_5 = arith.constant dense<0.000000e+00> : tensor<128x1xf16, #blocked>
    %19 = tt.broadcast %16 : tensor<128x1xi1, #blocked> -> tensor<128x16xi1, #blocked>
    %20 = tt.broadcast %cst_5 : tensor<128x1xf16, #blocked> -> tensor<128x16xf16, #blocked>
    %21 = amdg.buffer_load_to_local %arg0[%9] mask = %19 other = %20 into %0 : <f16>[tensor<128x16xi32, #blocked>] tensor<128x16xf16, #blocked> -> <128x16xf16, #shared, #smem, mutable>
    %22 = tt.broadcast %16 : tensor<128x1xi1, #blocked> -> tensor<128x16xi1, #blocked>
    %cst_6 = arith.constant 0.000000e+00 : f32
    %23 = arith.truncf %cst_6 : f32 to f16
    %24 = tt.splat %23 : f16 -> tensor<128x16xf16, #blocked>
    %25 = amdg.buffer_load_to_local %arg0[%9] mask = %22 other = %24 into %0 : <f16>[tensor<128x16xi32, #blocked>] tensor<128x16xf16, #blocked> -> <128x16xf16, #shared, #smem, mutable>
    tt.return
  }
}
""")
