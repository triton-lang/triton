...
def main():
    ...
    #Source files
    src =  'src/lib/random/rand.cpp src/lib/driver/command_queue.cpp src/lib/driver/check.cpp src/lib/driver/context.cpp src/lib/driver/backend.cpp src/lib/driver/dispatch.cpp src/lib/driver/handle.cpp src/lib/driver/device.cpp src/lib/driver/event.cpp src/lib/driver/buffer.cpp src/lib/driver/program_cache.cpp src/lib/driver/program.cpp src/lib/driver/ndrange.cpp src/lib/driver/kernel.cpp src/lib/driver/platform.cpp src/lib/array.cpp src/lib/exception/driver.cpp src/lib/exception/api.cpp src/lib/runtime/profiles.cpp src/lib/runtime/database.cpp src/lib/runtime/execute.cpp src/lib/runtime/predictors/random_forest.cpp src/lib/api/blas/cublas.cpp src/lib/api/blas/clBLAS.cpp src/lib/jit/generation/base.cpp src/lib/jit/generation/elementwise_2d.cpp src/lib/jit/generation/engine/stream.cpp src/lib/jit/generation/engine/keywords.cpp src/lib/jit/generation/elementwise_1d.cpp src/lib/jit/generation/gemm.cpp src/lib/jit/generation/reduce_1d.cpp src/lib/jit/generation/reduce_2d.cpp src/lib/jit/syntax/engine/process.cpp src/lib/jit/syntax/engine/binder.cpp src/lib/jit/syntax/engine/object.cpp src/lib/jit/syntax/engine/macro.cpp src/lib/jit/syntax/expression/preset.cpp src/lib/jit/syntax/expression/operations.cpp src/lib/jit/syntax/expression/expression.cpp src/lib/value_scalar.cpp '.split() + [os.path.join('src', 'bind', sf)  for sf in ['_isaac.cpp', 'core.cpp', 'driver.cpp', 'kernels.cpp', 'exceptions.cpp']]
