...
def main():
    ...
    #Source files
    src =  'src/lib/array.cpp src/lib/value_scalar.cpp src/lib/symbolic/engine/process.cpp src/lib/symbolic/engine/binder.cpp src/lib/symbolic/engine/macro.cpp src/lib/symbolic/engine/object.cpp src/lib/symbolic/execute.cpp src/lib/symbolic/scheduler/strategies/heft.cpp src/lib/symbolic/scheduler/dag.cpp src/lib/symbolic/expression/preset.cpp src/lib/symbolic/expression/operations.cpp src/lib/symbolic/expression/io.cpp src/lib/symbolic/expression/expression.cpp src/lib/exception/api.cpp src/lib/exception/driver.cpp src/lib/api/blas/cublas.cpp src/lib/api/blas/clBLAS.cpp src/lib/profiles/predictors/random_forest.cpp src/lib/profiles/profiles.cpp src/lib/profiles/database.cpp src/lib/templates/reduce_2d.cpp src/lib/templates/base.cpp src/lib/templates/engine/keywords.cpp src/lib/templates/engine/stream.cpp src/lib/templates/matrix_product.cpp src/lib/templates/elementwise_2d.cpp src/lib/templates/elementwise_1d.cpp src/lib/templates/reduce_1d.cpp src/lib/random/rand.cpp src/lib/driver/dispatch.cpp src/lib/driver/device.cpp src/lib/driver/context.cpp src/lib/driver/buffer.cpp src/lib/driver/program.cpp src/lib/driver/backend.cpp src/lib/driver/command_queue.cpp src/lib/driver/event.cpp src/lib/driver/program_cache.cpp src/lib/driver/kernel.cpp src/lib/driver/platform.cpp src/lib/driver/handle.cpp src/lib/driver/check.cpp src/lib/driver/ndrange.cpp '.split() + [os.path.join('src', 'bind', sf)  for sf in ['_isaac.cpp', 'core.cpp', 'driver.cpp', 'kernels.cpp', 'exceptions.cpp']]
