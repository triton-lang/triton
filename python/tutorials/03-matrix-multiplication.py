...
# You can see an example of how this reduces the memory needed to load in
# `Grouped vs Row Major Ordering.png`
#
...
@triton.autotune(
    configs=[
        ...
        triton.Config(
            {'BLOCK_SIZE_M': 256, 'BLOCK_SIZE_N': 64, 'BLOCK_SIZE_K': 32, 'GROUP_M': 8},
            num_stages=4,
            num_warps=4,
        ),
        triton.Config(
            {'BLOCK_SIZE_M': 64, 'BLOCK_SIZE_N': 256, 'BLOCK_SIZE_K': 32, 'GROUP_M': 8},
            num_stages=4,
            num_warps=4,
        ),
        triton.Config(
        ...
        triton.Config(
            {'BLOCK_SIZE_M': 128, 'BLOCK_SIZE_N': 64, 'BLOCK_SIZE_K': 32, 'GROUP_M': 8},
            num_stages=4,
            num_warps=4,
        ),
        triton.Config(
            {'BLOCK_SIZE_M': 64, 'BLOCK_SIZE_N': 128, 'BLOCK_SIZE_K': 32, 'GROUP_M': 8},
            num_stages=4,
            num_warps=4,
        ),
        triton.Config(
            {'BLOCK_SIZE_M': 128, 'BLOCK_SIZE_N': 32, 'BLOCK_SIZE_K': 32, 'GROUP_M': 8},
            num_stages=4,
            num_warps=4,
        ),
        triton.Config(
            {'BLOCK_SIZE_M': 64, 'BLOCK_SIZE_N': 32, 'BLOCK_SIZE_K': 32, 'GROUP_M': 8},
            num_stages=5,
            num_warps=2,
        ),
        triton.Config(
            {'BLOCK_SIZE_M': 32, 'BLOCK_SIZE_N': 64, 'BLOCK_SIZE_K': 32, 'GROUP_M': 8},
            num_stages=5,
            num_warps=2,
        ),
    ],
