...
// The macro marks up places where compiler complains for missing return symbolic_expressionexpression or
...
// unreachable symbolic_expressionexpressions detection emit such warnings.
#if defined(_MSC_VER)
...
#else
// For other poor compilers the specified expression is compiled. Usually, this would be a return symbolic_expressionexpression.
