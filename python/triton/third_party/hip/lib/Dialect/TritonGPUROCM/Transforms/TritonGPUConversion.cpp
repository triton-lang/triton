...
TritonGPUTypeConverter::TritonGPUTypeConverter(MLIRContext *context,
  ...
  addConversion([this](RankedTensorType tensorType) -> RankedTensorType {
    ...
    Attribute encoding = triton::gpu_rocm::BlockedEncodingAttr::get(
  ...
  addTargetMaterialization([&](OpBuilder &builder, RankedTensorType tensorType,
    ...
    auto cast =
        builder.create<triton::gpu_rocm::ConvertLayoutOp>(loc, tensorType, inputs);
...
TritonGPUConversionTarget::TritonGPUConversionTarget(
  ...
  // TODO: we should also verify ops of TritonGPUROCMDialect
  addLegalDialect<triton::gpu_rocm::TritonGPUROCMDialect>();
  ...
  addDynamicallyLegalOp<triton::DotOp>([](triton::DotOp dotOp) -> bool {
    ...
    if (aEncoding && aEncoding.isa<triton::gpu_rocm::DotOperandEncodingAttr>() &&
        bEncoding && bEncoding.isa<triton::gpu_rocm::DotOperandEncodingAttr>())
      return true;
    return false;
  });
}
