...
class _cross_entropy(torch.autograd.Function):
    ...
    def forward(cls, ctx, logits, indices):
        ...
        assert (indices.dtype ==
                torch.int64), "Indices are expected to be of type long."
        # make kernel
        ...
        def grid(opt): return (logits.numel() // n_cols, )
    ...
    def backward(cls, ctx, dneg_logprobs):
        ...
        def grid(opt): return (neg_logprobs.numel() // n_cols, )
