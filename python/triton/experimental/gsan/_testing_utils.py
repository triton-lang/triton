...
from triton._C.libtriton.gsan_testing import thread_state_address, SHADOW_GRANULARITY_BYTES as SHADOW_GRANULARITY_BYTES, PER_DEVICE_STATE_STRIDE_BYTES, GLOBAL_STATE_SIZE_BYTES, shadow_cell_address, shadow_granularity, thread_state_stride_bytes, SHADOW_CELL_SIZE_BYTES
...
def shadow_tensor_for(real: torch.Tensor) -> torch.Tensor:
    ...
    num_cells = triton.cdiv(nbytes, shadow_granularity(real.data_ptr()))
