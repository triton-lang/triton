...
op_str_to_op = {"max": ir.ATOMIC_OP.MAX, "min": ir.ATOMIC_OP.MIN,
                "fadd": ir.ATOMIC_OP.FADD, "add": ir.ATOMIC_OP.ADD,
                "and": ir.ATOMIC_OP.AND, "or": ir.ATOMIC_OP.OR,
...
def buffer_atomic_rmw(op, ptr, offsets, value, mask=None, sem=None, scope=None, stride=None, _semantic=None):
    ...
    return _semantic.tensor(_semantic.builder.create_buffer_atomic_rmw(op, ptr.handle, offsets.handle, mask, value.handle, sem, scope, stride), ret_type)
