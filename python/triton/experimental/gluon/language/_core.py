...
if TYPE_CHECKING:
    ...
    # Import runtime functions from triton.language.core for precise type checking.
    # Import them under private aliases and expose variable annotations so the
    # type checker sees the exact callable signatures while avoiding runtime
    # imports.
    from triton.language.core import associative_scan as _associative_scan
    from triton.language.core import atomic_add as _atomic_add
    from triton.language.core import atomic_and as _atomic_and
    from triton.language.core import atomic_cas as _atomic_cas
    from triton.language.core import atomic_max as _atomic_max
    from triton.language.core import atomic_min as _atomic_min
    from triton.language.core import atomic_or as _atomic_or
    from triton.language.core import atomic_xchg as _atomic_xchg
    from triton.language.core import atomic_xor as _atomic_xor
    from triton.language.core import broadcast as _broadcast
    from triton.language.core import expand_dims as _expand_dims
    from triton.language.core import inline_asm_elementwise as _inline_asm_elementwise
    from triton.language.core import join as _join
    from triton.language.core import load as _load
    from triton.language.core import map_elementwise as _map_elementwise
    from triton.language.core import max_constancy as _max_constancy
    from triton.language.core import max_contiguous as _max_contiguous
    from triton.language.core import maximum as _maximum
    from triton.language.core import minimum as _minimum
    from triton.language.core import multiple_of as _multiple_of
    from triton.language.core import num_programs as _num_programs
    from triton.language.core import permute as _permute
    from triton.language.core import program_id as _program_id
    from triton.language.core import reduce as _reduce
    from triton.language.core import reshape as _reshape
    from triton.language.core import split as _split
    from triton.language.core import static_assert as _static_assert
    from triton.language.core import static_print as _static_print
    from triton.language.core import store as _store
    from triton.language.core import to_tensor as _to_tensor
    from triton.language.core import where as _where

    # Expose precise types to the type checker by annotating the module-level
    # names with the imported callable objects.
    associative_scan: _associative_scan
    atomic_add: _atomic_add
    atomic_and: _atomic_and
    atomic_cas: _atomic_cas
    atomic_max: _atomic_max
    atomic_min: _atomic_min
    ...
    max_constancy: _max_constancy
    max_contiguous: _max_contiguous
    maximum: _maximum
    minimum: _minimum
