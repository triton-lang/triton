...
class ASTSource:
    ...
    def make_ir(self, options, codegen_fn, context):
        return ast_to_ttir(self.fn, self, context=context, options=options, codegen_fn=codegen_fn)
...
def compile(src, target=None, options=None):
    ...
    codegen_fn = backend.get_codegen_implementation()
    try:
        module = src.make_ir(options, codegen_fn, context)
