...
def _to_tensor(x: TensorLike, builder) -> tensor:
...
TensorLike = Union[bool, float, int, tensor, constexpr]
...
@builtin
def load(pointer: tensor, mask: Optional[TensorLike]=None, other: Optional[TensorLike]=None, cache_modifier="", eviction_policy="", volatile=False, _builder=None) -> tensor:
    """
...
@builtin
def store(pointer: tensor, value, mask: Optional[TensorLike]=None, cache_modifier="", eviction_policy="", _builder=None) -> tensor:
    """
...
def atomic_cas(pointer: tensor, cmp: TensorLike, val: TensorLike, _builder=None) -> tensor:
...
def atomic_xchg(pointer: tensor, val: TensorLike, mask: Optional[tensor]=None, _builder=None) -> tensor:
    val = _to_tensor(val, _builder)
...
def atomic_add(pointer: tensor, val: TensorLike, mask: Optional[tensor]=None, _builder=None) -> tensor:
    val = _to_tensor(val, _builder)
...
def atomic_max(pointer: tensor, val: TensorLike, mask: Optional[tensor]=None, _builder=None) -> tensor:
    val = _to_tensor(val, _builder)
...
def atomic_min(pointer: tensor, val: TensorLike, mask: Optional[tensor]=None, _builder=None) -> tensor:
    val = _to_tensor(val, _builder)
...
def atomic_and(pointer: tensor, val: TensorLike, mask: Optional[tensor]=None, _builder=None) -> tensor:
    val = _to_tensor(val, _builder)
...
def atomic_or(pointer: tensor, val: TensorLike, mask: Optional[tensor]=None, _builder=None) -> tensor:
    val = _to_tensor(val, _builder)
...
def atomic_xor(pointer: tensor, val: TensorLike, mask: Optional[tensor]=None, _builder=None) -> tensor:
    val = _to_tensor(val, _builder)
...
@builtin
def where(condition: TensorLike, x: TensorLike, y: TensorLike, _builder=None) -> tensor:
    """
...
@builtin
def umulhi(x: TensorLike, y: TensorLike, _builder=None) -> tensor:
    x = _to_tensor(x, _builder)
    y = _to_tensor(y, _builder)
...
@triton.jit
def swizzle2d(i, j, size_i, size_j, size_g: TensorLike) -> tuple[tensor, tensor]:
    """
