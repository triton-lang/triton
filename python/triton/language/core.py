...
@builtin
def dot(input, other, allow_tf32=True, allow_f16_acc=False, _builder=None):
    """
    ...
    allow_f16_acc = _constexpr_to_value(allow_f16_acc)
    return semantic.dot(input, other, allow_tf32, allow_f16_acc, _builder)
