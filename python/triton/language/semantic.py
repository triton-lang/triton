...
# ===----------------------------------------------------------------------===//
    ...
    def dot_scaled(self, lhs, lhs_scale, lhs_format, rhs, rhs_scale, rhs_format, acc=None, fast_math=False, lhs_k_pack=False, rhs_k_pack=False, out_dtype=tl.float32) -> TensorTy:
