...
def device_print(prefix: str, args: List[tl.tensor], elements: List[int], builder: ir.builder) -> tl.tensor:
    ...
    return tl.tensor(builder.create_print(prefix, new_args, elements), tl.void)
