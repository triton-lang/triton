...
def computation_type_impl(a_ty: tl.dtype, a_is_scalar: bool, b_ty: tl.dtype, b_is_scalar: bool,
    ...
    if a_is_scalar != b_is_scalar:
        ...
        if scalar_ty.kind().value < tensor_ty.kind().value or (scalar_ty.kind().value == tensor_ty.kind().value
                                                               and scalar_ty.kind() == tl.dtype.KIND.INTEGRAL
                                                               and scalar_ty.int_bitwidth <= tensor_ty.int_bitwidth):
