    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                ...
                core.dtype("int32"),
                core.dtype("int32"),
            ): ("__nv_byte_perm", core.dtype("int32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("int32"),
                core.dtype("int32"),
            ): ("__nv_mulhi", core.dtype("int32")),
            (
                core.dtype("uint32"),
                core.dtype("uint32"),
            ): ("__nv_umulhi", core.dtype("uint32")),
            (
                core.dtype("int64"),
                core.dtype("int64"),
            ): ("__nv_mul64hi", core.dtype("int64")),
            (
                core.dtype("uint64"),
                core.dtype("uint64"),
            ): ("__nv_umul64hi", core.dtype("uint64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("int32"),
                core.dtype("int32"),
            ): ("__nv_mul24", core.dtype("int32")),
            (
                core.dtype("uint32"),
                core.dtype("uint32"),
            ): ("__nv_umul24", core.dtype("uint32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                ...
                core.dtype("int32"),
                core.dtype("uint32"),
            ): ("__nv_sad", core.dtype("int32")),
            (
                core.dtype("uint32"),
                core.dtype("uint32"),
                core.dtype("uint32"),
            ): ("__nv_usad", core.dtype("uint32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                ...
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fmaf_rn", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_fma_rn", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                ...
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fmaf_rz", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_fma_rz", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                ...
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fmaf_rd", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_fma_rd", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                ...
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fmaf_ru", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_fma_ru", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fast_fdividef", core.dtype("fp32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fdiv_rn", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_ddiv_rn", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fdiv_rz", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_ddiv_rz", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fdiv_rd", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_ddiv_rd", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fdiv_ru", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_ddiv_ru", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_dadd_rn", core.dtype("fp64")),
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fadd_rn", core.dtype("fp32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_dadd_rz", core.dtype("fp64")),
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fadd_rz", core.dtype("fp32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_dadd_rd", core.dtype("fp64")),
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fadd_rd", core.dtype("fp32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_dadd_ru", core.dtype("fp64")),
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fadd_ru", core.dtype("fp32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_dmul_rn", core.dtype("fp64")),
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fmul_rn", core.dtype("fp32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_dmul_rz", core.dtype("fp64")),
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fmul_rz", core.dtype("fp32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_dmul_rd", core.dtype("fp64")),
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fmul_rd", core.dtype("fp32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("int32"),
                core.dtype("int32"),
            ): ("__nv_hiloint2double", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fast_powf", core.dtype("fp32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("int32"),
                core.dtype("int32"),
            ): ("__nv_hadd", core.dtype("int32")),
            (
                core.dtype("uint32"),
                core.dtype("uint32"),
            ): ("__nv_uhadd", core.dtype("uint32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("int32"),
                core.dtype("int32"),
            ): ("__nv_rhadd", core.dtype("int32")),
            (
                core.dtype("uint32"),
                core.dtype("uint32"),
            ): ("__nv_urhadd", core.dtype("uint32")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fsub_rn", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_dsub_rn", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fsub_rz", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_dsub_rz", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fsub_rd", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_dsub_rd", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fsub_ru", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_dsub_ru", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_copysignf", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_copysign", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_nextafterf", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_nextafter", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_atan2f", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_atan2", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_hypotf", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_hypot", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_rhypotf", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_rhypot", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                ...
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_norm3df", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_norm3d", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                ...
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_rnorm3df", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_rnorm3d", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("int32"),
                core.dtype("fp32"),
            ): ("__nv_ynf", core.dtype("fp32")),
            (
                core.dtype("int32"),
                core.dtype("fp64"),
            ): ("__nv_yn", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("int32"),
                core.dtype("fp32"),
            ): ("__nv_jnf", core.dtype("fp32")),
            (
                core.dtype("int32"),
                core.dtype("fp64"),
            ): ("__nv_jn", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("int32"),
            ): ("__nv_ldexpf", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("int32"),
            ): ("__nv_ldexp", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("int32"),
            ): ("__nv_scalbnf", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("int32"),
            ): ("__nv_scalbn", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fmodf", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_fmod", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_remainderf", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_remainder", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                ...
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fmaf", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_fma", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("int32"),
            ): ("__nv_powif", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("int32"),
            ): ("__nv_powi", core.dtype("fp64")),
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_powf", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_pow", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
    ...
    return core.extern_elementwise(
        ...
        ],
        {
            (
                core.dtype("fp32"),
                core.dtype("fp32"),
            ): ("__nv_fdimf", core.dtype("fp32")),
            (
                core.dtype("fp64"),
                core.dtype("fp64"),
            ): ("__nv_fdim", core.dtype("fp64")),
        },
        is_pure=True,
        _builder=_builder,
    )
