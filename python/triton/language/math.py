...
def fma(x, y, z, _semantic=None):
    ...
    x, y = _semantic.binary_op_type_checking_impl(x, y, allow_fp8=True)
    z, x = _semantic.binary_op_type_checking_impl(z, x, allow_fp8=True)
    z, y = _semantic.binary_op_type_checking_impl(z, y)
    x = _semantic.cast(x, z.dtype)
