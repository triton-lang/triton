...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_args",
        action="store_true",
        help="Save args passed to `triton.compiler.compile`, primarily for use with `triton.tools.aot.compiler`",
    )
    parser.add_argument(
        "--save_params",
        action="store_true",
        help="Save params passed to kernel template, primarily for use with `triton.tools.aot.compiler`",
    )
    ...
    # Save original signature -- mainly for debugging and testing of `triton.tools.aot.compiler`
    if args.save_args:
