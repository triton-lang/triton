...
parser.add_argument("--dir0", dest="dir0", required=True, help="Triton cache dir 0")
parser.add_argument("--dir1", dest="dir1", required=True, help="Triton cache dir 1")
parser.add_argument(
    "--asm", dest="asm", choices=["ttir", "llir", "ptx", "cubin"], required=True
)
parser.add_argument(
    "--early-stop", dest="early_stop", action="store_true", help="Stop after first diff"
)
