...
class Symbol:
    def __init__(
        self, name: str, op_name: str, ret_type: str, arg_names: list, arg_types: list
    ) -> None:
        """
...
class ExternLibrary(ABC):
    ...
    def __init__(
        self, name: str, path: str, format: bool = True, grouping: bool = True
    ) -> None:
        """
...
class Libdevice(ExternLibrary):
    ...
    def _output_stubs(self):
        ...
        for symbols in self._symbol_groups.values():
            ...
            return_str = (
                f'\treturn extern.elementwise("{self._name}", LIBDEVICE_PATH, ['
            )
            for arg_name in symbols[0].arg_names:
