...
static PyMethodDef SpecializeMethods[] = {
    {"specialize_int", specialize_int, METH_VARARGS,
     "integer specialization with type determination"},
    {"specialize_tensor", specialize_tensor, METH_VARARGS,
     "tensor data pointer alignment check"},
    {NULL, NULL, 0, NULL} // sentinel
};
static struct PyModuleDef SpecializeModule = {
    PyModuleDef_HEAD_INIT, "__triton_specialize_simple",
