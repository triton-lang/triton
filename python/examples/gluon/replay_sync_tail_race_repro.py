...
def run_repro(max_launches: int = 1000):
    ...
    gather_indx = torch.arange(FROZEN_GATHER_LEN, dtype=torch.int32, device=device) % batch_size
    out_shape = (FROZEN_GATHER_LEN, bias.shape[1] // fused_activation.specs.reduction_n)
