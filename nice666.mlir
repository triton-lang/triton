  ...
  tt.func public @ortho_diag_test_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg3: i32) attributes {noinline = false} {
    ...
    %27:2 = scf.for %arg4 = %c0_i32 to %arg3 step %c1_i32 iter_args(%arg5 = %21, %arg6 = %24) -> (tensor<64x64xf32, #blocked1>, tensor<64x64xf32, #blocked1>)  : i32 {
      ...
      ^bb0(%arg7: f32, %arg8: i32, %arg9: f32, %arg10: i32):
        %100 = arith.cmpf oeq, %arg7, %arg9 : f32
        %101 = arith.cmpi slt, %arg8, %arg10 : i32
        %102 = arith.andi %100, %101 : i1
        %103 = arith.cmpf ogt, %arg7, %arg9 : f32
        %104 = arith.ori %103, %102 : i1
        %105 = arith.select %104, %arg7, %arg9 : f32
        %106 = arith.select %104, %arg8, %arg10 : i32
        tt.reduce.return %105, %106 : f32, i32
      ...
      %82 = ttg.convert_layout %81 : tensor<64x64xf32, #blocked> -> tensor<64x64xf32, #blocked2>
      %83 = ttg.convert_layout %81 : tensor<64x64xf32, #blocked> -> tensor<64x64xf32, #blocked1>
      %84 = arith.mulf %83, %arg5 : tensor<64x64xf32, #blocked1>
      %85 = tt.broadcast %78 : tensor<1x64xf32, #blocked> -> tensor<64x64xf32, #blocked>
      %86 = ttg.convert_layout %85 : tensor<64x64xf32, #blocked> -> tensor<64x64xf32, #blocked1>
      %87 = arith.mulf %86, %80 : tensor<64x64xf32, #blocked1>
      %88 = arith.addf %84, %87 : tensor<64x64xf32, #blocked1>
      %89 = tt.trans %88 {order = array<i32: 1, 0>} : tensor<64x64xf32, #blocked1> -> tensor<64x64xf32, #blocked2>
      %90 = ttg.convert_layout %89 : tensor<64x64xf32, #blocked2> -> tensor<64x64xf32, #blocked1>
      %91 = tt.gather %90[%79] {axis = 1 : i32, efficient_layout} : (tensor<64x64xf32, #blocked1>, tensor<64x64xi32, #blocked1>) -> tensor<64x64xf32, #blocked1>
      %92 = arith.mulf %82, %89 : tensor<64x64xf32, #blocked2>
      %93 = ttg.convert_layout %92 : tensor<64x64xf32, #blocked2> -> tensor<64x64xf32, #blocked1>
      %94 = arith.mulf %86, %91 : tensor<64x64xf32, #blocked1>
      %95 = arith.addf %93, %94 : tensor<64x64xf32, #blocked1>
      %96 = tt.gather %arg6[%79] {axis = 1 : i32, efficient_layout} : (tensor<64x64xf32, #blocked1>, tensor<64x64xi32, #blocked1>) -> tensor<64x64xf32, #blocked1>
      %97 = arith.mulf %83, %arg6 : tensor<64x64xf32, #blocked1>
      %98 = arith.mulf %86, %96 : tensor<64x64xf32, #blocked1>
      %99 = arith.addf %97, %98 : tensor<64x64xf32, #blocked1>
      scf.yield %95, %99 : tensor<64x64xf32, #blocked1>, tensor<64x64xf32, #blocked1>
    }
