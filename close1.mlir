...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:90", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @ortho_diag_test_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg3: i32) attributes {noinline = false} {
    ...
    %25:2 = scf.for %arg4 = %c0_i32 to %arg3 step %c1_i32 iter_args(%arg5 = %19, %arg6 = %22) -> (tensor<64x64xf32, #blocked1>, tensor<64x64xf32, #blocked1>)  : i32 {
      ...
      %46 = tt.reshape %43 : tensor<64x1xf32, #blocked5> -> tensor<1x64xf32, #blocked6>
      %45 = ttg.convert_layout %44 : tensor<1x64xf32, #blocked2> -> tensor<1x64xf32, #blocked>
      %47 = ttg.convert_layout %46 : tensor<1x64xf32, #blocked6> -> tensor<1x64xf32, #blocked>
      ...
      %55 = tt.reshape %52 : tensor<64x1xf32, #blocked5> -> tensor<1x64xf32, #blocked6>
      %54 = ttg.convert_layout %53 : tensor<1x64xf32, #blocked2> -> tensor<1x64xf32, #blocked>
      %56 = ttg.convert_layout %55 : tensor<1x64xf32, #blocked6> -> tensor<1x64xf32, #blocked>
      ...
      %61 = tt.gather %45[%59] {axis = 1 : i32, efficient_layout} : (tensor<1x64xf32, #blocked>, tensor<1x64xi32, #blocked>) -> tensor<1x64xf32, #blocked>
      ...
      %66 = arith.subf %45, %61 : tensor<1x64xf32, #blocked>
      ...
      %79 = arith.mulf %54, %54 : tensor<1x64xf32, #blocked>
      ...
      %93 = arith.divf %54, %91 : tensor<1x64xf32, #blocked>
      ...
      %105 = tt.broadcast %99 : tensor<1x64xf32, #blocked> -> tensor<64x64xf32, #blocked>
      %106 = ttg.convert_layout %105 : tensor<64x64xf32, #blocked> -> tensor<64x64xf32, #blocked1>
      %107 = tt.broadcast %100 : tensor<1x64xf32, #blocked> -> tensor<64x64xf32, #blocked>
      ...
      %110 = tt.broadcast %101 : tensor<1x64xf32, #blocked> -> tensor<64x64xf32, #blocked>
      %111 = ttg.convert_layout %110 : tensor<64x64xf32, #blocked> -> tensor<64x64xf32, #blocked1>
      %112 = tt.broadcast %102 : tensor<1x64xf32, #blocked> -> tensor<64x64xf32, #blocked>
      %113 = ttg.convert_layout %112 : tensor<64x64xf32, #blocked> -> tensor<64x64xf32, #blocked1>
