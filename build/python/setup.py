...
def main():
    ...
    DEFINES = []
    INCLUDE_DIRS = ['/home/philippe/Development/ISAAC/python/external/boost/include',
                     os.path.join(find_module("numpy")[1], "core", "include"),
                    '/home/philippe/Development/ISAAC/include',
                    'CUDA_TOOLKIT_INCLUDE-NOTFOUND']
    LIBRARY_DIRS = ['/home/philippe/Development/ISAAC/build/lib']

    src = [os.path.join('/home/philippe/Development/ISAAC/python', 'src', sf) for sf in ['_isaac.cpp', 'driver.cpp', 'model.cpp', 'core.cpp']]

    boostsrc = '/home/philippe/Development/ISAAC/python/external/boost/libs/'
    for s in ['numpy','python','smart_ptr','system','thread']:
        src = src + [x for x in recursive_glob('/home/philippe/Development/ISAAC/python/external/boost/libs/' + s + '/src/','.cpp') if 'win32' not in x and 'pthread' not in x]
    ...
    setup(
                ...
                license='MPL 2.0',
                packages=["isaac"],
                #package_dir={ '': '/home/philippe/Development/ISAAC/build/python' },
                ext_package="isaac",
