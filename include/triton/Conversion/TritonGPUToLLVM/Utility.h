...
//      If partition output exists and smemBases.size() > 1, partition-aware.
// smemBases: For non-partitioned tensors, a single base pointer.
//            For partitioned tensors, one base per partition.
SmallVector<Value>
