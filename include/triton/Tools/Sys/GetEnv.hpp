...
inline const std::set<std::string> CACHE_INVALIDATING_ENV_VARS = {
    "AMDGCN_ENABLE_DUMP",       "DISABLE_FAST_REDUCTION",
    "DISABLE_LLVM_OPT",         "DISABLE_MMA_V3",
    "DISABLE_PTXAS_OPT",        "LLVM_IR_ENABLE_DUMP",
    "MLIR_ENABLE_DIAGNOSTICS",  "MLIR_ENABLE_DUMP",
    "TRITON_DISABLE_LINE_INFO", "TRITON_DISABLE_RESHAPE_ENCODING_INFERENCE",
    "TRITON_ENABLE_LLVM_DEBUG", "TRITON_LLVM_DEBUG_ONLY",
    "NVPTX_ENABLE_DUMP",
};
