...
template<class Fun>
inline void traverse(atidlas::array_expression const & array_expression, int_t root_idx, Fun const & fun, bool inspect)
{
...
public:
  ...
  void operator()(atidlas::array_expression const & array_expression, size_t root_idx, leaf_t) const;
private:
  pred_t pred_;
...
public:
  ...
  void call_before_expansion(atidlas::array_expression const & array_expression, int_t root_idx) const;
  void call_after_expansion(array_expression const & /*array_expression*/, int_t /*root_idx*/) const;
  void operator()(atidlas::array_expression const & array_expression, int_t root_idx, leaf_t leaf) const;
};
