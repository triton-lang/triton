...
tt.func @raw_single_block(%A : !tt.ptr<f16>) {
  ...
  %1 = tt.load %0, %cst1, %cst2 : tensor<128x32x!tt.ptr<f16, 1>, #AL>
...
tt.func @async_copy_global_to_local(%A : !tt.ptr<f16>, %i1 : i1) {
  ...
  %1 = triton_gpu.async_copy_global_to_local %a_ptr, %subview : tensor<16x16x!tt.ptr<f16>, #AL> -> !tt.memdesc<16x16xf16, #A_SHARED, mutable>
  // CHECK: gpu.barrier
  // CHECK-NEXT: triton_gpu.local_load
