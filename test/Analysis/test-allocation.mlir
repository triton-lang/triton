...
tt.func @multi_color(%A : !tt.ptr<f16>) {
  ...
  // expected-remark @below {{offset = 1280, size = 128}}
  ...
  // expected-remark @below {{size = 1440}}
  tt.return
}
