...
tt.func @reusable(%A : !tt.ptr<f16>) {
  ...
  %a4_ = tt.load %b_ptr, %cst3, %cst4 : tensor<32x128x!tt.ptr<f16, 1>, #AL>
  // CHECK-NEXT: offset = 0, size = 1152
