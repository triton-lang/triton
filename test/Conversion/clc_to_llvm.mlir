...
module attributes {"ttg.num-ctas" = 2 : i32, "ttg.num-warps" = 4 : i32} {
  ...
  tt.func @clc_try_cancel_multicast(%result: !ttg.memdesc<2xi64, #shared_clc, #smem>, %mbar: !ttg.memdesc<1xi64, #barrier, #smem>, %phase: i32, %pred: i1) {
    // CHECK: mbarrier.arrive.expect_tx.release.cluster.shared::cta.b64
    ttng.barrier_expect %mbar, 16, %pred : !ttg.memdesc<1xi64, #barrier, #smem>
    ...
    ttng.wait_barrier %mbar, %phase : !ttg.memdesc<1xi64, #barrier, #smem>
    // CHECK: mbarrier.arrive.release.cluster.shared::cta.b64
    ttng.arrive_barrier %mbar, 1 : !ttg.memdesc<1xi64, #barrier, #smem>
    tt.return
  }
}
