...
tt.func public @tma_gather_multicast(%arg0: !tt.tensordesc<1x128xbf16, #shared_gather_bcast>, %arg1: !ttg.memdesc<1xi64, #shared_bar_bcast, #smem, mutable>, %arg2: tensor<32xi32, #ttg.slice<{dim = 0, parent = #blocked_bcast}>>, %arg3: i32, %arg4: !ttg.memdesc<32x128xbf16, #shared_gather_bcast, #smem, mutable>, %arg5: i1, %arg6: i32, %arg7: !ttg.memdesc<1xi64, #shared_bar_local, #smem, mutable>) {
  ...
  ttng.wait_barrier %arg7, %arg6 : !ttg.memdesc<1xi64, #shared_bar_local, #smem, mutable>
  // CHECK: mbarrier.arrive.release.cluster.shared::cta.b64
  ttng.arrive_barrier %arg7, 1 : !ttg.memdesc<1xi64, #shared_bar_local, #smem, mutable>
