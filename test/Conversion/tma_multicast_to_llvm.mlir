// RUN: triton-opt %s --convert-triton-gpu-to-llvm=compute-capability=90 --convert-nv-gpu-to-llvm | mlir-translate -mlir-to-llvmir | opt -S -O1 | FileCheck %s
...
#shared_bar_local = #ttg.swizzled_shared<{vec = 1, perPhase = 1, maxPhase = 1, order = [0], CGALayout = [[1]]}>
...
tt.func public @tma_gather_multicast(%arg0: !tt.tensordesc<1x128xbf16, #shared_gather_bcast>, %arg1: !ttg.memdesc<1xi64, #shared_bar_bcast, #smem, mutable>, %arg2: tensor<32xi32, #ttg.slice<{dim = 0, parent = #blocked_bcast}>>, %arg3: i32, %arg4: !ttg.memdesc<32x128xbf16, #shared_gather_bcast, #smem, mutable>, %arg5: i1, %arg6: i32, %arg7: !ttg.memdesc<2xi64, #shared_bar_local, #smem, mutable>) {
  // CHECK: mbarrier.arrive.expect_tx.release.cluster.shared::cta.b64
  ttng.barrier_expect %arg7, 16, %arg5 : !ttg.memdesc<2xi64, #shared_bar_local, #smem, mutable>
  ...
  // CHECK: [[CTA_ELECT_PRED:%.*]] = and i1 {{.*}}, [[ELECT_PRED]]
  // CHECK: [[PRED:%.*]] = and i1 {{.*}}, [[CTA_ELECT_PRED]]
  ...
  ttng.wait_barrier %arg7, %arg6 : !ttg.memdesc<2xi64, #shared_bar_local, #smem, mutable>
  // CHECK: mbarrier.arrive.release.cluster.shared::cta.b64
  ttng.arrive_barrier %arg7, 1 : !ttg.memdesc<2xi64, #shared_bar_local, #smem, mutable>
