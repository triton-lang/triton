...
module attributes {"triton_gpu.compute-capability" = 80 : i32, "triton_gpu.num-ctas" = 1 : i32, "triton_gpu.num-warps" = 8 : i32, "triton_gpu.threads-per-warp" = 32 : i32} {
  // CHECK-LABEL: test_local_masked_load
  // CHECK: %[[T0:.*]] = llvm.extractelement {{.*}} : vector<8xf32>
  // CHECK: llvm.select %347, %[[T0]], %[[#]] : i1, f32
  tt.func public @test_local_masked_load(%mask : tensor<1x2048xi1, #blocked>) {
    %c0_i32 = arith.constant 0 : i32
    %cst = arith.constant dense<0xFF800000> : tensor<1x2048xf32, #blocked>
    %19 = triton_gpu.local_alloc  : () -> !tt.memdesc<1x1x2048xf32, #shared, mutable>
    %22 = triton_gpu.memdesc_subview %19[%c0_i32, %c0_i32, %c0_i32] : !tt.memdesc<1x1x2048xf32, #shared, mutable> -> !tt.memdesc<1x2048xf32, #shared, mutable>
    %39 = triton_gpu.local_load %22, %mask, %cst : !tt.memdesc<1x2048xf32, #shared, mutable> -> tensor<1x2048xf32, #blocked>
    tt.return
  }
}
