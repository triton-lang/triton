...
#mma1 = #ttg.amd_wmma<{version = 1, warpLayout = {register = [], warp = [[0, 1], [1, 0]]}}>
#mma2 = #ttg.amd_wmma<{version = 2, warpLayout = {register = [], warp = [[0, 1], [1, 0]]}}>
#mma2_transposed = #ttg.amd_wmma<{version = 2, warpLayout = {register = [], warp = [[0, 1], [1, 0]]}, isTranspose = true}>
#mma2_i4 = #ttg.amd_wmma<{version = 2, warpLayout = {register = [], warp = [[0, 1], [1, 0]]}, isTranspose = true, instrShape = [16, 16, 32]}>
#mma3 = #ttg.amd_wmma<{version = 3, warpLayout = {register = [], warp = [[0, 1], [1, 0]]}, instrShape = [16, 16, 32]}>
#mma3_transposed = #ttg.amd_wmma<{version = 3, warpLayout = {register = [], warp = [[0, 1], [1, 0]]}, isTranspose = true, instrShape = [16, 16, 32]}>
#mma3_f8 = #ttg.amd_wmma<{version = 3, warpLayout = {register = [], warp = [[0, 1], [1, 0]]}, instrShape = [16, 16, 64]}>
...
#mma1 = #ttg.amd_wmma<{version = 1, rank = 3, warpLayout = {register = [], warp = [[0, 0, 1], [0, 0, 2], [1, 0, 0]]}}>
#smem = #ttg.shared_memory
