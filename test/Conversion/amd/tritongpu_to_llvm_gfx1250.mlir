...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "hip:gfx1250", "ttg.threads-per-warp" = 32 : i32} {
  ...
  // GFX1250-COUNT-4: llvm.load {{.*}} : !llvm.ptr<3> -> vector<1xf16>
  // GFX1250-NOT: llvm.load {{.*}} : !llvm.ptr<3> -> vector<2xf16>
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "hip:gfx1250", "ttg.threads-per-warp" = 32 : i32} {
  ...
  // GFX1250-COUNT-4: llvm.store {{.*}} : vector<1xf16>, !llvm.ptr<3>
  // GFX1250-NOT: llvm.store {{.*}} : vector<2xf16>, !llvm.ptr<3>
