...
#mma = #ttg.amd_wmma<{version = 3, warpLayout = {register = [], warp = [[0, 1], [1, 0]]}, isTranspose = true, instrShape=[16, 16, 128]}>
#mma1 = #ttg.amd_wmma<{version = 3, warpLayout = {register = [], warp = [[0, 1], [1, 0]]}, isTranspose = true, instrShape=[16, 16, 64]}>
...
#mma = #ttg.amd_wmma<{version = 3, warpLayout = {register = [], warp = [[1, 0], [2, 0]]}, isTranspose = true, instrShape=[16, 16, 128]}>
