...
#blocked = #ttg.blocked<{sizePerThread = [1, 8], threadsPerWarp = [8, 4], warpsPerCTA = [4, 1], order = [1, 0], cga_layout = [[0, 0], [0, 0]]}>
#shared = #ttg.swizzled_shared<{vec = 8, perPhase = 2, maxPhase = 4, order = [1, 0], cga_layout = [[0, 0], [0, 0]]}>
#smem = #ttg.shared_memory
...
#blocked = #ttg.blocked<{sizePerThread = [1, 8], threadsPerWarp = [8, 4], warpsPerCTA = [4, 1], order = [1, 0], cga_layout = [[1, 0], [0, 0], [0, 0]]}>
#shared = #ttg.swizzled_shared<{vec = 8, perPhase = 2, maxPhase = 4, order = [1, 0], cga_layout = [[1, 0], [0, 0], [0, 0]]}>
#smem = #ttg.shared_memory
...
#blocked = #ttg.blocked<{sizePerThread = [1, 8], threadsPerWarp = [8, 4], warpsPerCTA = [4, 1], order = [1, 0], cga_layout = [[0, 1], [0, 2], [0, 4], [0, 0]]}>
#shared = #ttg.swizzled_shared<{vec = 8, perPhase = 2, maxPhase = 4, order = [1, 0], cga_layout = [[0, 1], [0, 2], [0, 4], [0, 0]]}>
#smem = #ttg.shared_memory
...
#blocked = #ttg.blocked<{sizePerThread = [1, 8], threadsPerWarp = [8, 4], warpsPerCTA = [4, 1], order = [1, 0], cga_layout = [[0, 1], [0, 2], [0, 4], [0, 8]]}>
#shared = #ttg.swizzled_shared<{vec = 8, perPhase = 2, maxPhase = 4, order = [1, 0], cga_layout = [[0, 1], [0, 2], [0, 4], [0, 8]]}>
#smem = #ttg.shared_memory
module attributes {"ttg.num-ctas" = 16 : i32, "ttg.num-warps" = 4 : i32, ttg.shared = 8192 : i32} {
