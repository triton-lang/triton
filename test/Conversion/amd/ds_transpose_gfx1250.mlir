...
#mma_b16 = #ttg.amd_wmma<{version = 3, ctaLayout = {register = [], warp = [[0, 1], [1, 0]]}, instrShape = [16, 16, 32]}> // b16
#mma_b8 = #ttg.amd_wmma<{version = 3, ctaLayout = {register = [], warp = [[0, 1], [1, 0]]}, instrShape = [16, 16, 64]}> // b8
#mma_b8_2x = #ttg.amd_wmma<{version = 3, ctaLayout = {register = [], warp = [[0, 1], [1, 0]]}, instrShape = [16, 16, 128]}> // b8
