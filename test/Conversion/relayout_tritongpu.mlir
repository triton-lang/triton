...
#tmem0 = #ttng.tensor_memory_encoding<blockM = 128, blockN = 128, unpacked = true, bitwidth = 32>
#tmem1 = #ttng.tensor_memory_encoding<blockM = 128, blockN = 64, unpacked = true, bitwidth = 32>
#tmem2 = #ttng.tensor_memory_encoding<blockM = 64, blockN = 64, unpacked = true, bitwidth = 32>
