// RUN: triton-opt %s -split-input-file --decompose-unsupported-conversions -triton-nvidia-gpu-add-descriptor-args --convert-triton-gpu-to-llvm=compute-capability=90 2>&1 | FileCheck %s
