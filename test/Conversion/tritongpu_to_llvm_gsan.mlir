...
module attributes {"ttg.instrumentation_mode" = "gsan", "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, "ttg.threads-per-warp" = 32 : i32} {
  ...
  tt.func @gsan_canonical_register_accesses(
    ...
    %loaded = tt.load %ptrs : tensor<1x!tt.ptr<i32>, #broadcasted_registers>
    tt.store %ptrs, %vals : tensor<1x!tt.ptr<i32>, #broadcasted_registers>
    tt.return
  }
  ...
  tt.func @gsan_distinct_register_accesses(
    ...
    %loaded = tt.load %ptrs : tensor<128x!tt.ptr<i32>, #broadcasted_registers>
    tt.store %ptrs, %vals : tensor<128x!tt.ptr<i32>, #broadcasted_registers>
    tt.return
  }
}
