...
module attributes {"ttg.num-warps" = 4 : i32, "ttg.num-ctas" = 1 : i32} {
  tt.func @test_empty_kernel(%lb : index, %A : !tt.ptr<i8>) {
    // CHECK: %0 = ttg.global_scratch_alloc {third_party_allocation, alignment = 128 : i32, nbytes = 384 : i32, ttg.global_scratch_memory_offset = 0 : i32} : !tt.ptr<i8>
    %0 = ttg.global_scratch_alloc {third_party_allocation, alignment = 128 : i32, nbytes = 384 : i32} : !tt.ptr<i8>
    // CHECK: %1 = ttg.global_scratch_alloc {third_party_allocation, alignment = 128 : i32, nbytes = 384 : i32, ttg.global_scratch_memory_offset = 384 : i32} : !tt.ptr<i8>
