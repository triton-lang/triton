...
module attributes {"ttg.num-warps" = 8 : i32} {
  ...
  // CHECK-NEXT: proton_gpu.global_time %[[SCRATCH]], 0 : !tt.ptr<i32>, i32
  ...
  // CHECK-NEXT: proton_gpu.global_time %[[SCRATCH]], 1 : !tt.ptr<i32>, i32
  // CHECK-NEXT: proton_gpu.finalize %[[SEGMENT]], %[[SCRATCH]] : !proton_gpu.segment<1024, #smem, warp>, !tt.ptr<i32>
  // CHECK-NEXT: proton_gpu.global_time %[[SCRATCH]], 2 : !tt.ptr<i32>, i32
