...
module attributes {ttg.global_scratch_memory_alignment = 128 : i32, ttg.global_scratch_memory_size = 512 : i32, ttg.maxnreg = 168 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.shared = 58368 : i32, ttg.target = "cuda:100", ttg.tensor_memory_size = 128 : i32, "ttg.threads-per-warp" = 32 : i32, "ttg.total-num-warps" = 12 : i32} {
  ...
  ^bb4:  // pred: ^bb3
    ...
    ttng.init_barrier %21, 1 {dependentPartitionIds = array<i32: 3>} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ...
    ttng.init_barrier %23, 1 {dependentPartitionIds = array<i32: 0>} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ...
    ttng.init_barrier %47, 1 {dependentPartitionIds = array<i32: 3>} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ...
    ttng.init_barrier %49, 1 {dependentPartitionIds = array<i32: 0>} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ...
    ttng.init_barrier %51, 1 {dependentPartitionIds = array<i32: 0>} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    %52 = ttg.memdesc_index %50[%c1_i32] : !ttg.memdesc<2x1xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ttng.init_barrier %52, 1 {dependentPartitionIds = array<i32: 0>} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ...
    ttng.init_barrier %59, 1 {dependentPartitionIds = array<i32: 3>} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ...
    ttng.init_barrier %63, 1 {dependentPartitionIds = array<i32: 0>} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ...
    ^bb4:  // pred: ^bb3
      ...
      ttng.arrive_barrier %23, 1 : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
      ...
      ttng.arrive_barrier %91, 1 : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ...
    ^bb5:  // pred: ^bb3
      ...
      ttng.arrive_barrier %117, 1 : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ...
    ^bb4:  // pred: ^bb3
      ...
      ttng.arrive_barrier %84, 1 : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
      ...
      ttng.arrive_barrier %89, 1 : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
      ...
      ttng.arrive_barrier %95, 1 : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ...
    ^bb5:  // pred: ^bb3
      ...
      ttng.arrive_barrier %98, 1 : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
...
module attributes {ttg.global_scratch_memory_alignment = 1 : i32, ttg.global_scratch_memory_size = 0 : i32, ttg.maxnreg = 256 : i32, "ttg.num-warps" = 4 : i32, ttg.shared = 32860 : i32, ttg.target = "cuda:100", ttg.tensor_memory_size = 0 : i32, "ttg.total-num-warps" = 8 : i32} {
  ...
  tt.func @auto_simple(%arg0: !tt.tensordesc<tensor<128x128xf16, #shared>>, %arg1: !tt.tensordesc<tensor<128x128xf16, #shared>>, %arg2: i32) attributes {allocation.offset = 32856 : i32, ttg.global_scratch_memory_alignment = 1 : i32, ttg.global_scratch_memory_size = 0 : i32} {
    ...
    // CHECK: "@$0 mbarrier.init.shared::cta.b64 [$1], 128;"
    ...
    ttng.init_barrier %3, 1 {dependentPartitionIds = array<i32: 0>} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ...
    ^bb2:  // pred: ^bb1
      ...
      ttng.arrive_barrier %22, 1 : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
