...
module attributes {"ttg.num-warps" = 4 : i32} {
  ...
  tt.func @complex_case(%arg0: i32, %arg1: i32, %arg2: i32) {
    ...
    // CHECK-NEXT: [[FULL1:%.*]] = ttg.local_alloc
    // CHECK-NEXT: scf.for
    // CHECK-NEXT:   [[EMPTYBAR1:%.*]] = ttg.memdesc_subview [[EMPTY1]]
    // CHECK-NEXT:   init_barrier [[EMPTYBAR1]], 2
    // CHECK-NEXT:   [[FULLBAR1:%.*]] = ttg.memdesc_subview [[FULL1]]
    ...
    // CHECK-NEXT: scf.for
    // CHECK-NEXT:   [[EMPTYBAR2:%.*]] = ttg.memdesc_subview [[EMPTY2]]
    // CHECK-NEXT:   init_barrier [[EMPTYBAR2]], 2
    // CHECK-NEXT:   [[FULLBAR2:%.*]] = ttg.memdesc_subview [[FULL2]]
    ...
    partition0 num_warps(4) {
      %5:2 = scf.for %arg3 = %arg0 to %arg1 step %arg2 iter_args(%arg4 = %cst, %arg5 = %cst) -> (tensor<1xi32, #blocked>, tensor<1xi32, #blocked>)  : i32 {
        // CHECK: [[EMPTYBAR2:%.*]] = ttg.memdesc_subview [[EMPTY2]]
        ...
        // CHECK: [[EMPTYBAR1:%.*]] = ttg.memdesc_subview [[EMPTY1]]
    ...
    partition1 num_warps(4) {
      scf.for %arg3 = %arg0 to %arg1 step %arg2  : i32 {
        // CHECK: [[FULLBAR1:%.*]] = ttg.memdesc_subview [[FULL1]]
        ...
        // CHECK: [[FULLBAR2:%.*]] = ttg.memdesc_subview [[FULL2]]
