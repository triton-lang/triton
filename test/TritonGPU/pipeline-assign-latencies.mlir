...
#tiny_shared = #ttg.nvmma_shared<{swizzlingByteWidth = 0, transposed = false, elementBitWidth = 32}>
...
module attributes {"ttg.num-warps" = 4 : i32, "ttg.num-ctas" = 1 : i32} {
  ...
  tt.func @unaligned_tma_stage_size(%desc: !tt.tensordesc<4xf32, #tiny_shared>,
    ...
    scf.for %iv = %lb to %ub step %step {
      // A 16-byte stage would make the second TMA buffer misaligned.
      // CHECK: tt.descriptor_load %{{.*}}[%{{.*}}] : !tt.tensordesc<4xf32
