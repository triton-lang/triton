...
#padded = #ttg.padded_shared<[32:+4] {order = [0, 1]}>
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 8 : i32, ttg.target = "hip:gfx942", "ttg.threads-per-warp" = 64 : i32} {
  ...
  tt.func public @memdesc_subslice_spliting() {
    ...
    %padded_indexed = ttg.memdesc_index %padded[%c0_i32] : !ttg.memdesc<1x256x128xf16, #padded, #smem, mutable> -> !ttg.memdesc<256x128xf16, #padded, #smem, mutable>
    %10 = ttg.memdesc_subslice %padded_indexed [128, 96]  : !ttg.memdesc<256x128xf16, #padded, #smem, mutable> -> !ttg.memdesc<128x32xf16, #padded, #smem, mutable, 256x128>
    tt.return
  }
}
