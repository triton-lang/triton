...
// GPU: %9 = tt.atomic_cas acq_rel, cta, %8, %cst_0, %cst { allocation.offset = 0 } : (tensor<2x!tt.ptr<i64>, #blocked>, tensor<2xi64, #blocked>, tensor<2xi64, #blocked>) -> tensor<2xi64, #blocked>
