...
#mma = #ttg.amd_mfma<{version = 2, warpsPerCTA = [1, 1], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = false}>
...
#mma = #ttg.amd_mfma<{version = 4, warpsPerCTA = [4, 1], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = true}>
...
#mma = #ttg.amd_mfma<{version = 4, warpsPerCTA = [2, 4], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = true}>
...
#mma = #ttg.amd_mfma<{version = 4, warpsPerCTA = [4, 1], tilesPerWarp = [1, 1], instrShape = [16, 16], isTransposed = true}>
module attributes {"ttg.num-warps" = 4 : i32, "ttg.threads-per-warp" = 64 : i32} {
...
#mma = #ttg.amd_mfma<{version = 4, warpsPerCTA = [2, 2], tilesPerWarp = [1, 1], instrShape = [16, 16], isTransposed = true}>
module attributes {"ttg.num-warps" = 4 : i32, "ttg.threads-per-warp" = 64 : i32} {
  tt.func public @store_dword_16x16(%arg0: !tt.ptr<f16>) attributes {noinline = false} {
    %cst = arith.constant dense<0.000000e+00> : tensor<128x128xf32, #mma>
    %cst_0 = arith.constant dense<1.230000e+02> : tensor<128x128xf32, #ttg.dot_op<{opIdx = 0, parent = #mma, kWidth = 2}>>
