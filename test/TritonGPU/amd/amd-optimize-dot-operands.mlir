// RUN: triton-opt %s -split-input-file -tritonamdgpu-optimize-dot-operands="gfx-arch=gfx950" | FileCheck %s --check-prefixes GFX950
  ...
  tt.func public @test_alloc_shared_mem_for_scaled_upcast(
    ...
    %K: i32 {tt.divisibility = 16 : i32}
      ...
      %14:1 = scf.for %13 = %c0_i32 to %K step %c128_i32 iter_args(%15 = %cst_1) -> (tensor<128x128xbf16, #blocked>) : i32 {
        ...
        %7 = tt.reshape %6 require_sliced : tensor<4x128xbf16, #ttg.slice<{dim = 2, parent = #linear}>> -> tensor<4x128x1xbf16, #linear>
