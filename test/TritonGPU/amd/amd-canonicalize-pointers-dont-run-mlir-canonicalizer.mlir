...
// CHECK:             %[[VAL_15:.*]] = arith.addi %[[VAL_8]], %[[VAL_7]] : tensor<1024xi32>
...
// CHECK:             %[[VAL_20:.*]] = tt.addptr %[[VAL_0]], %[[VAL_19]] : !tt.ptr<f32>, i32
// CHECK:             %[[VAL_21:.*]] = arith.extsi %[[VAL_8]] : tensor<1024xi32> to tensor<1024xi64>
// CHECK:             %[[VAL_22:.*]] = arith.addi %[[VAL_21]], %[[VAL_10]] : tensor<1024xi64>
// CHECK:             scf.yield %[[VAL_20]], %[[VAL_22]], %[[VAL_20]], %[[VAL_22]] : !tt.ptr<f32>, tensor<1024xi64>, !tt.ptr<f32>, tensor<1024xi64>
// CHECK:           }
// CHECK:           %[[VAL_23:.*]] = arith.trunci %[[VAL_24:.*]]#1 : tensor<1024xi64> to tensor<1024xi32>
// CHECK:           %[[VAL_25:.*]] = tt.splat %[[VAL_24]]#0 : !tt.ptr<f32> -> tensor<1024x!tt.ptr<f32>>
// CHECK:           %[[VAL_26:.*]] = tt.addptr %[[VAL_25]], %[[VAL_23]] : tensor<1024x!tt.ptr<f32>>, tensor<1024xi32>
// CHECK:           %[[VAL_27:.*]] = tt.load %[[VAL_26]] : tensor<1024x!tt.ptr<f32>>
// CHECK:           %[[VAL_28:.*]] = arith.trunci %[[VAL_24]]#3 : tensor<1024xi64> to tensor<1024xi32>
// CHECK:           %[[VAL_29:.*]] = tt.splat %[[VAL_24]]#2 : !tt.ptr<f32> -> tensor<1024x!tt.ptr<f32>>
// CHECK:           %[[VAL_30:.*]] = tt.addptr %[[VAL_29]], %[[VAL_28]] : tensor<1024x!tt.ptr<f32>>, tensor<1024xi32>
// CHECK:           %[[VAL_31:.*]] = tt.load %[[VAL_30]] : tensor<1024x!tt.ptr<f32>>
// CHECK:           tt.return %[[VAL_27]], %[[VAL_31]] : tensor<1024xf32>, tensor<1024xf32>
// CHECK:         }
...
// CHECK:             %[[VAL_21:.*]] = arith.extsi %[[VAL_8]] : tensor<1024xi32> to tensor<1024xi64>
// CHECK:             %[[VAL_22:.*]] = arith.addi %[[VAL_21]], %[[VAL_10]] : tensor<1024xi64>
// CHECK:             scf.yield %[[VAL_20]], %[[VAL_22]], %[[VAL_20]], %[[VAL_22]], %[[VAL_5]] : !tt.ptr<f32>, tensor<1024xi64>, !tt.ptr<f32>, tensor<1024xi64>, i32
// CHECK:           }
// CHECK:           %[[VAL_23:.*]] = arith.trunci %[[VAL_24:.*]]#1 : tensor<1024xi64> to tensor<1024xi32>
// CHECK:           %[[VAL_25:.*]] = tt.splat %[[VAL_24]]#0 : !tt.ptr<f32> -> tensor<1024x!tt.ptr<f32>>
// CHECK:           %[[VAL_26:.*]] = tt.addptr %[[VAL_25]], %[[VAL_23]] : tensor<1024x!tt.ptr<f32>>, tensor<1024xi32>
...
// CHECK:           %[[VAL_30:.*]] = tt.addptr %[[VAL_29]], %[[VAL_28]] : tensor<1024x!tt.ptr<f32>>, tensor<1024xi32>
// CHECK:           %[[VAL_31:.*]] = tt.load %[[VAL_30]] : tensor<1024x!tt.ptr<f32>>
// CHECK:           tt.return %[[VAL_27]], %[[VAL_31]], %[[VAL_24]]#4 : tensor<1024xf32>, tensor<1024xf32>, i32
// CHECK:         }
...
// CHECK:             %[[VAL_21:.*]] = arith.extsi %[[VAL_8]] : tensor<1024xi32> to tensor<1024xi64>
// CHECK:             %[[VAL_22:.*]] = arith.addi %[[VAL_21]], %[[VAL_10]] : tensor<1024xi64>
// CHECK:             scf.yield %[[VAL_20]], %[[VAL_22]], %[[VAL_5]], %[[VAL_20]], %[[VAL_22]] : !tt.ptr<f32>, tensor<1024xi64>, i32, !tt.ptr<f32>, tensor<1024xi64>
// CHECK:           }
// CHECK:           %[[VAL_23:.*]] = arith.trunci %[[VAL_24:.*]]#1 : tensor<1024xi64> to tensor<1024xi32>
// CHECK:           %[[VAL_25:.*]] = tt.splat %[[VAL_24]]#0 : !tt.ptr<f32> -> tensor<1024x!tt.ptr<f32>>
// CHECK:           %[[VAL_26:.*]] = tt.addptr %[[VAL_25]], %[[VAL_23]] : tensor<1024x!tt.ptr<f32>>, tensor<1024xi32>
// CHECK:           %[[VAL_27:.*]] = tt.load %[[VAL_26]] : tensor<1024x!tt.ptr<f32>>
// CHECK:           %[[VAL_28:.*]] = arith.trunci %[[VAL_24]]#4 : tensor<1024xi64> to tensor<1024xi32>
// CHECK:           %[[VAL_29:.*]] = tt.splat %[[VAL_24]]#3 : !tt.ptr<f32> -> tensor<1024x!tt.ptr<f32>>
// CHECK:           %[[VAL_30:.*]] = tt.addptr %[[VAL_29]], %[[VAL_28]] : tensor<1024x!tt.ptr<f32>>, tensor<1024xi32>
// CHECK:           %[[VAL_31:.*]] = tt.load %[[VAL_30]] : tensor<1024x!tt.ptr<f32>>
// CHECK:           tt.return %[[VAL_27]], %[[VAL_31]], %[[VAL_24]]#2 : tensor<1024xf32>, tensor<1024xf32>, i32
// CHECK:         }
