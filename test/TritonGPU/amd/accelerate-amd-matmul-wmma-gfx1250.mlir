...
// CHECK{LITERAL}: #mma = #ttg.amd_wmma<{version = 3, isTranspose = true, warpLayout = {register = [], warp = [[0, 1], [1, 0]]}, instrShape = [16, 16, 128]}>
// CHECK{LITERAL}: #mma1 = #ttg.amd_wmma<{version = 3, isTranspose = true, warpLayout = {register = [], warp = [[0, 1], [1, 0]]}, instrShape = [16, 16, 64]}>
