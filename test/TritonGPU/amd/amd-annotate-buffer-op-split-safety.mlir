...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 1 : i32, "ttg.threads-per-warp" = 32 : i32} {
    // CHECK-LABEL: @no_split_reshape_broadcast_negative_summand
    // CHECK: amdg.buffer_load
    // CHECK-NOT: amdgpu.split_soffset_safe
    tt.func @no_split_reshape_broadcast_negative_summand(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32}) {
        %cn64 = arith.constant -64 : i32
        ...
        %expanded = tt.reshape %add require_sliced : tensor<128xi32, #slice2d0> -> tensor<1x128xi32, #blocked2d>
