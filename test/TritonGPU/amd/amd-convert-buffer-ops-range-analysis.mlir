...
// CHECK:           %[[VAL_8:.*]] = tt.reshape %[[VAL_7]] require_sliced : tensor<16xi32, #ttg.slice<{dim = 1, parent = #[[$ATTR_0]]}>> -> tensor<16x1xi32, #[[$ATTR_0]]>
...
// CHECK:           %[[VAL_12:.*]] = tt.reshape %[[VAL_6]] require_sliced : tensor<256xi32, #ttg.slice<{dim = 0, parent = #[[$ATTR_0]]}>> -> tensor<1x256xi32, #[[$ATTR_0]]>
...
// CHECK:           %[[VAL_7:.*]] = tt.reshape %[[VAL_5]] require_sliced : tensor<128xi32, #ttg.slice<{dim = 1, parent = #[[$ATTR_1]]}>> -> tensor<128x1xi32, #[[$ATTR_1]]>
...
// CHECK:           %[[VAL_12:.*]] = tt.reshape %[[VAL_6]] require_sliced : tensor<16xi32, #ttg.slice<{dim = 0, parent = #[[$ATTR_1]]}>> -> tensor<1x16xi32, #[[$ATTR_1]]>
