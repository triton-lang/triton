...
#mma = #ttg.amd_mfma<{version = 2, warpsPerCTA = [1, 8], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = false}>
...
// CHECK-DAG: [[$MMA:#.*]] = #ttg.amd_mfma<{version = 2, warpsPerCTA = [1, 1, 8], tilesPerWarp = [1, 1, 1], instrShape = [32, 32], isTransposed = false}>
...
#mma = #ttg.amd_mfma<{version = 2, warpsPerCTA = [1, 1, 8], tilesPerWarp = [1, 1, 1], instrShape = [32, 32], isTransposed = false}>
...
// CHECK-DAG: [[MMA_1:#[a-z0-9]*]] = #ttg.amd_mfma<{version = 2, warpsPerCTA = [8, 1], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = true}>
// CHECK-DAG: [[MMA_2:#[a-z0-9]*]] = #ttg.amd_mfma<{version = 2, warpsPerCTA = [1, 8], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = false}>
...
#blocked = #ttg.blocked<{sizePerThread = [4, 1], threadsPerWarp = [16, 4], warpsPerCTA = [1, 8], order = [0, 1]}>
#mma1 = #ttg.amd_mfma<{version = 2, warpsPerCTA = [1, 8], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = false}>
#mma2 = #ttg.amd_mfma<{version = 2, warpsPerCTA = [8, 1], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = true}>
...
#mma = #ttg.amd_mfma<{version = 2, warpsPerCTA = [4, 1], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = true}>
#shared = #ttg.swizzled_shared<{vec = 4, perPhase = 1, maxPhase = 16, order = [0, 1]}>
#smem = #ttg.shared_memory
