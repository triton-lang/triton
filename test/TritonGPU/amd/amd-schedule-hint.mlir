...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 8 : i32, ttg.target = "hip:gfx942", "ttg.threads-per-warp" = 64 : i32} {
  tt.func public @insert_schedule_hint(
    ...
    // INSTR_HINT-SAME: isBufferLoadsAEnabled = false
    // INSTR_HINT-SAME: isBufferLoadsBEnabled = false
    // INSTR_HINT-SAME: numDsReadsA = #amdgpu.InstCounter<0, none>
    // INSTR_HINT-SAME: numDsReadsB = #amdgpu.InstCounter<0, none>
    // INSTR_HINT-SAME: numDsWritesA = #amdgpu.InstCounter<0, none>
    // INSTR_HINT-SAME: numDsWritesB = #amdgpu.InstCounter<0, none>
    // INSTR_HINT-SAME: numGlobalLoadsA = #amdgpu.InstCounter<0, none>
    // INSTR_HINT-SAME: numGlobalLoadsB = #amdgpu.InstCounter<0, none>
    // INSTR_HINT-SAME: numMMAs = #amdgpu.InstCounter<0, none>
...
#dot_op_a = #ttg.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>
#dot_op_b = #ttg.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>
// LOWER_HINT-LABEL: @lower_hint
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 8 : i32, ttg.target = "hip:gfx942", "ttg.threads-per-warp" = 64 : i32} {
  tt.func public @lower_hint(
    %lb : index, %ub : index, %step : index,
    %arg0: tensor<128x128xf32, #dot_op_a>,
    %arg1: tensor<128x128xf32, #dot_op_b>,
    %arg2: tensor<128x128x!tt.ptr<f32>, #blocked>
