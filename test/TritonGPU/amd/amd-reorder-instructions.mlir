...
module attributes {"triton_gpu.num-warps" = 8 : i32, "triton_gpu.threads-per-warp" = 64 : i32} {
  tt.func public @order_load_alloc_local_load_local_store(%arg0: tensor<32x32x!tt.ptr<f32>, #blocked>) attributes {noinline = false} {
    ...
    %10 = triton_gpu.local_alloc : () -> !triton_gpu.memdesc<32x32xf32, #shared, #triton_gpu.shared_memory, mutable>
    triton_gpu.local_store %9, %10 : tensor<32x32xf32, #blocked> -> !triton_gpu.memdesc<32x32xf32, #shared, #triton_gpu.shared_memory, mutable>
    %cst_0 = arith.constant dense<1.230000e+02> : tensor<32x32xf32, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 2}>>
    %11 = triton_gpu.local_load %10 : !triton_gpu.memdesc<32x32xf32, #shared, #triton_gpu.shared_memory, mutable> -> tensor<32x32xf32, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 2}>>
...
// CHECK-COUNT-2: triton_gpu.local_dealloc %{{.+}} : !triton_gpu.memdesc<4x128x64xf16, #shared, #triton_gpu.shared_memory, mutable>
...
module attributes {"triton_gpu.num-warps" = 4 : i32, "triton_gpu.threads-per-warp" = 32 : i32} {
  tt.func public @anchor_barrier(%arg0: tensor<32x32x!tt.ptr<f16>, #blocked>) attributes {noinline = false} {
    ...
    %1 = triton_gpu.local_alloc %2 : (tensor<32x32xf16, #blocked>) -> !triton_gpu.memdesc<4x128x64xf16, #shared, #triton_gpu.shared_memory, mutable>
    triton_gpu.local_dealloc %0 : !triton_gpu.memdesc<4x128x64xf16, #shared, #triton_gpu.shared_memory, mutable>
    triton_gpu.local_dealloc %1 : !triton_gpu.memdesc<4x128x64xf16, #shared, #triton_gpu.shared_memory, mutable>
    tt.return
  }
