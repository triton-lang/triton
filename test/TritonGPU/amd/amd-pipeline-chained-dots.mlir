// RUN: triton-opt %s -split-input-file -tritonamdgpu-schedule-loops="num_stages=4 use_async_copy=1" -tritonamdgpu-stream-pipeline="use_async_copy=1" -canonicalize | FileCheck %s
