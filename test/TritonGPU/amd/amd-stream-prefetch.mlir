// RUN: triton-opt %s -tritonamdgpu-schedule-loops="num_stages=3 global_prefetch=1" -tritonamdgpu-stream-pipeline -canonicalize | FileCheck %s --check-prefixes=GLOBAL_1
// RUN: triton-opt %s -tritonamdgpu-schedule-loops="num_stages=4 global_prefetch=2" -tritonamdgpu-stream-pipeline -canonicalize | FileCheck %s --check-prefixes=GLOBAL_2
// RUN: triton-opt %s -tritonamdgpu-schedule-loops="num_stages=3 global_prefetch=1 local_prefetch=1" -tritonamdgpu-stream-pipeline -canonicalize | FileCheck %s --check-prefixes=GLOBAL_LOCAL_1
// RUN: triton-opt %s -tritonamdgpu-schedule-loops="num_stages=2 local_prefetch=1" -tritonamdgpu-stream-pipeline -canonicalize | FileCheck %s --check-prefixes=LOCAL_1
