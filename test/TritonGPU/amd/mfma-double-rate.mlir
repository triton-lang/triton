...
#mma = #ttg.amd_mfma<{version = 4, warpsPerCTA = [4, 1], tilesPerWarp = [1, 1], instrShape = [16, 16], isTransposed = false}>
...
#mma = #ttg.amd_mfma<{version = 4, warpsPerCTA = [4, 1], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = false}>
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, "ttg.threads-per-warp" = 64 : i32} {
