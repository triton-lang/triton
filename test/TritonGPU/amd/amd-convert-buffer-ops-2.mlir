...
// CHECK:           %[[VAL_8:.*]] = arith.extsi %[[VAL_4]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:           %[[VAL_9:.*]] = arith.addi %[[VAL_8]], %[[VAL_6]] {__amdgpuconvertbufferops.output_range = [0, 2048]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_8:.*]] = arith.addi %[[VAL_5]], %[[VAL_5]] {__amdgpuconvertbufferops.output_range = [0, 2048]} : tensor<1024xi32>
// CHECK:           %[[VAL_9:.*]] = amdgpu.buffer_load %[[VAL_7]]{{\[}}%[[VAL_8]]] stride = %[[VAL_1]] : tensor<1024xf32>
...
// CHECK:             %[[VAL_17:.*]] = arith.extsi %[[VAL_8]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:             %[[VAL_18:.*]] = arith.addi %[[VAL_17]], %[[VAL_14]] {__amdgpuconvertbufferops.output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_25:.*]] = arith.extsi %[[VAL_8]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:           %[[VAL_26:.*]] = arith.addi %[[VAL_25]], %[[VAL_24]]#1 {__amdgpuconvertbufferops.output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:             %[[VAL_16:.*]] = arith.extsi %[[VAL_9]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:             %[[VAL_17:.*]] = arith.addi %[[VAL_16]], %[[VAL_13]] {__amdgpuconvertbufferops.output_range = [0, 131072]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_24:.*]] = arith.extsi %[[VAL_9]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:           %[[VAL_25:.*]] = arith.addi %[[VAL_24]], %[[VAL_23]]#1 {__amdgpuconvertbufferops.output_range = [0, 131072]} : tensor<1024xi64>
...
// CHECK:               %[[VAL_22:.*]] = arith.addi %[[VAL_21]], %[[VAL_18]] {__amdgpuconvertbufferops.output_range = [0, 262144]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_31:.*]] = arith.addi %[[VAL_30]], %[[VAL_29]]#1 {__amdgpuconvertbufferops.output_range = [0, 16384]} : tensor<1024xi64>
...
// CHECK:             %[[VAL_11:.*]] = arith.extsi %[[VAL_8]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
...
// CHECK:           }
// CHECK:           %[[VAL_13:.*]] = arith.trunci %[[VAL_14:.*]]#1 {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi64> to tensor<1024xi32>
// CHECK:           %[[VAL_15:.*]] = amdgpu.buffer_load %[[VAL_14]]#0{{\[}}%[[VAL_13]]] stride = %[[VAL_3]] : tensor<1024xf32>
...
// CHECK:         ^bb1(%[[VAL_9:.*]]: !tt.ptr<f32>, %[[VAL_10:.*]]: tensor<1024xi32>):
// CHECK:           %[[VAL_11:.*]] = amdgpu.buffer_load %[[VAL_9]]{{\[}}%[[VAL_10]]] stride = %[[VAL_3]] : tensor<1024xf32>
// CHECK:           tt.return %[[VAL_11]] : tensor<1024xf32>
// CHECK:         }
...
// CHECK:           %[[VAL_9:.*]] = tt.splat %[[VAL_2]] {__amdgpuconvertbufferops.output_range = [-2147483648, 2147483647]} : i32 -> tensor<16x1xi32, #[[$ATTR_0]]>
// CHECK:           %[[VAL_10:.*]] = arith.muli %[[VAL_8]], %[[VAL_9]] {__amdgpuconvertbufferops.output_range = [-2147483648, 2147483647]} : tensor<16x1xi32, #[[$ATTR_0]]>
// CHECK:           %[[VAL_11:.*]] = tt.broadcast %[[VAL_10]] {__amdgpuconvertbufferops.output_range = [-2147483648, 2147483647]} : tensor<16x1xi32, #[[$ATTR_0]]> -> tensor<16x256xi32, #[[$ATTR_0]]>
// CHECK:           %[[VAL_12:.*]] = tt.expand_dims %[[VAL_6]] {__amdgpuconvertbufferops.output_range = [0, 256], axis = 0 : i32} : tensor<256xi32, #ttg.slice<{dim = 0, parent = #[[$ATTR_0]]}>> -> tensor<1x256xi32, #[[$ATTR_0]]>
// CHECK:           %[[VAL_13:.*]] = tt.broadcast %[[VAL_12]] {__amdgpuconvertbufferops.output_range = [-2147483648, 2147483647]} : tensor<1x256xi32, #[[$ATTR_0]]> -> tensor<16x256xi32, #[[$ATTR_0]]>
// CHECK:           %[[VAL_14:.*]] = arith.addi %[[VAL_11]], %[[VAL_13]] {__amdgpuconvertbufferops.output_range = [-2147483648, 2147483647]} : tensor<16x256xi32, #[[$ATTR_0]]>
...
// CHECK:           %[[VAL_8:.*]] = arith.muli %[[VAL_4]], %[[VAL_1]] {__amdgpuconvertbufferops.output_range = [-2147483648, 2147483647]} : i32
// CHECK:           %[[VAL_9:.*]] = tt.splat %[[VAL_1]] {__amdgpuconvertbufferops.output_range = [-2147483648, 2147483647]} : i32 -> tensor<128x1xi32, #[[$ATTR_1]]>
// CHECK:           %[[VAL_10:.*]] = arith.muli %[[VAL_7]], %[[VAL_9]] {__amdgpuconvertbufferops.output_range = [-2147483648, 2147483647]} : tensor<128x1xi32, #[[$ATTR_1]]>
// CHECK:           %[[VAL_11:.*]] = tt.broadcast %[[VAL_10]] {__amdgpuconvertbufferops.output_range = [-2147483648, 2147483647]} : tensor<128x1xi32, #[[$ATTR_1]]> -> tensor<128x16xi32, #[[$ATTR_1]]>
// CHECK:           %[[VAL_12:.*]] = tt.expand_dims %[[VAL_6]] {__amdgpuconvertbufferops.output_range = [0, 16], axis = 0 : i32} : tensor<16xi32, #ttg.slice<{dim = 0, parent = #[[$ATTR_1]]}>> -> tensor<1x16xi32, #[[$ATTR_1]]>
// CHECK:           %[[VAL_13:.*]] = tt.broadcast %[[VAL_12]] {__amdgpuconvertbufferops.output_range = [-2147483648, 2147483647]} : tensor<1x16xi32, #[[$ATTR_1]]> -> tensor<128x16xi32, #[[$ATTR_1]]>
// CHECK:           %[[VAL_14:.*]] = arith.addi %[[VAL_11]], %[[VAL_13]] {__amdgpuconvertbufferops.output_range = [-2147483648, 2147483647]} : tensor<128x16xi32, #[[$ATTR_1]]>
...
// CHECK:           %[[VAL_11:.*]] = arith.select %[[VAL_1]], %[[VAL_3]], %[[VAL_9]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi64>
// CHECK:           %[[VAL_12:.*]] = arith.trunci %[[VAL_11]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi64> to tensor<1024xi32>
// CHECK:           %[[VAL_13:.*]] = amdgpu.buffer_load %[[VAL_10]]{{\[}}%[[VAL_12]]] stride = %[[VAL_2]] : tensor<1024xf32>
...
// CHECK:           %[[VAL_12:.*]] = amdgpu.buffer_load %[[VAL_11]]{{\[}}%[[VAL_8]]] stride = %[[VAL_3]] : tensor<1024xi64>
...
// CHECK:             %[[VAL_15:.*]] = arith.trunci %[[VAL_13]] {__amdgpuconvertbufferops.output_range = [0, 131072]} : tensor<1024xi64> to tensor<1024xi32>
// CHECK:             %[[VAL_16:.*]] = amdgpu.buffer_load %[[VAL_12]]{{\[}}%[[VAL_15]]] stride = %[[VAL_2]] : tensor<1024xf32>
// CHECK:             %[[VAL_17:.*]] = tt.addptr %[[VAL_12]], %[[VAL_6]] : !tt.ptr<f32>, i32
// CHECK:             %[[VAL_18:.*]] = arith.extsi %[[VAL_7]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:             %[[VAL_19:.*]] = arith.addi %[[VAL_18]], %[[VAL_13]] {__amdgpuconvertbufferops.output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_24:.*]] = arith.extsi %[[VAL_7]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:           %[[VAL_25:.*]] = arith.addi %[[VAL_24]], %[[VAL_23]]#1 {__amdgpuconvertbufferops.output_range = [0, 132096]} : tensor<1024xi64>
// CHECK:           %[[VAL_26:.*]] = tt.splat %[[VAL_22]] : !tt.ptr<f32> -> tensor<1024x!tt.ptr<f32>>
// CHECK:           %[[VAL_27:.*]] = tt.addptr %[[VAL_26]], %[[VAL_25]] : tensor<1024x!tt.ptr<f32>>, tensor<1024xi64>
// CHECK:           %[[VAL_28:.*]] = tt.load %[[VAL_27]] : tensor<1024x!tt.ptr<f32>>
// CHECK:           tt.return %[[VAL_28]] : tensor<1024xf32>
...
// CHECK:           %[[VAL_1:.*]] = arith.constant {__amdgpuconvertbufferops.output_range = [0, 0]} 0 : i64
// CHECK:           %[[VAL_2:.*]] = arith.constant {__amdgpuconvertbufferops.output_range = [1, 1]} 1 : i32
// CHECK:           %[[VAL_3:.*]] = arith.constant {__amdgpuconvertbufferops.output_range = [100, 100]} 100 : i32
...
// CHECK:           %[[VAL_3:.*]] = arith.constant {__amdgpuconvertbufferops.output_range = [1, 1]} 1 : i32
// CHECK:           %[[VAL_4:.*]] = arith.constant {__amdgpuconvertbufferops.output_range = [100, 100]} 100 : i32
// CHECK:           %[[VAL_5:.*]] = tt.addptr %[[VAL_0]], %[[VAL_3]] : !tt.ptr<f32>, i32
...
// CHECK:           %[[VAL_12:.*]] = arith.extsi %[[VAL_8]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
...
// CHECK:             %[[VAL_21:.*]] = arith.extsi %[[VAL_8]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:             %[[VAL_22:.*]] = arith.addi %[[VAL_21]], %[[VAL_18]] {__amdgpuconvertbufferops.output_range = [0, 132096]} : tensor<1024xi64>
// CHECK:             %[[VAL_23:.*]] = tt.splat %[[VAL_20]] : !tt.ptr<f32> -> tensor<1024x!tt.ptr<f32>>
// CHECK:             %[[VAL_24:.*]] = tt.addptr %[[VAL_23]], %[[VAL_22]] : tensor<1024x!tt.ptr<f32>>, tensor<1024xi64>
// CHECK:             %[[VAL_25:.*]] = tt.load %[[VAL_24]] : tensor<1024x!tt.ptr<f32>>
// CHECK:             %[[VAL_26:.*]] = arith.addf %[[VAL_25]], %[[VAL_19]] : tensor<1024xf32>
...
// CHECK:           %[[VAL_29:.*]] = arith.extsi %[[VAL_8]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:           %[[VAL_30:.*]] = arith.addi %[[VAL_29]], %[[VAL_28]]#1 {__amdgpuconvertbufferops.output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_13:.*]] = arith.extsi %[[VAL_9]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
...
// CHECK:             %[[VAL_23:.*]] = arith.extsi %[[VAL_9]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:             %[[VAL_24:.*]] = arith.addi %[[VAL_23]], %[[VAL_17]] {__amdgpuconvertbufferops.output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:             %[[VAL_30:.*]] = arith.extsi %[[VAL_9]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:             %[[VAL_31:.*]] = arith.addi %[[VAL_30]], %[[VAL_20]] {__amdgpuconvertbufferops.output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_38:.*]] = arith.extsi %[[VAL_9]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:           %[[VAL_39:.*]] = arith.addi %[[VAL_38]], %[[VAL_37]]#1 {__amdgpuconvertbufferops.output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_44:.*]] = arith.extsi %[[VAL_9]] {__amdgpuconvertbufferops.output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:           %[[VAL_45:.*]] = arith.addi %[[VAL_44]], %[[VAL_37]]#4 {__amdgpuconvertbufferops.output_range = [0, 132096]} : tensor<1024xi64>
