...
// CHECK-SAME:  %[[VAL_0:.*]]: !tt.ptr<f32>) -> tensor<1024xf32> {
// CHECK:           %[[VAL_1:.*]] = arith.constant {output_range = [0, 0]} 0 : i32
...
// CHECK:           %[[VAL_8:.*]] = arith.addi %[[VAL_5]], %[[VAL_5]] {output_range = [0, 2048]} : tensor<1024xi32>
...
// CHECK:             %[[VAL_18:.*]] = arith.addi %[[VAL_17]], %[[VAL_14]] {output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_26:.*]] = arith.addi %[[VAL_25]], %[[VAL_24]]#1 {output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:             %[[VAL_17:.*]] = arith.addi %[[VAL_16]], %[[VAL_13]] {output_range = [0, 131072]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_25:.*]] = arith.addi %[[VAL_24]], %[[VAL_23]]#1 {output_range = [0, 131072]} : tensor<1024xi64>
...
// CHECK:               %[[VAL_22:.*]] = arith.addi %[[VAL_21]], %[[VAL_18]] {output_range = [0, 131072]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_31:.*]] = arith.addi %[[VAL_30]], %[[VAL_29]]#1 {output_range = [0, 131072]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_3:.*]] = arith.constant {output_range = [0, 0]} 0 : i32
// CHECK:           %[[VAL_4:.*]] = arith.constant {output_range = [0, 0]} dense<0> : tensor<1024xi64>
// CHECK:           %[[VAL_5:.*]] = arith.constant {output_range = [1024, 1024]} 1024 : i32
// CHECK:           %[[VAL_6:.*]] = tt.get_program_id x {output_range = [0, 2048]} : i32
// CHECK:           %[[VAL_7:.*]] = arith.muli %[[VAL_6]], %[[VAL_5]] {output_range = [0, 2097152]} : i32
// CHECK:           %[[VAL_8:.*]] = tt.make_range {end = 1024 : i32, output_range = [0, 1024], start = 0 : i32} : tensor<1024xi32>
// CHECK:           %[[VAL_9:.*]]:2 = scf.if %[[VAL_2]] -> (!tt.ptr<f32>, tensor<1024xi64>) {
// CHECK:             %[[VAL_10:.*]] = tt.addptr %[[VAL_0]], %[[VAL_7]] : !tt.ptr<f32>, i32
// CHECK:             %[[VAL_11:.*]] = arith.extsi %[[VAL_8]] {output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
...
// CHECK:           }
// CHECK:           %[[VAL_13:.*]] = arith.trunci %[[VAL_14:.*]]#1 {output_range = [0, 1024]} : tensor<1024xi64> to tensor<1024xi32>
...
// CHECK-SAME:  %[[VAL_0:.*]]: !tt.ptr<f32>, %[[VAL_1:.*]]: i1) -> tensor<1024xf32> {
// CHECK:           %[[VAL_2:.*]] = arith.constant {output_range = [0, 0]} 0 : i32
// CHECK:           %[[VAL_3:.*]] = arith.constant {output_range = [1024, 1024]} 1024 : i32
// CHECK:           %[[VAL_4:.*]] = tt.get_program_id x {output_range = [0, 2048]} : i32
// CHECK:           %[[VAL_5:.*]] = arith.muli %[[VAL_4]], %[[VAL_3]] {output_range = [0, 2097152]} : i32
// CHECK:           %[[VAL_6:.*]] = tt.make_range {end = 1024 : i32, output_range = [0, 1024], start = 0 : i32} : tensor<1024xi32>
...
// CHECK:           %[[VAL_3:.*]] = arith.constant {output_range = [0, 0]} 0 : i32
// CHECK:           %[[VAL_4:.*]] = arith.constant {output_range = [0, 0]} 0 : i8
// CHECK:           %[[VAL_5:.*]] = arith.constant {output_range = [1024, 1024]} 1024 : i32
// CHECK:           %[[VAL_6:.*]] = tt.get_program_id x {output_range = [0, 2048]} : i32
// CHECK:           %[[VAL_7:.*]] = arith.muli %[[VAL_6]], %[[VAL_5]] {output_range = [0, 2097152]} : i32
// CHECK:           %[[VAL_8:.*]] = tt.make_range {end = 1024 : i32, output_range = [0, 1024], start = 0 : i32} : tensor<1024xi32>
// CHECK:           %[[VAL_9:.*]] = arith.cmpi ne, %[[VAL_2]], %[[VAL_4]] {output_range = [-1, 0]} : i8
// CHECK:           %[[VAL_10:.*]] = arith.select %[[VAL_9]], %[[VAL_0]], %[[VAL_1]] : !tt.ptr<i64>
// CHECK:           %[[VAL_11:.*]] = tt.addptr %[[VAL_10]], %[[VAL_7]] : !tt.ptr<i64>, i32
// CHECK:           %[[VAL_12:.*]] = amdgpu.buffer_load %[[VAL_11]]{{\[}}%[[VAL_8]]] stride = %[[VAL_3]] {output_range = [-9223372036854775808, 9223372036854775807]} : tensor<1024xi64>
...
// CHECK:             %[[VAL_14:.*]] = arith.trunci %[[VAL_12]] {output_range = [0, 131072]} : tensor<1024xi64> to tensor<1024xi32>
...
// CHECK:             %[[VAL_20:.*]] = arith.addi %[[VAL_19]], %[[VAL_12]] {output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:             %[[VAL_22:.*]] = arith.addi %[[VAL_21]], %[[VAL_18]] {output_range = [0, 132096]} : tensor<1024xi64>
// CHECK:             %[[VAL_23:.*]] = tt.splat %[[VAL_20]] : !tt.ptr<f32> -> tensor<1024x!tt.ptr<f32>>
// CHECK:             %[[VAL_24:.*]] = tt.addptr %[[VAL_23]], %[[VAL_22]] : tensor<1024x!tt.ptr<f32>>, tensor<1024xi64>
// CHECK:             %[[VAL_25:.*]] = tt.load %[[VAL_24]] : tensor<1024x!tt.ptr<f32>>
// CHECK:             %[[VAL_26:.*]] = arith.addf %[[VAL_25]], %[[VAL_19]] : tensor<1024xf32>
...
// CHECK:           %[[VAL_30:.*]] = arith.addi %[[VAL_29]], %[[VAL_28]]#1 {output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:             %[[VAL_24:.*]] = arith.addi %[[VAL_23]], %[[VAL_17]] {output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:             %[[VAL_30:.*]] = arith.extsi %[[VAL_9]] {output_range = [0, 1024]} : tensor<1024xi32> to tensor<1024xi64>
// CHECK:             %[[VAL_31:.*]] = arith.addi %[[VAL_30]], %[[VAL_20]] {output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_39:.*]] = arith.addi %[[VAL_38]], %[[VAL_37]]#1 {output_range = [0, 132096]} : tensor<1024xi64>
...
// CHECK:           %[[VAL_45:.*]] = arith.addi %[[VAL_44]], %[[VAL_37]]#4 {output_range = [0, 132096]} : tensor<1024xi64>
