...
#linear1 = #ttg.linear<{register = [[1], [4], [0], [0], [8], [2]], lane = [[0], [0], [0], [0], [0]], warp = [], block = []}>
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 1 : i32, "ttg.threads-per-warp" = 32 : i32} {
  ...
  //      CHECK: %[[C:.+]] = ttg.convert_layout %[[S]]
  //      CHECK: tt.return %[[C]]
    tt.func public @split_propagation_linear(%arg0: tensor<16x2xf32, #blocked>) -> tensor<16xf32, #linear1> {
    %0 = ttg.convert_layout %arg0 : tensor<16x2xf32, #blocked> -> tensor<16x2xf32, #linear>
    %outLHS, %outRHS = tt.split %0 : tensor<16x2xf32, #linear> -> tensor<16xf32, #linear1>
    tt.return %outLHS : tensor<16xf32, #linear1>
  }
}
