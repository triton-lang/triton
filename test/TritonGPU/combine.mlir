...
#mma = #ttg.amd_mfma<{version = 2, warpsPerCTA = [1, 1], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = true}>
#mma1 = #ttg.amd_mfma<{version = 2, warpsPerCTA = [1, 1], tilesPerWarp = [1, 1], instrShape = [16, 16], isTransposed = true}>
...
#mma = #ttg.amd_mfma<{version = 3, warpsPerCTA = [2, 2], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = true}>
...
#mma = #ttg.amd_mfma<{version = 4, warpsPerCTA = [2, 2], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = true}>
