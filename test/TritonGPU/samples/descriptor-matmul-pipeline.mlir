...
// CHECK:           %[[VAL_43:.*]] = ttg.local_alloc  {alignment = 1024 : i32} : () -> !ttg.memdesc<3x128x64xf16, #[[$ATTR_2]], #[[$ATTR_5]], mutable>
// CHECK:           %[[VAL_44:.*]] = ttg.local_alloc  {alignment = 1024 : i32} : () -> !ttg.memdesc<3x256x64xf16, #[[$ATTR_2]], #[[$ATTR_5]], mutable>
