...
#mma = #ttg.amd_mfma<{version = 3, warpsPerCTA = [4, 1], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = true}>
...
#mma = #ttg.amd_mfma<{version = 4, warpsPerCTA = [1, 4], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = true}>
...
#mma = #ttg.amd_mfma<{version = 3, warpsPerCTA = [4, 2], tilesPerWarp = [1, 1], instrShape = [32, 32], isTransposed = true}>
...
#mma = #ttg.amd_mfma<{version = 4, warpsPerCTA = [1, 8], tilesPerWarp = [1, 1], instrShape = [16, 16], isTransposed = true}>
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 8 : i32, ttg.target = "hip:gfx950", "ttg.threads-per-warp" = 64 : i32} {
