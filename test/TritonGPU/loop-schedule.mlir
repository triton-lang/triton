...
tt.func @matmul_loop_load_acc(%lb : index, %ub : index, %step : index,
  ...
  %expanded_c_tmp1 = tt.reshape %c_tmp0 : tensor<128xi32, #CLs0> -> tensor<1x128xi32, #expanded>
  %c_tmp1 = ttg.convert_layout %expanded_c_tmp1 : tensor<1x128xi32, #expanded> -> tensor<1x128xi32, #C>
