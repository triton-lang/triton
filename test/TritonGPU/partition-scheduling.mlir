...
tt.func public @attention_forward(
  ...
  %loop_outs:4 = scf.for %i = %c0_i32 to %n_tiles step %c64_i32 iter_args(
    ...
    %alpha_0 = tt.reshape %alpha : tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>> -> tensor<256x1xf32, #blocked>
  ...
  tt.func @if_stmt_yield_outputs(%lb: i32, %ub: i32, %step: i32,
    ...
    scf.for %arg3 = %lb to %ub step %step : i32 {
      ...
      %23 = scf.if %22 -> (tensor<128x64xbf16, #blocked>) {
        ...
        %39 = tt.reshape %38 : tensor<128xi1, #ttg.slice<{dim = 1, parent = #blocked}>> -> tensor<128x1xi1, #blocked>
    ...
    scf.for %arg3 = %lb to %ub step %step : i32 {
      ...
      %23 = scf.if %22 -> (tensor<128x64xbf16, #blocked>) {
        ...
        %39 = tt.reshape %38 {ttg.partition = array<i32: 0>} : tensor<128xi1, #ttg.slice<{dim = 1, parent = #blocked}>> -> tensor<128x1xi1, #blocked>
