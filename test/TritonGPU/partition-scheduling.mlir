...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  ...
  tt.func public @block_scaled_mma_scale_copy_tmem_store(%a_desc: !tt.tensordesc<tensor<128x128xf8E5M2, #shared>>, %b_desc: !tt.tensordesc<tensor<256x128xf8E5M2, #shared>>, %output_ptr: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %a_scale_ptr_35: tensor<128x4x!tt.ptr<i8>, #blocked>, %b_scale_ptr_42: tensor<256x4x!tt.ptr<i8>, #blocked>, %M: i32 {tt.divisibility = 16 : i32}, %N: i32 {tt.divisibility = 16 : i32}, %K: i32 {tt.divisibility = 16 : i32}, %stride_cm: i32 {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %num_pid_m_10 = arith.divsi %M, %c128_i32 : i32
    ...
    %accumulator_46:5 = scf.for %accumulator_63 = %c0_i32 to %1 step %c1_i32 iter_args(%arg18 = %c0_i32, %a_scale_ptr_64 = %a_scale_ptr_35, %b_scale_ptr_65 = %b_scale_ptr_42, %accumulator_66 = %accumulator, %accumulator_67 = %accumulator_45) -> (i32, tensor<128x4x!tt.ptr<i8>, #blocked>, tensor<256x4x!tt.ptr<i8>, #blocked>, i1, !ttg.async.token)  : i32 {
      ...
      // CHECK-COUNT-6: ttg.partition = array<i32: 3>
      ...
      // CHECK-COUNT-2: ttng.tmem_alloc {{.*}}ttg.partition = array<i32: 3>
