...
tt.func @indirect_bmm_scalar(%77: i64 {tt.divisibility=16: i32},
                   ...
                   %60: tensor<16x16x!tt.ptr<f16>, #BL> {tt.divisibility = [16, 16] : tensor<2xi32>, tt.contiguity = [1, 16] : tensor<2xi32>}) -> tensor<16x16xf32, #C>{
...
tt.func @indirect_bmm_scalar_dist_one(%77: i64 {tt.divisibility=16: i32},
                   %76: index,
                   %49: tensor<16x16x!tt.ptr<f16>, #AL> {tt.divisibility = [16, 16] : tensor<2xi32>, tt.contiguity = [1, 2] : tensor<2xi32>},
                   %75: !tt.ptr<i64>,
                   %78: tensor<16x16xi32, #AL> {tt.constancy=16: i32, tt.divisibility=16: i32},
                   %60: tensor<16x16x!tt.ptr<f16>, #BL> {tt.divisibility = [16, 16] : tensor<2xi32>, tt.contiguity = [1, 16] : tensor<2xi32>}) -> tensor<16x16xf32, #C>{
  %cst = arith.constant dense<0.000000e+00> : tensor<16x16xf32, #C>
...
tt.func @peeled_prologue_statically_dead(
                  %a_ptr : tensor<128x32x!tt.ptr<f16>, #AL> {tt.divisibility = [16, 16] : tensor<2xi32>, tt.contiguity = [1, 16] : tensor<2xi32>},
