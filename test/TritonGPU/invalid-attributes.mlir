...
// expected-error@+1 {{invalid WMMA version 1 instruction shape}}
#wmma = #ttg.amd_wmma<{version = 1, warpsPerCTA = [1, 1], instrShape = [16, 16, 32]}>

// -----

// expected-error@+1 {{invalid WMMA version 2 instruction shape}}
#wmma = #ttg.amd_wmma<{version = 2, warpsPerCTA = [1, 1], instrShape = [16, 16, 64]}>

// -----

// expected-error@+1 {{invalid WMMA version 3 instruction shape}}
