...
#wmma = #ttg.amd_wmma<{version = 1, warpLayout = {register = [], warp = [[0, 1], [0, 2]]}}>
...
#wmma = #ttg.amd_wmma<{version = 2, warpLayout = {register = [], warp = [[0, 1], [0, 2]]}}>
#dot_op = #ttg.dot_op<{opIdx = 1, parent = #wmma, kWidth = 32}>

// -----

// expected-error@+1 {{invalid WMMA v1 instruction shape}}
#wmma = #ttg.amd_wmma<{version = 1, warpLayout = {register = [], warp = []}, instrShape = [16, 16, 32]}>

// -----

// expected-error@+1 {{invalid WMMA v2 instruction shape}}
#wmma = #ttg.amd_wmma<{version = 2, warpLayout = {register = [], warp = []}, instrShape = [16, 16, 64]}>

// -----

// expected-error@+1 {{invalid WMMA v3 instruction shape}}
#wmma = #ttg.amd_wmma<{version = 3, warpLayout = {register = [], warp = []}, instrShape = [16, 16, 16]}>
