...
module attributes {"ttg.target" = "cuda:0", "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 1 : i32, "ttg.threads-per-warp" = 32 : i32} {
  ...
  // CHECK: ttg.memdesc_reinterpret
  tt.func @memdesc_reinterpret_contiguous_smem_subview(%arg0 : !ttg.memdesc<8x16xf16, #shared2d, #smem, mutable, 16x16>) {
    %0 = ttg.memdesc_reinterpret %arg0 : !ttg.memdesc<8x16xf16, #shared2d, #smem, mutable, 16x16> -> !ttg.memdesc<8x8xf32, #shared2d, #smem, mutable>
    tt.return
  }
}
