...
// CHECK: %[[TID:.*]] = ttng.get_async_task_id : i32
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:90", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @_attn_bwd_ws(%arg0: !tt.ptr<bf16> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<i64> {tt.divisibility = 16 : i32}, %arg2: !tt.ptr<bf16> {tt.divisibility = 16 : i32}, %arg3: !tt.ptr<i64> {tt.divisibility = 16 : i32}, %arg4: !tt.ptr<bf16> {tt.divisibility = 16 : i32}, %arg5: !tt.tensordesc<tensor<64x128xbf16>>, %arg6: !tt.tensordesc<tensor<64x128xbf16>>, %arg7: !tt.tensordesc<tensor<64x128xbf16>>, %arg8: !tt.tensordesc<tensor<64x128xbf16>>, %arg9: !tt.tensordesc<tensor<64x128xbf16>>, %arg10: !tt.tensordesc<tensor<64x128xbf16>>, %arg11: !tt.tensordesc<tensor<64x128xbf16>>, %arg12: !tt.tensordesc<tensor<64x128xbf16>>, %arg14: f32, %arg15: !tt.ptr<bf16> {tt.divisibility = 16 : i32}, %arg16: !tt.ptr<i64> {tt.divisibility = 16 : i32}, %arg17: !tt.ptr<bf16> {tt.divisibility = 16 : i32}, %arg18: !tt.ptr<bf16> {tt.divisibility = 16 : i32}, %arg19: !tt.ptr<bf16> {tt.divisibility = 16 : i32}, %arg20: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg21: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg22: i32 {tt.divisibility = 16 : i32}, %arg23: i32 {tt.divisibility = 16 : i32}, %arg24: i32 {tt.divisibility = 16 : i32}, %arg25: i32 {tt.divisibility = 16 : i32}, %arg26: i32 {tt.divisibility = 16 : i32}, %arg27: i32 {tt.divisibility = 16 : i32}, %arg28: i32 {tt.divisibility = 16 : i32}, %arg29: i32, %arg30: i32 {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %15 = tt.make_range {async_task_id = dense<1> : vector<1xi32>, end = 64 : i32, start = 0 : i32} : tensor<64xi32, #ttg.slice<{dim = 1, parent = #blocked}>>
    %16 = tt.make_range {async_task_id = dense<2> : vector<1xi32>, end = 128 : i32, start = 64 : i32} : tensor<64xi32, #ttg.slice<{dim = 1, parent = #blocked}>>
    ...
    scf.if %25 {
      %27 = tt.splat %14 {async_task_id = dense<1> : vector<1xi32>} : i32 -> tensor<64xi32, #ttg.slice<{dim = 1, parent = #blocked}>>
      %28 = tt.splat %14 {async_task_id = dense<2> : vector<1xi32>} : i32 -> tensor<64xi32, #ttg.slice<{dim = 1, parent = #blocked}>>
      %29 = arith.addi %27, %15 {async_task_id = dense<1> : vector<1xi32>} : tensor<64xi32, #ttg.slice<{dim = 1, parent = #blocked}>>
      %30 = arith.addi %28, %16 {async_task_id = dense<2> : vector<1xi32>} : tensor<64xi32, #ttg.slice<{dim = 1, parent = #blocked}>>
      ...
      %37 = tt.descriptor_load %arg6[%33, %36] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<64x128xbf16>> -> tensor<64x128xbf16, #blocked2>
      %38 = tt.descriptor_load %arg6[%35, %36] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<64x128xbf16>> -> tensor<64x128xbf16, #blocked2>
      %39 = ttg.local_alloc %37 {async_task_id = dense<1> : vector<1xi32>} : (tensor<64x128xbf16, #blocked2>) -> !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory>
      %40 = ttg.local_alloc %38 {async_task_id = dense<2> : vector<1xi32>} : (tensor<64x128xbf16, #blocked2>) -> !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory>
      %41 = tt.descriptor_load %arg7[%33, %36] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<64x128xbf16>> -> tensor<64x128xbf16, #blocked2>
      %42 = tt.descriptor_load %arg7[%34, %36] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<64x128xbf16>> -> tensor<64x128xbf16, #blocked2>
      %43 = ttg.local_alloc %41 {async_task_id = dense<1> : vector<1xi32>} : (tensor<64x128xbf16, #blocked2>) -> !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory>
      %44 = ttg.local_alloc %42 {async_task_id = dense<2> : vector<1xi32>} : (tensor<64x128xbf16, #blocked2>) -> !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory>
      ...
      %48 = tt.make_range {async_task_id = dense<[1, 2]> : vector<2xi32>, end = 64 : i32, start = 0 : i32} : tensor<64xi32, #ttg.slice<{dim = 0, parent = #mma}>>
      ...
      %54 = tt.splat %8 {async_task_id = dense<[1, 2]> : vector<2xi32>} : i64 -> tensor<64xi64, #ttg.slice<{dim = 0, parent = #mma}>>
      %55 = tt.splat %23#3 {async_task_id = dense<[1, 2]> : vector<2xi32>} : !tt.ptr<f32> -> tensor<64x!tt.ptr<f32>, #ttg.slice<{dim = 0, parent = #mma}>>
      ...
      %58 = tt.splat %23#4 {async_task_id = dense<[1, 2]> : vector<2xi32>} : !tt.ptr<f32> -> tensor<64x!tt.ptr<f32>, #ttg.slice<{dim = 0, parent = #mma}>>
      %59:3 = scf.for %arg31 = %c0_i64 to %46 step %c1_i64 iter_args(%arg32 = %c0_i32, %arg33 = %cst_1, %arg35 = %cst_1) -> (i32, tensor<64x128xf32, #mma1>, tensor<64x128xf32, #mma1>)  : i64 {
        %111 = tt.splat %arg32 {async_task_id = dense<[1, 2]> : vector<2xi32>} : i32 -> tensor<64xi32, #ttg.slice<{dim = 0, parent = #mma}>>
        %112 = arith.addi %111, %48 {async_task_id = dense<[1, 2]> : vector<2xi32>} : tensor<64xi32, #ttg.slice<{dim = 0, parent = #mma}>>
        %113 = tt.descriptor_load %arg5[%50, %53] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<64x128xbf16>> -> tensor<64x128xbf16, #blocked2>
        %114 = ttg.local_alloc %113 {async_task_id = dense<[1, 2]> : vector<2xi32>} : (tensor<64x128xbf16, #blocked2>) -> !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory>
        %115 = ttg.memdesc_trans %114 {async_task_id = dense<[1, 2]> : vector<2xi32>, order = array<i32: 1, 0>} : !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> -> !ttg.memdesc<128x64xbf16, #shared1, #ttg.shared_memory>
        %116 = arith.extsi %112 {async_task_id = dense<[1, 2]> : vector<2xi32>} : tensor<64xi32, #ttg.slice<{dim = 0, parent = #mma}>> to tensor<64xi64, #ttg.slice<{dim = 0, parent = #mma}>>
        %117 = arith.cmpi slt, %116, %54 {async_task_id = dense<[1, 2]> : vector<2xi32>} : tensor<64xi64, #ttg.slice<{dim = 0, parent = #mma}>>
        %118 = tt.addptr %55, %112 {async_task_id = dense<[1, 2]> : vector<2xi32>} : tensor<64x!tt.ptr<f32>, #ttg.slice<{dim = 0, parent = #mma}>>, tensor<64xi32, #ttg.slice<{dim = 0, parent = #mma}>>
        %119 = tt.load %118, %117 {async_task_id = dense<[1, 2]> : vector<2xi32>} : tensor<64x!tt.ptr<f32>, #ttg.slice<{dim = 0, parent = #mma}>>
        %120 = ttng.warp_group_dot %39, %115, %cst, %false {async_task_id = dense<1> : vector<1xi32>, inputPrecision = 0 : i32} : !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> * !ttg.memdesc<128x64xbf16, #shared1, #ttg.shared_memory> -> tensor<64x64xf32, #mma>
        %121 = ttng.warp_group_dot %40, %115, %cst, %false {async_task_id = dense<2> : vector<1xi32>, inputPrecision = 0 : i32} : !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> * !ttg.memdesc<128x64xbf16, #shared1, #ttg.shared_memory> -> tensor<64x64xf32, #mma>
        ...
        %124 = tt.descriptor_load %arg8[%50, %53] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<64x128xbf16>> -> tensor<64x128xbf16, #blocked2>
        %125 = ttg.local_alloc %124 {async_task_id = dense<[1, 2]> : vector<2xi32>} : (tensor<64x128xbf16, #blocked2>) -> !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory>
        %126 = ttg.memdesc_trans %125 {async_task_id = dense<[1, 2]> : vector<2xi32>, order = array<i32: 1, 0>} : !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> -> !ttg.memdesc<128x64xbf16, #shared1, #ttg.shared_memory>
        %127 = ttng.warp_group_dot %43, %126, %cst, %false {async_task_id = dense<1> : vector<1xi32>, inputPrecision = 0 : i32} : !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> * !ttg.memdesc<128x64xbf16, #shared1, #ttg.shared_memory> -> tensor<64x64xf32, #mma>
        %128 = ttng.warp_group_dot %44, %126, %cst, %false {async_task_id = dense<2> : vector<1xi32>, inputPrecision = 0 : i32} : !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> * !ttg.memdesc<128x64xbf16, #shared1, #ttg.shared_memory> -> tensor<64x64xf32, #mma>
        %129 = tt.expand_dims %119 {async_task_id = dense<[1, 2]> : vector<2xi32>, axis = 0 : i32} : tensor<64xf32, #ttg.slice<{dim = 0, parent = #mma}>> -> tensor<1x64xf32, #mma>
        ...
        %138 = tt.addptr %58, %112 {async_task_id = dense<[1, 2]> : vector<2xi32>} : tensor<64x!tt.ptr<f32>, #ttg.slice<{dim = 0, parent = #mma}>>, tensor<64xi32, #ttg.slice<{dim = 0, parent = #mma}>>
        %139 = tt.load %138, %117 {async_task_id = dense<[1, 2]> : vector<2xi32>} : tensor<64x!tt.ptr<f32>, #ttg.slice<{dim = 0, parent = #mma}>>
        %140 = ttg.convert_layout %136 {async_task_id = dense<1> : vector<1xi32>} : tensor<64x64xbf16, #mma> -> tensor<64x64xbf16, #ttg.dot_op<{opIdx = 0, parent = #mma, kWidth = 2}>>
        %141 = ttg.convert_layout %137 {async_task_id = dense<2> : vector<1xi32>} : tensor<64x64xbf16, #mma> -> tensor<64x64xbf16, #ttg.dot_op<{opIdx = 0, parent = #mma, kWidth = 2}>>
        %142 = ttng.warp_group_dot %140, %125, %arg33 {async_task_id = dense<1> : vector<1xi32>, inputPrecision = 0 : i32} : tensor<64x64xbf16, #ttg.dot_op<{opIdx = 0, parent = #mma, kWidth = 2}>> * !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> -> tensor<64x128xf32, #mma1>
        %143 = ttng.warp_group_dot %141, %125, %arg35 {async_task_id = dense<2> : vector<1xi32>, inputPrecision = 0 : i32} : tensor<64x64xbf16, #ttg.dot_op<{opIdx = 0, parent = #mma, kWidth = 2}>> * !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> -> tensor<64x128xf32, #mma1>
      ...
      %60 = tt.make_range {async_task_id = dense<[1, 2]> : vector<2xi32>, end = 128 : i32, start = 0 : i32} : tensor<128xi32, #ttg.slice<{dim = 0, parent = #blocked}>>
      %61 = tt.expand_dims %60 {async_task_id = dense<[1, 2]> : vector<2xi32>, axis = 0 : i32} : tensor<128xi32, #ttg.slice<{dim = 0, parent = #blocked}>> -> tensor<1x128xi32, #blocked>
      %62 = arith.cmpi slt, %61, %cst_0 {async_task_id = dense<[1, 2]> : vector<2xi32>} : tensor<1x128xi32, #blocked>
      %63 = tt.expand_dims %29 {async_task_id = dense<1> : vector<1xi32>, axis = 1 : i32} : tensor<64xi32, #ttg.slice<{dim = 1, parent = #blocked}>> -> tensor<64x1xi32, #blocked>
      %64 = tt.expand_dims %30 {async_task_id = dense<2> : vector<1xi32>, axis = 1 : i32} : tensor<64xi32, #ttg.slice<{dim = 1, parent = #blocked}>> -> tensor<64x1xi32, #blocked>
      ...
      %93 = ttg.convert_layout %91 {async_task_id = dense<1> : vector<1xi32>} : tensor<64x128xbf16, #mma1> -> tensor<64x128xbf16, #blocked>
      %94 = ttg.convert_layout %92 {async_task_id = dense<2> : vector<1xi32>} : tensor<64x128xbf16, #mma1> -> tensor<64x128xbf16, #blocked>
    ...
    scf.if %26 {
      ...
      %31 = arith.addi %27, %15 {async_task_id = dense<1> : vector<1xi32>} : tensor<64xi32, #ttg.slice<{dim = 1, parent = #blocked}>>
      %32 = arith.addi %28, %16 {async_task_id = dense<2> : vector<1xi32>} : tensor<64xi32, #ttg.slice<{dim = 1, parent = #blocked}>>
      ...
      %44 = tt.descriptor_load %arg9[%38, %43] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<64x128xbf16>> -> tensor<64x128xbf16, #blocked2>
      %45 = tt.descriptor_load %arg9[%40, %43] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<64x128xbf16>> -> tensor<64x128xbf16, #blocked2>
      %46 = ttg.local_alloc %44 {async_task_id = dense<1> : vector<1xi32>} : (tensor<64x128xbf16, #blocked2>) -> !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory>
      %47 = ttg.local_alloc %45 {async_task_id = dense<2> : vector<1xi32>} : (tensor<64x128xbf16, #blocked2>) -> !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory>
      ...
      %50 = arith.trunci %49 {async_task_id = dense<0> : vector<1xi32>} : i64 to i32
      %51 = tt.descriptor_load %arg12[%38, %50] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<64x128xbf16>> -> tensor<64x128xbf16, #blocked2>
      %52 = tt.descriptor_load %arg12[%39, %50] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<64x128xbf16>> -> tensor<64x128xbf16, #blocked2>
      %53 = ttg.local_alloc %51 {async_task_id = dense<1> : vector<1xi32>} : (tensor<64x128xbf16, #blocked2>) -> !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory>
      %54 = ttg.local_alloc %52 {async_task_id = dense<2> : vector<1xi32>} : (tensor<64x128xbf16, #blocked2>) -> !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory>
      ...
      %67 = ttg.convert_layout %65 {async_task_id = dense<1> : vector<1xi32>} : tensor<64xf32, #blocked1> -> tensor<64xf32, #ttg.slice<{dim = 1, parent = #blocked3}>>
      %68 = ttg.convert_layout %66 {async_task_id = dense<2> : vector<1xi32>} : tensor<64xf32, #blocked1> -> tensor<64xf32, #ttg.slice<{dim = 1, parent = #blocked3}>>
      %69 = tt.expand_dims %67 {async_task_id = dense<1> : vector<1xi32>, axis = 1 : i32} : tensor<64xf32, #ttg.slice<{dim = 1, parent = #blocked3}>> -> tensor<64x1xf32, #blocked3>
      %70 = tt.expand_dims %68 {async_task_id = dense<2> : vector<1xi32>, axis = 1 : i32} : tensor<64xf32, #ttg.slice<{dim = 1, parent = #blocked3}>> -> tensor<64x1xf32, #blocked3>
      ...
      %85 = ttg.convert_layout %83 {async_task_id = dense<1> : vector<1xi32>} : tensor<64x64xf32, #blocked3> -> tensor<64x64xf32, #mma>
      %86 = ttg.convert_layout %84 {async_task_id = dense<2> : vector<1xi32>} : tensor<64x64xf32, #blocked3> -> tensor<64x64xf32, #mma>
      %87 = ttg.convert_layout %77 {async_task_id = dense<1> : vector<1xi32>} : tensor<64xf32, #blocked1> -> tensor<64xf32, #ttg.slice<{dim = 1, parent = #blocked3}>>
      %88 = ttg.convert_layout %78 {async_task_id = dense<2> : vector<1xi32>} : tensor<64xf32, #blocked1> -> tensor<64xf32, #ttg.slice<{dim = 1, parent = #blocked3}>>
      %89 = tt.expand_dims %87 {async_task_id = dense<1> : vector<1xi32>, axis = 1 : i32} : tensor<64xf32, #ttg.slice<{dim = 1, parent = #blocked3}>> -> tensor<64x1xf32, #blocked3>
      %90 = tt.expand_dims %88 {async_task_id = dense<2> : vector<1xi32>, axis = 1 : i32} : tensor<64xf32, #ttg.slice<{dim = 1, parent = #blocked3}>> -> tensor<64x1xf32, #blocked3>
      ...
      %93 = ttg.convert_layout %91 {async_task_id = dense<1> : vector<1xi32>} : tensor<64x64xf32, #blocked3> -> tensor<64x64xf32, #mma>
      %94 = ttg.convert_layout %92 {async_task_id = dense<2> : vector<1xi32>} : tensor<64x64xf32, #blocked3> -> tensor<64x64xf32, #mma>
      ...
      %97:2 = scf.for %arg31 = %c0_i64 to %72 step %c1_i64 iter_args(%arg32 = %cst_1, %arg33 = %cst_1) -> (tensor<64x128xf32, #mma1>, tensor<64x128xf32, #mma1>)  : i64 {
        %135 = tt.descriptor_load %arg10[%79, %80] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<64x128xbf16>> -> tensor<64x128xbf16, #blocked2>
        %136 = ttg.local_alloc %135 {async_task_id = dense<[1, 2]> : vector<2xi32>} : (tensor<64x128xbf16, #blocked2>) -> !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory>
        %137 = ttg.memdesc_trans %136 {async_task_id = dense<[1, 2]> : vector<2xi32>, order = array<i32: 1, 0>} : !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> -> !ttg.memdesc<128x64xbf16, #shared1, #ttg.shared_memory>
        %138 = tt.descriptor_load %arg11[%79, %80] {async_task_id = dense<0> : vector<1xi32>} :!tt.tensordesc<tensor<64x128xbf16>> -> tensor<64x128xbf16, #blocked2>
        %139 = ttg.local_alloc %138 {async_task_id = dense<[1, 2]> : vector<2xi32>} : (tensor<64x128xbf16, #blocked2>) -> !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory>
        %140 = ttg.memdesc_trans %139 {async_task_id = dense<[1, 2]> : vector<2xi32>, order = array<i32: 1, 0>} : !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> -> !ttg.memdesc<128x64xbf16, #shared1, #ttg.shared_memory>
        %141 = ttng.warp_group_dot %46, %137, %cst, %false {async_task_id = dense<1> : vector<1xi32>, inputPrecision = 0 : i32} : !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> * !ttg.memdesc<128x64xbf16, #shared1, #ttg.shared_memory> -> tensor<64x64xf32, #mma>
        %142 = ttng.warp_group_dot %47, %137, %cst, %false {async_task_id = dense<2> : vector<1xi32>, inputPrecision = 0 : i32} : !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> * !ttg.memdesc<128x64xbf16, #shared1, #ttg.shared_memory> -> tensor<64x64xf32, #mma>
        ...
        %145 = ttng.warp_group_dot %53, %140, %cst, %false {async_task_id = dense<1> : vector<1xi32>, inputPrecision = 0 : i32} : !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> * !ttg.memdesc<128x64xbf16, #shared1, #ttg.shared_memory> -> tensor<64x64xf32, #mma>
        %146 = ttng.warp_group_dot %54, %140, %cst, %false {async_task_id = dense<2> : vector<1xi32>, inputPrecision = 0 : i32} : !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> * !ttg.memdesc<128x64xbf16, #shared1, #ttg.shared_memory> -> tensor<64x64xf32, #mma>
        ...
        %157 = ttg.convert_layout %155 {async_task_id = dense<1> : vector<1xi32>} : tensor<64x64xbf16, #mma> -> tensor<64x64xbf16, #ttg.dot_op<{opIdx = 0, parent = #mma, kWidth = 2}>>
        %158 = ttg.convert_layout %156 {async_task_id = dense<2> : vector<1xi32>} : tensor<64x64xbf16, #mma> -> tensor<64x64xbf16, #ttg.dot_op<{opIdx = 0, parent = #mma, kWidth = 2}>>
        %159 = ttng.warp_group_dot %157, %136, %cst_1, %false {async_task_id = dense<1> : vector<1xi32>, inputPrecision = 0 : i32} : tensor<64x64xbf16, #ttg.dot_op<{opIdx = 0, parent = #mma, kWidth = 2}>> * !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> -> tensor<64x128xf32, #mma1>
        %160 = ttng.warp_group_dot %158, %136, %cst_1, %false {async_task_id = dense<2> : vector<1xi32>, inputPrecision = 0 : i32} : tensor<64x64xbf16, #ttg.dot_op<{opIdx = 0, parent = #mma, kWidth = 2}>> * !ttg.memdesc<64x128xbf16, #shared, #ttg.shared_memory> -> tensor<64x128xf32, #mma1>
      ...
      %98 = tt.make_range {async_task_id = dense<[1, 2]> : vector<2xi32>, end = 128 : i32, start = 0 : i32} : tensor<128xi32, #ttg.slice<{dim = 0, parent = #blocked}>>
      %99 = tt.expand_dims %98 {async_task_id = dense<[1, 2]> : vector<2xi32>, axis = 0 : i32} : tensor<128xi32, #ttg.slice<{dim = 0, parent = #blocked}>> -> tensor<1x128xi32, #blocked>
      %100 = arith.cmpi slt, %99, %cst_0 {async_task_id = dense<[1, 2]> : vector<2xi32>} : tensor<1x128xi32, #blocked>
      %101 = tt.expand_dims %31 {async_task_id = dense<1> : vector<1xi32>, axis = 1 : i32} : tensor<64xi32, #ttg.slice<{dim = 1, parent = #blocked}>> -> tensor<64x1xi32, #blocked>
      %102 = tt.expand_dims %32 {async_task_id = dense<2> : vector<1xi32>, axis = 1 : i32} : tensor<64xi32, #ttg.slice<{dim = 1, parent = #blocked}>> -> tensor<64x1xi32, #blocked>
      ...
      %133 = ttg.convert_layout %131 {async_task_id = dense<1> : vector<1xi32>} : tensor<64x128xbf16, #mma1> -> tensor<64x128xbf16, #blocked>
      %134 = ttg.convert_layout %132 {async_task_id = dense<2> : vector<1xi32>} : tensor<64x128xbf16, #mma1> -> tensor<64x128xbf16, #blocked>
  ...
  tt.func public @matmul_persistent_tma_ws_tcgen05_kernel(%arg0: !tt.ptr<i8, 0> {tt.nv_tma_desc = 1 : i32}, %arg1: !tt.ptr<i8, 0> {tt.nv_tma_desc = 1 : i32}, %arg2: !tt.ptr<i8, 0> {tt.nv_tma_desc = 1 : i32}, %arg3: i32 {tt.divisibility = 16 : i32}, %arg4: i32 {tt.divisibility = 16 : i32}, %arg5: i32 {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    scf.for %arg6 = %5 to %4 step %6  : i32 {
      ...
      %24:2 = scf.for %arg7 = %c0_i32 to %9 step %c1_i32 iter_args(%arg8 = %cst, %arg9 = %c0_i32) -> (tensor<128x256xf32, #blocked>, i32)  : i32 {
        %28 = tt.descriptor_load %10[%21, %arg9] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<128x64xf16>> -> tensor<128x64xf16, #blocked1>
        %29 = ttg.local_alloc %28 {async_task_id = dense<1> : vector<1xi32>} : (tensor<128x64xf16, #blocked1>) -> !ttg.memdesc<128x64xf16, #shared, #smem>
        %30 = tt.descriptor_load %11[%22, %arg9] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<256x64xf16>> -> tensor<256x64xf16, #blocked1>
        ...
        ttng.tc_gen5_mma %29, %32, %23, %true, %true {async_task_id = dense<1> : vector<1xi32>} : !ttg.memdesc<128x64xf16, #shared, #smem>, !ttg.memdesc<64x256xf16, #shared1, #smem>, !ttg.memdesc<128x256xf32, #tmem, #ttng.tensor_memory, mutable>
      ...
      tt.descriptor_store %12[%21, %22], %27 {async_task_id = dense<1> : vector<1xi32>} : !tt.tensordesc<tensor<128x256xf16>>, tensor<128x256xf16, #blocked2>
    } {async_task_id = dense<[0, 1]> : vector<2xi32>}
    tt.return
  }
}
...
// CHECK-LABEL: @matmul_persistent_tma_ws_tcgen05_epilogue_kernel
// CHECK: %[[#TASKID:]] = ttng.get_async_task_id : i32
// CHECK: %[[C0:.+]] = arith.constant 0 : i32
// CHECK: %[[#WG0:]] = arith.cmpi eq, %[[#TASKID]], %[[C0]] : i32
// CHECK: scf.if %[[#WG0]]
...
// CHECK: %[[#WG2:]] = arith.cmpi eq, %[[#TASKID]], %[[C2]] : i32
// CHECK: scf.if %[[#WG2]]
// CHECK: ttng.reg_alloc 232
// CHECK: ttng.consumer_wait
// CHECK: ttng.tmem_load
...
#tmem = #ttng.tensor_memory_encoding<blockM = 128, blockN = 256, unpacked = true>
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @matmul_persistent_tma_ws_tcgen05_epilogue_kernel(%arg0: !tt.ptr<i8, 0> {tt.nv_tma_desc = 1 : i32}, %arg1: !tt.ptr<i8, 0> {tt.nv_tma_desc = 1 : i32}, %arg2: !tt.ptr<i8, 0> {tt.nv_tma_desc = 1 : i32}, %arg3: i32 {tt.divisibility = 16 : i32}, %arg4: i32 {tt.divisibility = 16 : i32}, %arg5: i32 {tt.divisibility = 16 : i32}, %arg6: i32 {tt.divisibility = 16 : i32}, %arg7: i32 {tt.divisibility = 16 : i32}, %arg8: i32 {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    %true = arith.constant {async_task_id = dense<1> : vector<1xi32>} true
    %c127_i32 = arith.constant {async_task_id = dense<[0, 1, 2]> : vector<3xi32>} 127 : i32
    %c8_i32 = arith.constant {async_task_id = dense<[0, 2]> : vector<2xi32>} 8 : i32
    %c128_i32 = arith.constant {async_task_id = dense<[0, 1, 2]> : vector<3xi32>} 128 : i32
    %c256_i32 = arith.constant {async_task_id = dense<[0, 1, 2]> : vector<3xi32>} 256 : i32
    %c0_i32 = arith.constant {async_task_id = dense<[0, 1]> : vector<2xi32>} 0 : i32
    %c64_i32 = arith.constant {async_task_id = dense<[0, 1]> : vector<2xi32>} 64 : i32
    ...
    %c255_i32 = arith.constant {async_task_id = dense<[0, 1, 2]> : vector<3xi32>} 255 : i32
    %c63_i32 = arith.constant {async_task_id = dense<[0, 1]> : vector<2xi32>} 63 : i32
    %cst = arith.constant {async_task_id = dense<[0, 1, 2]> : vector<3xi32>} dense<0.000000e+00> : tensor<128x256xf32, #blocked>
    ...
    %7 = arith.muli %3, %c8_i32 {async_task_id = dense<[0, 2]> : vector<2xi32>} : i32
    %8 = arith.addi %arg5, %c63_i32 {async_task_id = dense<[0, 1]> : vector<2xi32>} : i32
    %9 = arith.divsi %8, %c64_i32 {async_task_id = dense<[0, 1]> : vector<2xi32>} : i32
    %10 = tt.reinterpret_tensor_descriptor %arg0 {async_task_id = dense<0> : vector<1xi32>} : !tt.ptr<i8, 0> to !tt.tensordesc<tensor<128x64xf16>>
    %11 = tt.reinterpret_tensor_descriptor %arg1 {async_task_id = dense<0> : vector<1xi32>} : !tt.ptr<i8, 0> to !tt.tensordesc<tensor<64x256xf16>>
    %12 = tt.reinterpret_tensor_descriptor %arg2 {async_task_id = dense<2> : vector<1xi32>} : !tt.ptr<i8, 0> to !tt.tensordesc<tensor<128x256xf16>>
    scf.for %arg9 = %5 to %4 step %6  : i32 {
      %13 = arith.divsi %arg9, %7 {async_task_id = dense<[0, 2]> : vector<2xi32>} : i32
      %14 = arith.muli %13, %c8_i32 {async_task_id = dense<[0, 2]> : vector<2xi32>} : i32
      %15 = arith.subi %1, %14 {async_task_id = dense<[0, 2]> : vector<2xi32>} : i32
      %16 = arith.minsi %15, %c8_i32 {async_task_id = dense<[0, 2]> : vector<2xi32>} : i32
      %17 = arith.remsi %arg9, %7 {async_task_id = dense<[0, 2]> : vector<2xi32>} : i32
      %18 = arith.remsi %17, %16 {async_task_id = dense<[0, 2]> : vector<2xi32>} : i32
      %19 = arith.addi %14, %18 {async_task_id = dense<[0, 2]> : vector<2xi32>} : i32
      %20 = arith.divsi %17, %16 {async_task_id = dense<[0, 2]> : vector<2xi32>} : i32
      %21 = arith.muli %19, %c128_i32 {async_task_id = dense<[0, 2]> : vector<2xi32>} : i32
      %22 = arith.muli %20, %c256_i32 {async_task_id = dense<[0, 2]> : vector<2xi32>} : i32
      %23 = ttng.tmem_alloc %cst {async_task_id = dense<[1, 2]> : vector<2xi32>} : (tensor<128x256xf32, #blocked>) -> !ttg.memdesc<128x256xf32, #tmem, #ttng.tensor_memory, mutable>
      %24:2 = scf.for %arg10 = %c0_i32 to %9 step %c1_i32 iter_args(%arg11 = %cst, %arg12 = %c0_i32) -> (tensor<128x256xf32, #blocked>, i32)  : i32 {
        %28 = tt.descriptor_load %10[%21, %arg12] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<128x64xf16>> -> tensor<128x64xf16, #blocked1>
        %29 = ttg.local_alloc %28 {async_task_id = dense<1> : vector<1xi32>} : (tensor<128x64xf16, #blocked1>) -> !ttg.memdesc<128x64xf16, #shared, #smem>
        %30 = tt.descriptor_load %11[%arg12, %22] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<64x256xf16>> -> tensor<64x256xf16, #blocked2>
        %31 = ttg.local_alloc %30 {async_task_id = dense<1> : vector<1xi32>} : (tensor<64x256xf16, #blocked2>) -> !ttg.memdesc<64x256xf16, #shared, #smem>
        ttng.tc_gen5_mma %29, %31, %23, %true, %true {async_task_id = dense<1> : vector<1xi32>} : !ttg.memdesc<128x64xf16, #shared, #smem>, !ttg.memdesc<64x256xf16, #shared, #smem>, !ttg.memdesc<128x256xf32, #tmem, #ttng.tensor_memory, mutable>
        %32 = arith.addi %arg12, %c64_i32 {async_task_id = dense<0> : vector<1xi32>} : i32
        scf.yield {async_task_id = dense<[0, 1]> : vector<2xi32>} %arg11, %32 : tensor<128x256xf32, #blocked>, i32
      } {async_task_id = dense<[0, 1]> : vector<2xi32>}
      %25 = ttng.tmem_load %23 {async_task_id = dense<2> : vector<1xi32>} : !ttg.memdesc<128x256xf32, #tmem, #ttng.tensor_memory, mutable> -> tensor<128x256xf32, #blocked>
      %26 = arith.truncf %25 {async_task_id = dense<2> : vector<1xi32>} : tensor<128x256xf32, #blocked> to tensor<128x256xf16, #blocked>
      %27 = ttg.convert_layout %26 {async_task_id = dense<2> : vector<1xi32>} : tensor<128x256xf16, #blocked> -> tensor<128x256xf16, #blocked2>
      tt.descriptor_store %12[%21, %22], %27 {async_task_id = dense<2> : vector<1xi32>} : !tt.tensordesc<tensor<128x256xf16>>, tensor<128x256xf16, #blocked2>
    } {async_task_id = dense<[0, 1, 2]> : vector<3xi32>}
    tt.return
  }
}
