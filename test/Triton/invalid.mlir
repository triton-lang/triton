...
module attributes {"triton_gpu.target" = "cuda:80", "triton_gpu.num-ctas" = 8 : i32, "triton_gpu.num-warps" = 64 : i32, "triton_gpu.threads-per-warp" = 32 : i32} {
tt.func public @fn(%arg0: !triton_gpu.memdesc<2x4x8x16xf32, #shared, #triton_gpu.shared_memory>, %arg1: !triton_gpu.memdesc<16x32xf32, #shared2, #triton_gpu.shared_memory>) {
    %a = triton_gpu.memdesc_trans %arg0 {order = array<i32: 1, 3, 2, 0>} : !triton_gpu.memdesc<2x4x8x16xf32, #shared, #triton_gpu.shared_memory> -> !triton_gpu.memdesc<4x16x8x2xf32, #shared1, #triton_gpu.shared_memory>
    %b = triton_gpu.memdesc_trans %arg1 {order = array<i32: 1, 0>} : !triton_gpu.memdesc<16x32xf32, #shared2, #triton_gpu.shared_memory> -> !triton_gpu.memdesc<32x16xf32, #shared3, #triton_gpu.shared_memory>
    tt.return
}
}  // end module
