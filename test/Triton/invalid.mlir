...
#shared2 = #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = false, elementBitWidth = 32, CTAsPerCGA = [2, 4], CTASplitNum = [2, 4], CTAOrder = [0, 1]}>
#shared3 = #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = true, elementBitWidth = 32, CTAsPerCGA = [4, 2], CTASplitNum = [4, 2], CTAOrder = [1, 0]}>
