...
// CHECK-DAG: %[[VAL7:.*]] = tt.expand_dims %[[VAL6]] {axis = 1 : i32} : tensor<128xi64> -> tensor<128x1xi64>
...
// CHECK-DAG: %[[VAL12:.*]] = tt.expand_dims %[[VAL11]] {axis = 0 : i32} : tensor<128xi64> -> tensor<1x128xi64>
