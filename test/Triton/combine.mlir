...
tt.func @test_canonicalize_expand_dims(%arg0: tensor<f32>, %arg1: tensor<1xf32>) -> (tensor<1x8xf32>, tensor<8x8xf32>) {
    ...
    // CHECK-NEXT: %[[bc:.*]] = tt.broadcast %arg1 : tensor<1xf32> -> tensor<8xf32>
    // CHECK-NEXT: %[[ed2:.*]] = tt.reshape %[[bc]] : tensor<8xf32> -> tensor<1x8xf32>
    // CHECK-NEXT: %{{.*}} = tt.broadcast %[[ed2]] : tensor<1x8xf32> -> tensor<8x8xf32>
