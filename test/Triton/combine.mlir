...
tt.func @test_canonicalize_reshape(%arg0: tensor<8xf32>, %arg1: tensor<f32>) -> (tensor<4x2xf32>, tensor<2x2x2xf32>, tensor<8xf32>) {
    ...
    tt.return %reshape1, %reshape2, %add : tensor<4x2xf32>, tensor<2x2x2xf32>, tensor<8xf32>
}
