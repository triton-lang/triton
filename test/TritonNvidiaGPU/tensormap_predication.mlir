...
// ops like TensormapCreateOp that appear inside pipelined loops. Without a
// fallback in predicateOp(), the pipeliner crashes with "pipeliner doesn't
// know how to predicate this op". With the scf.if fallback, such ops are
// wrapped in scf.if gated on the pipeline phase predicate.
