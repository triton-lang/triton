...
#smem = #ttg.shared_memory
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 8 : i32, ttg.target = "cuda:90", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @tma_im2col_missing_offsets(%arg0: !ttng.tensordesc_im2col<64x128xf16, #nvmma_128, element_strides = [1, 1, 1, 1], pixel_box_lower_corner = [0, 0], pixel_box_upper_corner = [0, 0]>) {
    %true = arith.constant true
    %c0_i32 = arith.constant 0 : i32
...
#smem = #ttg.shared_memory
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 8 : i32, ttg.target = "cuda:90", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @tma_im2col_wrong_offset_count(%arg0: !ttng.tensordesc_im2col<64x128xf16, #nvmma_128, element_strides = [1, 1, 1, 1], pixel_box_lower_corner = [0, 0], pixel_box_upper_corner = [0, 0]>) {
    %true = arith.constant true
    %c0_i32 = arith.constant 0 : i32
...
#smem = #ttg.shared_memory
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 8 : i32, ttg.target = "cuda:90", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @tma_im2col_2d_invalid(%arg0: !ttng.tensordesc_im2col<64x128xf16, #nvmma_128, element_strides = [1, 1, 1, 1], pixel_box_lower_corner = [0, 0], pixel_box_upper_corner = [0, 0]>) {
    %true = arith.constant true
    %c0_i32 = arith.constant 0 : i32
    %0 = ttg.local_alloc : () -> !ttg.memdesc<64x128xf16, #nvmma_128, #smem, mutable>
    %1 = ttg.local_alloc : () -> !ttg.memdesc<1xi64, #shared2, #smem, mutable>
...
#smem = #ttg.shared_memory
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 8 : i32, ttg.target = "cuda:90", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @tma_im2col_metadata_2d_invalid(%arg0: !ttng.tensordesc_im2col<64x128xf16, #nvmma_128, element_strides = [1, 1, 1, 1], pixel_box_lower_corner = [-1, -1], pixel_box_upper_corner = [-1, -1]>) {
    %true = arith.constant true
    %c0_i32 = arith.constant 0 : i32
    %0 = ttg.local_alloc : () -> !ttg.memdesc<64x128xf16, #nvmma_128, #smem, mutable>
    %1 = ttg.local_alloc : () -> !ttg.memdesc<1xi64, #shared2, #smem, mutable>
...
module attributes {"ttg.num-warps" = 4 : i32, "ttg.num-ctas" = 1 : i32} {
  ...
  tt.func @tensordesc_im2col_wrong_rank(%desc: !ttng.tensordesc_im2col<32x64x128xf16, element_strides = [1, 1, 1, 1], pixel_box_lower_corner = [0, 0], pixel_box_upper_corner = [0, 0]>) {
    tt.return
  }
}
