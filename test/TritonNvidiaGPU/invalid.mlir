...
module attributes {"ttg.num-ctas" = 2 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @async_tma_gather_multicast_requires_broadcast(%arg0: !tt.tensordesc<tensor<1x128xf16, #nvmma_no_broadcast>>) {
    %true = arith.constant true
    %c0_i32 = arith.constant 0 : i32
    ...
    ttng.async_tma_gather %arg0[%x_offsets, %c0_i32] %result, %bar, %true {multicast} : !tt.tensordesc<tensor<1x128xf16, #nvmma_no_broadcast>>, tensor<32xi32, #blocked_broadcast>, i32, !ttg.memdesc<1xi64, #shared_bar, #smem, mutable>, !ttg.memdesc<32x128xf16, #nvmma_no_broadcast, #smem, mutable>, i1
    tt.return
  }
}
...
module attributes {"ttg.num-ctas" = 4 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @async_tma_gather_multicast_allows_extra_x_offset_broadcast(%arg0: !tt.tensordesc<tensor<1x128xf16, #nvmma_partial_broadcast>>) {
    ...
    ttng.async_tma_gather %arg0[%x_offsets, %c0_i32] %result, %bar, %true {multicast} : !tt.tensordesc<tensor<1x128xf16, #nvmma_partial_broadcast>>, tensor<32xi32, #blocked_broadcast>, i32, !ttg.memdesc<1xi64, #shared_bar, #smem, mutable>, !ttg.memdesc<32x128xf16, #nvmma_partial_broadcast, #smem, mutable>, i1
    tt.return
  }
}
...
#smem = #ttg.shared_memory
module attributes {"ttg.num-ctas" = 2 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @async_tma_gather_multicast_requires_uniform_x_offsets(%arg0: !tt.tensordesc<tensor<1x128xf16, #nvmma_broadcast>>) {
    %true = arith.constant true
    %c0_i32 = arith.constant 0 : i32
    ...
    ttng.async_tma_gather %arg0[%x_offsets, %c0_i32] %result, %bar, %true {multicast} : !tt.tensordesc<tensor<1x128xf16, #nvmma_broadcast>>, tensor<32xi32, #blocked_split>, i32, !ttg.memdesc<1xi64, #shared_bar, #smem, mutable>, !ttg.memdesc<32x128xf16, #nvmma_broadcast, #smem, mutable>, i1
    tt.return
  }

  tt.func public @async_tma_gather_requires_local_shared_offsets(%arg0: !tt.tensordesc<tensor<1x128xf16, #nvmma_broadcast>>) {
    %true = arith.constant true
    %c0_i32 = arith.constant 0 : i32
    %x_offsets = arith.constant dense<0> : tensor<32xi32, #blocked_split>
    %bar = ttg.local_alloc : () -> !ttg.memdesc<1xi64, #shared_bar, #smem, mutable>
    ...
    ttng.async_tma_gather %arg0[%x_offsets, %c0_i32] %result, %bar, %true : !tt.tensordesc<tensor<1x128xf16, #nvmma_broadcast>>, tensor<32xi32, #blocked_split>, i32, !ttg.memdesc<1xi64, #shared_bar, #smem, mutable>, !ttg.memdesc<32x128xf16, #nvmma_broadcast, #smem, mutable>, i1
    tt.return
  }
}
