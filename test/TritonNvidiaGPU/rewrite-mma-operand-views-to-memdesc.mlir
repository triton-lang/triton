// RUN: triton-opt %s -split-input-file -triton-nvidia-optimize-descriptor-encoding -triton-nvidia-rewrite-mma-operand-views-to-memdesc -canonicalize | FileCheck %s
...
// CHECK-DAG: #{{.*}} = #ttg.nvmma_shared<{swizzlingByteWidth = 0, transposed = false, elementBitWidth = 8, rank = 5}>
